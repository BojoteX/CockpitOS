...
static const InputMapping InputMappings[] = {
    { "APU_CONTROL_SW_OFF"             , "NONE" ,  0 ,  0 ,  -1 , "APU_CONTROL_SW"     ,     0 , "selector"     ,  4 ,  0 },
    { "APU_CONTROL_SW_ON"              , "NONE" ,  0 ,  0 ,  -1 , "APU_CONTROL_SW"     ,     1 , "selector"     ,  4 ,  0 },
    { "ENGINE_CRANK_SW_RIGHT"          , "NONE" ,  0 ,  0 ,  -1 , "ENGINE_CRANK_SW"    ,     0 , "selector"     ,  5 ,  0 },
    { "ENGINE_CRANK_SW_OFF"            , "NONE" ,  0 ,  0 ,  -1 , "ENGINE_CRANK_SW"    ,     1 , "selector"     ,  5 ,  0 },
    { "ENGINE_CRANK_SW_LEFT"           , "NONE" ,  0 ,  0 ,  -1 , "ENGINE_CRANK_SW"    ,     2 , "selector"     ,  5 ,  0 },
    { "FLIR_SW_OFF"                    , "NONE" ,  0 ,  0 ,  -1 , "FLIR_SW"            ,     0 , "selector"     ,  7 ,  0 },
    { "FLIR_SW_STBY"                   , "NONE" ,  0 ,  0 ,  -1 , "FLIR_SW"            ,     1 , "selector"     ,  7 ,  0 },
    { "FLIR_SW_ON"                     , "NONE" ,  0 ,  0 ,  -1 , "FLIR_SW"            ,     2 , "selector"     ,  7 ,  0 },
    { "INS_SW_TEST"                    , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     0 , "selector"     ,  8 ,  0 },
    { "INS_SW_GB"                      , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     1 , "selector"     ,  8 ,  0 },
    { "INS_SW_GYRO"                    , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     2 , "selector"     ,  8 ,  0 },
    { "INS_SW_IFA"                     , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     3 , "selector"     ,  8 ,  0 },
    { "INS_SW_NAV"                     , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     4 , "selector"     ,  8 ,  0 },
    { "INS_SW_GND"                     , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     5 , "selector"     ,  8 ,  0 },
    { "INS_SW_CV"                      , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     6 , "selector"     ,  8 ,  0 },
    { "INS_SW_OFF"                     , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     7 , "selector"     ,  8 ,  0 },
    { "INS_SW_DEC"                     , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     0 , "fixed_step"   ,  0 ,  0 },
    { "INS_SW_INC"                     , "NONE" ,  0 ,  0 ,  -1 , "INS_SW"             ,     1 , "fixed_step"   ,  0 ,  0 },
    { "LST_NFLR_SW_OFF"                , "NONE" ,  0 ,  0 ,  -1 , "LST_NFLR_SW"        ,     0 , "selector"     ,  9 ,  0 },
    { "LST_NFLR_SW_ON"                 , "NONE" ,  0 ,  0 ,  -1 , "LST_NFLR_SW"        ,     1 , "selector"     ,  9 ,  0 },
    { "LTD_R_SW_SAFE"                  , "GPIO" , -1 ,  0 ,  -1 , "LTD_R_SW"           ,     0 , "selector"     , 12 ,  0 },
    { "LTD_R_SW_ARM"                   , "GPIO" ,  2 ,  0 ,  -1 , "LTD_R_SW"           ,     1 , "selector"     , 12 ,  0 },
    { "RADAR_SW_EMERG(PULL)"           , "NONE" ,  0 ,  0 ,  -1 , "RADAR_SW"           ,     0 , "selector"     , 11 ,  0 },
    { "RADAR_SW_OPR"                   , "NONE" ,  0 ,  0 ,  -1 , "RADAR_SW"           ,     1 , "selector"     , 11 ,  0 },
    { "RADAR_SW_STBY"                  , "NONE" ,  0 ,  0 ,  -1 , "RADAR_SW"           ,     2 , "selector"     , 11 ,  0 },
    { "RADAR_SW_OFF"                   , "NONE" ,  0 ,  0 ,  -1 , "RADAR_SW"           ,     3 , "selector"     , 11 ,  0 },
    ...
    { "THROTTLE_ATC_SW"                , "GPIO" ,  9 ,  0 ,  -1 , "THROTTLE_ATC_SW"    ,     1 , "momentary"    ,  0 ,  0 },
    { "THROTTLE_CAGE_BTN"              , "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_CAGE_BTN"  ,     1 , "momentary"    ,  0 ,  0 },
    { "THROTTLE_DISP_SW_FORWARD(CHAFF)", "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_DISP_SW"   ,     0 , "selector"     ,  1 ,  0 },
    { "THROTTLE_DISP_SW_CENTER(OFF)"   , "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_DISP_SW"   ,     1 , "selector"     ,  1 ,  0 },
    { "THROTTLE_DISP_SW_AFT(FLARE)"    , "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_DISP_SW"   ,     2 , "selector"     ,  1 ,  0 },
    { "THROTTLE_EXT_L_SW_OFF"          , "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_EXT_L_SW"  ,     0 , "selector"     ,  2 ,  0 },
    { "THROTTLE_EXT_L_SW_ON"           , "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_EXT_L_SW"  ,     1 , "selector"     ,  2 ,  0 },
    ...
    { "THROTTLE_SPEED_BRK_RETRACT"     , "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_SPEED_BRK" ,     0 , "selector"     ,  3 ,  0 },
    { "THROTTLE_SPEED_BRK_OFF"         , "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_SPEED_BRK" ,     1 , "selector"     ,  3 ,  0 },
    { "THROTTLE_SPEED_BRK_EXTEND"      , "NONE" ,  0 ,  0 ,  -1 , "THROTTLE_SPEED_BRK" ,     2 , "selector"     ,  3 ,  0 },
};
