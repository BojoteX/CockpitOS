// CustomPins.h - Pin configuration for SERVOTEST
//
...
// --- RS485 Communication ----------------------------------
#define RS485_TX_PIN                             18             // GPIO for TX (connect to RS485 board DI)
#define RS485_RX_PIN                             19             // GPIO for RX (connect to RS485 board RO)
#define RS485_DE_PIN                             -1             // Direction enable pin (-1 if auto-direction)

// --- RS485 Test Pins --------------------------------------
#define RS485_TEST_BUTTON_GPIO                   -1             // Test button GPIO (-1 to disable)
