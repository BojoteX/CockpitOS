...
static const LEDMapping panelLEDs[] = {
  ...
  { "AUX_REL_SW"            , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "CMSD_DISPENSE_SW"      , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "CMSD_JET_SEL_BTN"      , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "CMSD_JET_SEL_L"        , DEVICE_PCA9555 , {.pcaInfo = {0x22, 1, 1}}, false, true }, // PCA 0x22 Port 1 Bit 1,
  { "ECM_MODE_SW"           , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  ...
  { "RWR_BIT_BTN"           , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "RWR_BIT_LT"            , DEVICE_GPIO    , {.gpioInfo = {PIN(4)}}, false, true }, // GPIO PIN(4),
  { "RWR_DISPLAY_BTN"       , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "RWR_DISPLAY_LT"        , DEVICE_GPIO    , {.gpioInfo = {PIN(13)}}, false, true }, // GPIO PIN(13),
  { "RWR_DIS_TYPE_SW"       , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  ...
  { "RWR_OFFSET_BTN"        , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "RWR_OFFSET_LT"         , DEVICE_GPIO    , {.gpioInfo = {PIN(6)}}, false, true }, // GPIO PIN(6),
  { "RWR_POWER_BTN"         , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "RWR_RWR_INTESITY"      , DEVICE_NONE    , {.gpioInfo = {0}}, false, true }, // No Info,
  { "RWR_SPECIAL_BTN"       , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
