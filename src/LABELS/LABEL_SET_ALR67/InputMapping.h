...
static const InputMapping InputMappings[] = {
    { "AUX_REL_SW_NORM"            , "PCA_0x22" ,  0 ,  1 ,  10 , "AUX_REL_SW"            ,     0 , "selector"     ,  1 ,  0 },
    { "AUX_REL_SW_ENABLE"          , "PCA_0x22" ,  0 , -1 ,  11 , "AUX_REL_SW"            ,     1 , "selector"     ,  1 ,  0 },
    { "CMSD_DISPENSE_SW_OFF"       , "PCA_0x22" ,  0 ,  3 ,   7 , "CMSD_DISPENSE_SW"      ,     0 , "selector"     ,  2 ,  0 },
    { "CMSD_DISPENSE_SW_ON"        , "PCA_0x22" ,  0 , -1 ,   8 , "CMSD_DISPENSE_SW"      ,     1 , "selector"     ,  2 ,  0 },
    { "CMSD_DISPENSE_SW_BYPASS"    , "PCA_0x22" ,  0 ,  2 ,   9 , "CMSD_DISPENSE_SW"      ,     2 , "selector"     ,  2 ,  0 },
    { "CMSD_JET_SEL_BTN"           , "PCA_0x22" ,  0 ,  0 ,   6 , "CMSD_JET_SEL_BTN"      ,     1 , "momentary"    ,  0 ,  0 },
    { "ECM_MODE_SW_OFF"            , "PCA_0x22" ,  0 ,  4 ,   1 , "ECM_MODE_SW"           ,     0 , "selector"     ,  3 ,  0 },
    { "ECM_MODE_SW_STBY"           , "PCA_0x22" ,  0 ,  5 ,   2 , "ECM_MODE_SW"           ,     1 , "selector"     ,  3 ,  0 },
    { "ECM_MODE_SW_BIT"            , "PCA_0x22" ,  0 ,  6 ,   3 , "ECM_MODE_SW"           ,     2 , "selector"     ,  3 ,  0 },
    { "ECM_MODE_SW_REC"            , "PCA_0x22" ,  0 ,  7 ,   4 , "ECM_MODE_SW"           ,     3 , "selector"     ,  3 ,  0 },
    { "ECM_MODE_SW_XMIT"           , "PCA_0x22" ,  1 ,  0 ,   5 , "ECM_MODE_SW"           ,     4 , "selector"     ,  3 ,  0 },
    { "ECM_MODE_SW_DEC"            , "NONE" ,  0 ,  0 ,  -1 , "ECM_MODE_SW"           ,     0 , "fixed_step"   ,  0 ,  0 },
    { "ECM_MODE_SW_INC"            , "NONE" ,  0 ,  0 ,  -1 , "ECM_MODE_SW"           ,     1 , "fixed_step"   ,  0 ,  0 },
    ...
    { "COCKKPIT_LIGHT_MODE_SW_DAY" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     0 , "selector"     ,  4 ,  0 },
    { "COCKKPIT_LIGHT_MODE_SW_NITE", "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     1 , "selector"     ,  4 ,  0 },
    { "COCKKPIT_LIGHT_MODE_SW_NVG" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     2 , "selector"     ,  4 ,  0 },
    ...
    { "LIGHTS_TEST_SW_OFF"         , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"        ,     0 , "selector"     ,  5 ,  0 },
    { "LIGHTS_TEST_SW_TEST"        , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"        ,     1 , "selector"     ,  5 ,  0 },
    ...
    { "RWR_AUDIO_CTRL"             , "GPIO" , PIN(2) ,  0 ,  -1 , "RWR_AUDIO_CTRL"        , 65535 , "analog"       ,  0 ,  0 },
    { "RWR_AUDIO_CTRL_DEC"         , "NONE" ,  0 ,  0 ,  -1 , "RWR_AUDIO_CTRL"        ,     0 , "variable_step",  0 ,  0 },
    { "RWR_AUDIO_CTRL_INC"         , "NONE" ,  0 ,  0 ,  -1 , "RWR_AUDIO_CTRL"        ,     1 , "variable_step",  0 ,  0 },
    { "RWR_BIT_BTN"                , "HC165" ,  0 ,  0 ,  -1 , "RWR_BIT_BTN"           ,     1 , "momentary"    ,  0 ,  0 },
    { "RWR_DISPLAY_BTN"            , "HC165" ,  0 ,  3 ,  -1 , "RWR_DISPLAY_BTN"       ,     1 , "momentary"    ,  0 ,  0 },
    { "RWR_DIS_TYPE_SW_F"          , "MATRIX" , ALR67_DataPin , 15 ,  -1 , "RWR_DIS_TYPE_SW"       ,     4 , "selector"     ,  6 ,  0 },
    { "RWR_DIS_TYPE_SW_U"          , "MATRIX" , ALR67_STROBE_1 ,  1 ,  -1 , "RWR_DIS_TYPE_SW"       ,     3 , "selector"     ,  6 ,  0 },
    { "RWR_DIS_TYPE_SW_A"          , "MATRIX" , ALR67_STROBE_2 ,  2 ,  -1 , "RWR_DIS_TYPE_SW"       ,     2 , "selector"     ,  6 ,  0 },
    { "RWR_DIS_TYPE_SW_I"          , "MATRIX" , ALR67_STROBE_3 ,  4 ,  -1 , "RWR_DIS_TYPE_SW"       ,     1 , "selector"     ,  6 ,  0 },
    { "RWR_DIS_TYPE_SW_N"          , "MATRIX" , ALR67_STROBE_4 ,  8 ,  -1 , "RWR_DIS_TYPE_SW"       ,     0 , "selector"     ,  6 ,  0 },
    { "RWR_DIS_TYPE_SW_DEC"        , "NONE" ,  0 ,  0 ,  -1 , "RWR_DIS_TYPE_SW"       ,     0 , "fixed_step"   ,  0 ,  0 },
    { "RWR_DIS_TYPE_SW_INC"        , "NONE" ,  0 ,  0 ,  -1 , "RWR_DIS_TYPE_SW"       ,     1 , "fixed_step"   ,  0 ,  0 },
    { "RWR_DMR_CTRL"               , "GPIO" , PIN(1) ,  0 ,  -1 , "RWR_DMR_CTRL"          , 65535 , "analog"       ,  0 ,  0 },
    { "RWR_DMR_CTRL_DEC"           , "NONE" ,  0 ,  0 ,  -1 , "RWR_DMR_CTRL"          ,     0 , "variable_step",  0 ,  0 },
    { "RWR_DMR_CTRL_INC"           , "NONE" ,  0 ,  0 ,  -1 , "RWR_DMR_CTRL"          ,     1 , "variable_step",  0 ,  0 },
    { "RWR_OFFSET_BTN"             , "HC165" ,  0 ,  1 ,  -1 , "RWR_OFFSET_BTN"        ,     1 , "momentary"    ,  0 ,  0 },
    { "RWR_POWER_BTN"              , "HC165" ,  0 ,  4 ,  -1 , "RWR_POWER_BTN"         ,     1 , "momentary"    ,  0 ,  0 },
    { "RWR_RWR_INTESITY"           , "NONE" ,  0 ,  0 ,  -1 , "RWR_RWR_INTESITY"      , 65535 , "analog"       ,  0 ,  0 },
    { "RWR_RWR_INTESITY_DEC"       , "NONE" ,  0 ,  0 ,  -1 , "RWR_RWR_INTESITY"      ,     0 , "variable_step",  0 ,  0 },
    { "RWR_RWR_INTESITY_INC"       , "NONE" ,  0 ,  0 ,  -1 , "RWR_RWR_INTESITY"      ,     1 , "variable_step",  0 ,  0 },
    { "RWR_SPECIAL_BTN"            , "HC165" ,  0 ,  2 ,  -1 , "RWR_SPECIAL_BTN"       ,     1 , "momentary"    ,  0 ,  0 },
};
