...
static const SelectorHashEntry selectorHashTable[109] = {
  {"CONSOLES_DIMMER", 0, &SelectorMap[20]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"COCKKPIT_LIGHT_MODE_SW", 0, &SelectorMap[16]},
  {nullptr, 0, nullptr},
  {"CMSD_DISPENSE_SW", 0, &SelectorMap[2]},
  {"COCKKPIT_LIGHT_MODE_SW", 2, &SelectorMap[18]},
  {"RWR_POWER_BTN", 1, &SelectorMap[49]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CMSD_DISPENSE_SW", 1, &SelectorMap[3]},
  {nullptr, 0, nullptr},
  {"ECM_MODE_SW", 3, &SelectorMap[9]},
  {"INST_PNL_DIMMER", 65535, &SelectorMap[25]},
  {nullptr, 0, nullptr},
  {"ECM_MODE_SW", 4, &SelectorMap[10]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"RWR_AUDIO_CTRL", 1, &SelectorMap[35]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  ...
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CONSOLES_DIMMER", 1, &SelectorMap[21]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CONSOLES_DIMMER", 65535, &SelectorMap[19]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"LIGHTS_TEST_SW", 1, &SelectorMap[29]},
  {"RWR_DIS_TYPE_SW", 1, &SelectorMap[39]},
  {"CHART_DIMMER", 0, &SelectorMap[14]},
  {"RWR_DIS_TYPE_SW", 1, &SelectorMap[44]},
  {"RWR_AUDIO_CTRL", 65535, &SelectorMap[33]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"RWR_SPECIAL_BTN", 1, &SelectorMap[53]},
  {nullptr, 0, nullptr},
  {"INST_PNL_DIMMER", 1, &SelectorMap[27]},
  {"CMSD_DISPENSE_SW", 2, &SelectorMap[4]},
  {"RWR_AUDIO_CTRL", 0, &SelectorMap[34]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CMSD_JET_SEL_BTN", 1, &SelectorMap[5]},
  {"COCKKPIT_LIGHT_MODE_SW", 1, &SelectorMap[17]},
  {"FLOOD_DIMMER", 0, &SelectorMap[23]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"RWR_DIS_TYPE_SW", 2, &SelectorMap[40]},
  {nullptr, 0, nullptr},
  {"RWR_DISPLAY_BTN", 1, &SelectorMap[37]},
  {nullptr, 0, nullptr},
  {"RWR_DMR_CTRL", 0, &SelectorMap[46]},
  {"WARN_CAUTION_DIMMER", 1, &SelectorMap[32]},
  {nullptr, 0, nullptr},
  {"ECM_MODE_SW", 0, &SelectorMap[6]},
  {"ECM_MODE_SW", 0, &SelectorMap[11]},
  {"CHART_DIMMER", 65535, &SelectorMap[13]},
  {"FLOOD_DIMMER", 1, &SelectorMap[24]},
  {"AUX_REL_SW", 1, &SelectorMap[1]},
  {"RWR_DIS_TYPE_SW", 3, &SelectorMap[41]},
  {"RWR_DMR_CTRL", 65535, &SelectorMap[45]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"INST_PNL_DIMMER", 0, &SelectorMap[26]},
  {"RWR_BIT_BTN", 1, &SelectorMap[36]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"RWR_RWR_INTESITY", 65535, &SelectorMap[50]},
  {"RWR_RWR_INTESITY", 1, &SelectorMap[52]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"LIGHTS_TEST_SW", 0, &SelectorMap[28]},
  {"ECM_MODE_SW", 1, &SelectorMap[7]},
  {"ECM_MODE_SW", 1, &SelectorMap[12]},
  {"RWR_RWR_INTESITY", 0, &SelectorMap[51]},
  {"ECM_MODE_SW", 2, &SelectorMap[8]},
  {"RWR_DIS_TYPE_SW", 4, &SelectorMap[42]},
  {"FLOOD_DIMMER", 65535, &SelectorMap[22]},
  {"CHART_DIMMER", 1, &SelectorMap[15]},
  {"RWR_DMR_CTRL", 1, &SelectorMap[47]},
  {"RWR_DIS_TYPE_SW", 0, &SelectorMap[38]},
  {"WARN_CAUTION_DIMMER", 65535, &SelectorMap[30]},
  {"WARN_CAUTION_DIMMER", 0, &SelectorMap[31]},
  {"AUX_REL_SW", 0, &SelectorMap[0]},
  {"RWR_DIS_TYPE_SW", 0, &SelectorMap[43]},
  {"RWR_OFFSET_BTN", 1, &SelectorMap[48]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
};
...
inline const SelectorEntry* findSelectorByDcsAndValue(const char* dcsCommand, uint16_t value) {
  uint16_t startH = (labelHash(dcsCommand) ^ (value * 7919u)) % 109;
