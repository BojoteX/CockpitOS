...
static const SelectorEntry SelectorMap[] = {
    { "AUX_REL_SW_ENABLE","AUX_REL_SW",0,"selector",1,"ENABLE" },
    { "AUX_REL_SW_NORM","AUX_REL_SW",1,"selector",1,"NORM" },
    { "CMSD_DISPENSE_SW_BYPASS","CMSD_DISPENSE_SW",0,"selector",2,"BYPASS" },
    { "CMSD_DISPENSE_SW_ON","CMSD_DISPENSE_SW",1,"selector",2,"ON" },
    { "CMSD_DISPENSE_SW_OFF","CMSD_DISPENSE_SW",2,"selector",2,"OFF" },
    { "CMSD_JET_SEL_BTN","CMSD_JET_SEL_BTN",1,"momentary",0,"PRESS" },
    { "ECM_MODE_SW_XMIT","ECM_MODE_SW",0,"selector",3,"XMIT" },
    { "ECM_MODE_SW_REC","ECM_MODE_SW",1,"selector",3,"REC" },
    { "ECM_MODE_SW_BIT","ECM_MODE_SW",2,"selector",3,"BIT" },
    { "ECM_MODE_SW_STBY","ECM_MODE_SW",3,"selector",3,"STBY" },
    { "ECM_MODE_SW_OFF","ECM_MODE_SW",4,"selector",3,"OFF" },
    ...
    { "RWR_DIS_TYPE_SW_N","RWR_DIS_TYPE_SW",0,"selector",6,"N" },
    { "RWR_DIS_TYPE_SW_I","RWR_DIS_TYPE_SW",1,"selector",6,"I" },
    { "RWR_DIS_TYPE_SW_A","RWR_DIS_TYPE_SW",2,"selector",6,"A" },
    { "RWR_DIS_TYPE_SW_U","RWR_DIS_TYPE_SW",3,"selector",6,"U" },
    { "RWR_DIS_TYPE_SW_F","RWR_DIS_TYPE_SW",4,"selector",6,"F" },
