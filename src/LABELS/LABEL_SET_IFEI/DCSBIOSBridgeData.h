...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x74D6, { &DcsOutputTable[5], &DcsOutputTable[6], &DcsOutputTable[8], &DcsOutputTable[11], &DcsOutputTable[12], &DcsOutputTable[15], &DcsOutputTable[16], &DcsOutputTable[84] }, 8 },
  { 0x7574, { &DcsOutputTable[7] }, 1 },
  { 0x756E, { &DcsOutputTable[9] }, 1 },
  { 0x7572, { &DcsOutputTable[10] }, 1 },
  { 0x7570, { &DcsOutputTable[13] }, 1 },
  { 0x74D8, { &DcsOutputTable[14], &DcsOutputTable[70] }, 2 },
  { 0x7466, { &DcsOutputTable[17], &DcsOutputTable[24], &DcsOutputTable[25], &DcsOutputTable[26], &DcsOutputTable[46], &DcsOutputTable[47], &DcsOutputTable[73], &DcsOutputTable[82], &DcsOutputTable[124], &DcsOutputTable[125] }, 10 },
  { 0x7430, { &DcsOutputTable[18], &DcsOutputTable[19], &DcsOutputTable[20], &DcsOutputTable[21], &DcsOutputTable[22], &DcsOutputTable[149], &DcsOutputTable[151], &DcsOutputTable[153] }, 8 },
  { 0x74DE, { &DcsOutputTable[23] }, 1 },
  { 0x7468, { &DcsOutputTable[27] }, 1 },
  { 0x7469, { &DcsOutputTable[28] }, 1 },
  { 0x746A, { &DcsOutputTable[29] }, 1 },
  { 0x746B, { &DcsOutputTable[30] }, 1 },
  { 0x746C, { &DcsOutputTable[31] }, 1 },
  { 0x74C6, { &DcsOutputTable[32] }, 1 },
  { 0x746E, { &DcsOutputTable[33] }, 1 },
  { 0x746F, { &DcsOutputTable[34] }, 1 },
  { 0x7470, { &DcsOutputTable[35] }, 1 },
  { 0x7471, { &DcsOutputTable[36] }, 1 },
  { 0x7472, { &DcsOutputTable[37] }, 1 },
  { 0x7473, { &DcsOutputTable[38] }, 1 },
  { 0x74AE, { &DcsOutputTable[39] }, 1 },
  { 0x74AF, { &DcsOutputTable[40] }, 1 },
  { 0x74B0, { &DcsOutputTable[41] }, 1 },
  { 0x747A, { &DcsOutputTable[42] }, 1 },
  { 0x747C, { &DcsOutputTable[43] }, 1 },
  { 0x747E, { &DcsOutputTable[44] }, 1 },
  { 0x7480, { &DcsOutputTable[45] }, 1 },
  { 0x7482, { &DcsOutputTable[48] }, 1 },
  { 0x7483, { &DcsOutputTable[49] }, 1 },
  { 0x7484, { &DcsOutputTable[50] }, 1 },
  { 0x7486, { &DcsOutputTable[51] }, 1 },
  { 0x7487, { &DcsOutputTable[52] }, 1 },
  { 0x7488, { &DcsOutputTable[53] }, 1 },
  { 0x74C0, { &DcsOutputTable[54] }, 1 },
  { 0x748A, { &DcsOutputTable[55] }, 1 },
  { 0x748B, { &DcsOutputTable[56] }, 1 },
  { 0x748C, { &DcsOutputTable[57] }, 1 },
  { 0x748D, { &DcsOutputTable[58] }, 1 },
  { 0x748E, { &DcsOutputTable[59] }, 1 },
  { 0x748F, { &DcsOutputTable[60] }, 1 },
  { 0x7490, { &DcsOutputTable[61] }, 1 },
  { 0x7491, { &DcsOutputTable[62] }, 1 },
  { 0x7492, { &DcsOutputTable[63] }, 1 },
  { 0x7493, { &DcsOutputTable[64] }, 1 },
  { 0x7494, { &DcsOutputTable[65] }, 1 },
  { 0x7495, { &DcsOutputTable[66] }, 1 },
  { 0x74CC, { &DcsOutputTable[67] }, 1 },
  { 0x74D4, { &DcsOutputTable[68], &DcsOutputTable[136], &DcsOutputTable[137] }, 3 },
  { 0x74D0, { &DcsOutputTable[69] }, 1 },
  { 0x74C8, { &DcsOutputTable[71], &DcsOutputTable[128], &DcsOutputTable[132] }, 3 },
  { 0x7582, { &DcsOutputTable[72] }, 1 },
  { 0x74C2, { &DcsOutputTable[74] }, 1 },
  { 0x7496, { &DcsOutputTable[75] }, 1 },
  { 0x7497, { &DcsOutputTable[76] }, 1 },
  { 0x7498, { &DcsOutputTable[77] }, 1 },
  { 0x749A, { &DcsOutputTable[78] }, 1 },
  { 0x749B, { &DcsOutputTable[79] }, 1 },
  { 0x749C, { &DcsOutputTable[80] }, 1 },
  { 0x74C4, { &DcsOutputTable[81] }, 1 },
  { 0x74CE, { &DcsOutputTable[83] }, 1 },
  { 0x74D2, { &DcsOutputTable[85] }, 1 },
  { 0x749E, { &DcsOutputTable[86] }, 1 },
  { 0x749F, { &DcsOutputTable[87] }, 1 },
  { 0x74A0, { &DcsOutputTable[88] }, 1 },
  { 0x74A2, { &DcsOutputTable[89] }, 1 },
  { 0x74A3, { &DcsOutputTable[90] }, 1 },
  { 0x74A4, { &DcsOutputTable[91] }, 1 },
  { 0x74BC, { &DcsOutputTable[92] }, 1 },
  { 0x74DA, { &DcsOutputTable[93] }, 1 },
  { 0x74CA, { &DcsOutputTable[94] }, 1 },
  { 0x7584, { &DcsOutputTable[95] }, 1 },
  { 0x74B2, { &DcsOutputTable[96] }, 1 },
  { 0x74B3, { &DcsOutputTable[97] }, 1 },
  { 0x74B4, { &DcsOutputTable[98] }, 1 },
  { 0x757C, { &DcsOutputTable[99] }, 1 },
  { 0x757D, { &DcsOutputTable[100] }, 1 },
  { 0x757E, { &DcsOutputTable[101] }, 1 },
  { 0x757F, { &DcsOutputTable[102] }, 1 },
  { 0x7580, { &DcsOutputTable[103] }, 1 },
  { 0x7581, { &DcsOutputTable[104] }, 1 },
  { 0x74A6, { &DcsOutputTable[105] }, 1 },
  { 0x74A7, { &DcsOutputTable[106] }, 1 },
  { 0x74A8, { &DcsOutputTable[107] }, 1 },
  { 0x74AA, { &DcsOutputTable[108] }, 1 },
  { 0x74AB, { &DcsOutputTable[109] }, 1 },
  { 0x74AC, { &DcsOutputTable[110] }, 1 },
  { 0x74BE, { &DcsOutputTable[111] }, 1 },
  { 0x7474, { &DcsOutputTable[112] }, 1 },
  { 0x7475, { &DcsOutputTable[113] }, 1 },
  { 0x7476, { &DcsOutputTable[114] }, 1 },
  { 0x7477, { &DcsOutputTable[115] }, 1 },
  { 0x7478, { &DcsOutputTable[116] }, 1 },
  { 0x7479, { &DcsOutputTable[117] }, 1 },
  { 0x74B6, { &DcsOutputTable[118] }, 1 },
  { 0x74B7, { &DcsOutputTable[119] }, 1 },
  { 0x74B8, { &DcsOutputTable[120] }, 1 },
  { 0x74B9, { &DcsOutputTable[121] }, 1 },
  { 0x74BA, { &DcsOutputTable[122] }, 1 },
  { 0x74BB, { &DcsOutputTable[123] }, 1 },
  { 0x74DC, { &DcsOutputTable[126] }, 1 },
  { 0x754A, { &DcsOutputTable[127] }, 1 },
  { 0x7544, { &DcsOutputTable[129] }, 1 },
  { 0x7548, { &DcsOutputTable[130] }, 1 },
  { 0x7546, { &DcsOutputTable[131] }, 1 },
  { 0x754C, { &DcsOutputTable[133] }, 1 },
  { 0x755E, { &DcsOutputTable[134] }, 1 },
  { 0x7558, { &DcsOutputTable[135] }, 1 },
  { 0x755A, { &DcsOutputTable[138] }, 1 },
  { 0x7566, { &DcsOutputTable[139] }, 1 },
  { 0x7564, { &DcsOutputTable[140] }, 1 },
  { 0x7560, { &DcsOutputTable[141] }, 1 },
  { 0x755C, { &DcsOutputTable[142] }, 1 },
  { 0x7562, { &DcsOutputTable[143] }, 1 },
  { 0x742C, { &DcsOutputTable[144] }, 1 },
  { 0x742E, { &DcsOutputTable[145], &DcsOutputTable[146], &DcsOutputTable[147], &DcsOutputTable[148], &DcsOutputTable[150], &DcsOutputTable[152] }, 6 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[251] = {
  { 0x74AC, &dcsAddressTable[91] },
  { 0x74AE, &dcsAddressTable[26] },
  { 0x74AF, &dcsAddressTable[27] },
  { 0x74B0, &dcsAddressTable[28] },
  { 0x7476, &dcsAddressTable[95] },
  { 0x74B2, &dcsAddressTable[77] },
  { 0x75AE, &dcsAddressTable[2] },
  { 0x74B3, &dcsAddressTable[78] },
  { 0x74B4, &dcsAddressTable[79] },
  { 0x7477, &dcsAddressTable[96] },
  { 0x7478, &dcsAddressTable[97] },
  { 0x7479, &dcsAddressTable[98] },
  { 0x74B6, &dcsAddressTable[99] },
  { 0x74B7, &dcsAddressTable[100] },
  { 0x74B8, &dcsAddressTable[101] },
  { 0x74BC, &dcsAddressTable[73] },
  { 0x74B9, &dcsAddressTable[102] },
  { 0x74BE, &dcsAddressTable[92] },
  { 0x74BA, &dcsAddressTable[103] },
  { 0x74C0, &dcsAddressTable[39] },
  { 0x74BB, &dcsAddressTable[104] },
  { 0x74C2, &dcsAddressTable[57] },
  { 0x7564, &dcsAddressTable[115] },
  { 0x74C4, &dcsAddressTable[64] },
  {0xFFFF, nullptr},
  { 0x74C6, &dcsAddressTable[19] },
  {0xFFFF, nullptr},
  { 0x74C8, &dcsAddressTable[55] },
  {0xFFFF, nullptr},
  { 0x74CA, &dcsAddressTable[75] },
  {0xFFFF, nullptr},
  { 0x74CC, &dcsAddressTable[52] },
  {0xFFFF, nullptr},
  { 0x74CE, &dcsAddressTable[65] },
  {0xFFFF, nullptr},
  { 0x74D0, &dcsAddressTable[54] },
  {0xFFFF, nullptr},
  { 0x74D2, &dcsAddressTable[66] },
  {0xFFFF, nullptr},
  { 0x74D4, &dcsAddressTable[53] },
  {0xFFFF, nullptr},
  { 0x74D6, &dcsAddressTable[5] },
  {0xFFFF, nullptr},
  { 0x74D8, &dcsAddressTable[10] },
  {0xFFFF, nullptr},
  { 0x74DA, &dcsAddressTable[74] },
  {0xFFFF, nullptr},
  { 0x74DC, &dcsAddressTable[105] },
  {0xFFFF, nullptr},
  { 0x74DE, &dcsAddressTable[13] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x742C, &dcsAddressTable[119] },
  {0xFFFF, nullptr},
  { 0x742E, &dcsAddressTable[120] },
  {0xFFFF, nullptr},
  { 0x7430, &dcsAddressTable[12] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x7544, &dcsAddressTable[107] },
  {0xFFFF, nullptr},
  { 0x7546, &dcsAddressTable[109] },
  {0xFFFF, nullptr},
  { 0x7548, &dcsAddressTable[108] },
  {0xFFFF, nullptr},
  { 0x754A, &dcsAddressTable[106] },
  {0xFFFF, nullptr},
  { 0x754C, &dcsAddressTable[110] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x7558, &dcsAddressTable[112] },
  {0xFFFF, nullptr},
  { 0x755A, &dcsAddressTable[113] },
  {0xFFFF, nullptr},
  { 0x755C, &dcsAddressTable[117] },
  {0xFFFF, nullptr},
  { 0x755E, &dcsAddressTable[111] },
  {0xFFFF, nullptr},
  { 0x7560, &dcsAddressTable[116] },
  { 0x7466, &dcsAddressTable[11] },
  { 0x7562, &dcsAddressTable[118] },
  { 0x7468, &dcsAddressTable[14] },
  { 0x7469, &dcsAddressTable[15] },
  { 0x746A, &dcsAddressTable[16] },
  { 0x746B, &dcsAddressTable[17] },
  { 0x746C, &dcsAddressTable[18] },
  { 0x7566, &dcsAddressTable[114] },
  { 0x746E, &dcsAddressTable[20] },
  { 0x746F, &dcsAddressTable[21] },
  { 0x7470, &dcsAddressTable[22] },
  { 0x7471, &dcsAddressTable[23] },
  { 0x7472, &dcsAddressTable[24] },
  { 0x756E, &dcsAddressTable[7] },
  { 0x7473, &dcsAddressTable[25] },
  { 0x7570, &dcsAddressTable[9] },
  { 0x7474, &dcsAddressTable[93] },
  { 0x7572, &dcsAddressTable[8] },
  { 0x7475, &dcsAddressTable[94] },
  { 0x7574, &dcsAddressTable[6] },
  { 0x747A, &dcsAddressTable[29] },
  { 0x7576, &dcsAddressTable[0] },
  { 0x747C, &dcsAddressTable[30] },
  { 0x7578, &dcsAddressTable[4] },
  { 0x747E, &dcsAddressTable[31] },
  { 0x757A, &dcsAddressTable[3] },
  { 0x7480, &dcsAddressTable[32] },
  { 0x757C, &dcsAddressTable[80] },
  { 0x7482, &dcsAddressTable[33] },
  { 0x7483, &dcsAddressTable[34] },
  { 0x7484, &dcsAddressTable[35] },
  { 0x757D, &dcsAddressTable[81] },
  { 0x7486, &dcsAddressTable[36] },
  { 0x7487, &dcsAddressTable[37] },
  { 0x7488, &dcsAddressTable[38] },
  { 0x7582, &dcsAddressTable[56] },
  { 0x748A, &dcsAddressTable[40] },
  { 0x7586, &dcsAddressTable[1] },
  { 0x748B, &dcsAddressTable[41] },
  { 0x748C, &dcsAddressTable[42] },
  { 0x748D, &dcsAddressTable[43] },
  { 0x748E, &dcsAddressTable[44] },
  { 0x748F, &dcsAddressTable[45] },
  { 0x7490, &dcsAddressTable[46] },
  { 0x7491, &dcsAddressTable[47] },
  { 0x7492, &dcsAddressTable[48] },
  { 0x7493, &dcsAddressTable[49] },
  { 0x7494, &dcsAddressTable[50] },
  { 0x7495, &dcsAddressTable[51] },
  { 0x7496, &dcsAddressTable[58] },
  { 0x7497, &dcsAddressTable[59] },
  { 0x7498, &dcsAddressTable[60] },
  { 0x749A, &dcsAddressTable[61] },
  { 0x749B, &dcsAddressTable[62] },
  { 0x749C, &dcsAddressTable[63] },
  { 0x7584, &dcsAddressTable[76] },
  { 0x749E, &dcsAddressTable[67] },
  { 0x749F, &dcsAddressTable[68] },
  { 0x74A0, &dcsAddressTable[69] },
  { 0x757E, &dcsAddressTable[82] },
  { 0x74A2, &dcsAddressTable[70] },
  { 0x74A3, &dcsAddressTable[71] },
  { 0x74A4, &dcsAddressTable[72] },
  { 0x757F, &dcsAddressTable[83] },
  { 0x7580, &dcsAddressTable[84] },
  { 0x7581, &dcsAddressTable[85] },
  { 0x74A6, &dcsAddressTable[86] },
  { 0x74A7, &dcsAddressTable[87] },
  { 0x74A8, &dcsAddressTable[88] },
  { 0x74AA, &dcsAddressTable[89] },
  { 0x74AB, &dcsAddressTable[90] },
};
