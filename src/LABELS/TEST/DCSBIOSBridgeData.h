...
static const SelectorEntry SelectorMap[] = {
    ...
    { "COM_AUX_CUSTOM_POS0","COM_AUX",0,"variable_step",0,"POS0" },
    { "COM_AUX_CUSTOM_POS1","COM_AUX",1,"variable_step",0,"POS1" },
    ...
    { "COM_ICS_CUSTOM_POS0","COM_ICS",0,"variable_step",0,"POS0" },
    { "COM_ICS_CUSTOM_POS1","COM_ICS",1,"variable_step",0,"POS1" },
    ...
    { "COM_MIDS_A_CUSTOM_POS0","COM_MIDS_A",0,"variable_step",0,"POS0" },
    { "COM_MIDS_A_CUSTOM_POS1","COM_MIDS_A",1,"variable_step",0,"POS1" },
    { "COM_MIDS_B","COM_MIDS_B",65535,"analog",0,"LEVEL" },
    { "COM_MIDS_B_CUSTOM_POS0","COM_MIDS_B",0,"variable_step",0,"POS0" },
    { "COM_MIDS_B_CUSTOM_POS1","COM_MIDS_B",1,"variable_step",0,"POS1" },
    { "COM_RWR","COM_RWR",65535,"analog",0,"LEVEL" },
    { "COM_RWR_CUSTOM_POS0","COM_RWR",0,"variable_step",0,"POS0" },
    { "COM_RWR_CUSTOM_POS1","COM_RWR",1,"variable_step",0,"POS1" },
    { "COM_TACAN","COM_TACAN",65535,"analog",0,"LEVEL" },
    { "COM_TACAN_CUSTOM_POS0","COM_TACAN",0,"variable_step",0,"POS0" },
    { "COM_TACAN_CUSTOM_POS1","COM_TACAN",1,"variable_step",0,"POS1" },
    { "COM_VOX","COM_VOX",65535,"analog",0,"LEVEL" },
    { "COM_VOX_CUSTOM_POS0","COM_VOX",0,"variable_step",0,"POS0" },
    { "COM_VOX_CUSTOM_POS1","COM_VOX",1,"variable_step",0,"POS1" },
    { "COM_WPN","COM_WPN",65535,"analog",0,"LEVEL" },
    { "COM_WPN_CUSTOM_POS0","COM_WPN",0,"variable_step",0,"POS0" },
    { "COM_WPN_CUSTOM_POS1","COM_WPN",1,"variable_step",0,"POS1" },
    ...
    { "RUD_TRIM_CUSTOM_POS0","RUD_TRIM",0,"variable_step",0,"POS0" },
    { "RUD_TRIM_CUSTOM_POS1","RUD_TRIM",1,"variable_step",0,"POS1" },
