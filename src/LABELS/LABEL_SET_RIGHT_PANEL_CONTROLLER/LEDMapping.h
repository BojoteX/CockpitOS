...
static const LEDMapping panelLEDs[] = {
  ...
  { "WSHIELD_ANTI_ICE_SW"   , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "BATTERY_SW"            , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "L_GEN_SW"              , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "R_GEN_SW"              , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "VOLT_E"                , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "VOLT_U"                , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "BLEED_AIR_KNOB"        , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "BLEED_AIR_PULL"        , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "CABIN_PRESS_SW"        , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "CABIN_TEMP"            , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "ECS_MODE_SW"           , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "ENG_ANTIICE_SW"        , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "PITOT_HEAT_SW"         , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  ...
  { "CANOPY_SW"             , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
