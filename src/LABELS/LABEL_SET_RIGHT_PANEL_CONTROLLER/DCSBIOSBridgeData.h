...
static const SelectorEntry SelectorMap[] = {
    { "BATTERY_SW_ON","BATTERY_SW",0,"selector",1,"ON" },
    { "BATTERY_SW_OFF","BATTERY_SW",1,"selector",1,"OFF" },
    { "BATTERY_SW_ORIDE","BATTERY_SW",2,"selector",1,"ORIDE" },
    { "L_GEN_SW_NORM","L_GEN_SW",0,"selector",2,"NORM" },
    { "L_GEN_SW_OFF","L_GEN_SW",1,"selector",2,"OFF" },
    { "R_GEN_SW_NORM","R_GEN_SW",0,"selector",3,"NORM" },
    { "R_GEN_SW_OFF","R_GEN_SW",1,"selector",3,"OFF" },
    { "BLEED_AIR_KNOB_R_OFF","BLEED_AIR_KNOB",0,"selector",4,"R_OFF" },
    { "BLEED_AIR_KNOB_NORM","BLEED_AIR_KNOB",1,"selector",4,"NORM" },
    { "BLEED_AIR_KNOB_L_OFF","BLEED_AIR_KNOB",2,"selector",4,"L_OFF" },
    { "BLEED_AIR_KNOB_OFF","BLEED_AIR_KNOB",3,"selector",4,"OFF" },
    ...
    { "ENG_ANTIICE_SW_ON","ENG_ANTIICE_SW",0,"selector",5,"ON" },
    { "ENG_ANTIICE_SW_OFF","ENG_ANTIICE_SW",1,"selector",5,"OFF" },
    { "ENG_ANTIICE_SW_TEST","ENG_ANTIICE_SW",2,"selector",5,"TEST" },
    { "PITOT_HEAT_SW_ON","PITOT_HEAT_SW",0,"selector",6,"ON" },
    { "PITOT_HEAT_SW_AUTO","PITOT_HEAT_SW",1,"selector",6,"AUTO" },
    ...
    { "COCKKPIT_LIGHT_MODE_SW_NVG","COCKKPIT_LIGHT_MODE_SW",0,"selector",7,"NVG" },
    { "COCKKPIT_LIGHT_MODE_SW_NITE","COCKKPIT_LIGHT_MODE_SW",1,"selector",7,"NITE" },
    { "COCKKPIT_LIGHT_MODE_SW_DAY","COCKKPIT_LIGHT_MODE_SW",2,"selector",7,"DAY" },
    ...
    { "LIGHTS_TEST_SW_TEST","LIGHTS_TEST_SW",0,"selector",8,"TEST" },
    { "LIGHTS_TEST_SW_OFF","LIGHTS_TEST_SW",1,"selector",8,"OFF" },
    ...
    { "FLIR_SW_ON","FLIR_SW",0,"selector",9,"ON" },
    { "FLIR_SW_STBY","FLIR_SW",1,"selector",9,"STBY" },
    { "FLIR_SW_OFF","FLIR_SW",2,"selector",9,"OFF" },
    { "INS_SW_OFF","INS_SW",0,"selector",10,"OFF" },
    { "INS_SW_CV","INS_SW",1,"selector",10,"CV" },
    { "INS_SW_GND","INS_SW",2,"selector",10,"GND" },
    { "INS_SW_NAV","INS_SW",3,"selector",10,"NAV" },
    { "INS_SW_IFA","INS_SW",4,"selector",10,"IFA" },
    { "INS_SW_GYRO","INS_SW",5,"selector",10,"GYRO" },
    { "INS_SW_GB","INS_SW",6,"selector",10,"GB" },
    { "INS_SW_TEST","INS_SW",7,"selector",10,"TEST" },
    { "LST_NFLR_SW_ON","LST_NFLR_SW",0,"selector",11,"ON" },
    { "LST_NFLR_SW_OFF","LST_NFLR_SW",1,"selector",11,"OFF" },
    { "LTD_R_SW_ARM","LTD_R_SW",0,"selector",12,"ARM" },
    { "LTD_R_SW_SAFE","LTD_R_SW",1,"selector",12,"SAFE" },
    { "RADAR_SW_OFF","RADAR_SW",0,"selector",13,"OFF" },
    { "RADAR_SW_STBY","RADAR_SW",1,"selector",13,"STBY" },
    { "RADAR_SW_OPR","RADAR_SW",2,"selector",13,"OPR" },
    { "RADAR_SW_EMERG(PULL)","RADAR_SW",3,"selector",13,"EMERG(PULL)" },
