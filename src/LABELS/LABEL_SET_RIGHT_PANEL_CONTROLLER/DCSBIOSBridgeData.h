...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x74CC, { &DcsOutputTable[1], &DcsOutputTable[41] }, 2 },
  ...
  { 0x74C8, { &DcsOutputTable[13], &DcsOutputTable[33], &DcsOutputTable[37], &DcsOutputTable[46], &DcsOutputTable[48], &DcsOutputTable[49] }, 6 },
  { 0x7542, { &DcsOutputTable[14] }, 1 },
  { 0x7576, { &DcsOutputTable[15] }, 1 },
  { 0x7586, { &DcsOutputTable[16] }, 1 },
  { 0x75AE, { &DcsOutputTable[17] }, 1 },
  { 0x757A, { &DcsOutputTable[18] }, 1 },
  { 0x7578, { &DcsOutputTable[19] }, 1 },
  { 0x74D6, { &DcsOutputTable[20], &DcsOutputTable[21], &DcsOutputTable[23], &DcsOutputTable[26], &DcsOutputTable[27], &DcsOutputTable[30], &DcsOutputTable[31] }, 7 },
  { 0x7574, { &DcsOutputTable[22] }, 1 },
  { 0x756E, { &DcsOutputTable[24] }, 1 },
  { 0x7572, { &DcsOutputTable[25] }, 1 },
  { 0x7570, { &DcsOutputTable[28] }, 1 },
  { 0x74D8, { &DcsOutputTable[29] }, 1 },
  { 0x754A, { &DcsOutputTable[32] }, 1 },
  { 0x7544, { &DcsOutputTable[34] }, 1 },
  { 0x7548, { &DcsOutputTable[35] }, 1 },
  { 0x7546, { &DcsOutputTable[36] }, 1 },
  { 0x754C, { &DcsOutputTable[38] }, 1 },
  { 0x7552, { &DcsOutputTable[39] }, 1 },
  { 0x74CE, { &DcsOutputTable[40], &DcsOutputTable[42], &DcsOutputTable[43], &DcsOutputTable[44], &DcsOutputTable[45] }, 5 },
  { 0x74CA, { &DcsOutputTable[47], &DcsOutputTable[50], &DcsOutputTable[51] }, 3 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[59] = {
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x756E, &dcsAddressTable[16] },
  {0xFFFF, nullptr},
  { 0x7570, &dcsAddressTable[18] },
  {0xFFFF, nullptr},
  { 0x7572, &dcsAddressTable[17] },
  { 0x75AE, &dcsAddressTable[11] },
  { 0x7574, &dcsAddressTable[15] },
  ...
  { 0x757A, &dcsAddressTable[12] },
  { 0x74CC, &dcsAddressTable[1] },
  { 0x7542, &dcsAddressTable[8] },
  { 0x7578, &dcsAddressTable[13] },
  { 0x7544, &dcsAddressTable[21] },
  { 0x7546, &dcsAddressTable[23] },
  { 0x74CE, &dcsAddressTable[26] },
  { 0x7548, &dcsAddressTable[22] },
  { 0x74CA, &dcsAddressTable[27] },
  { 0x754A, &dcsAddressTable[20] },
  { 0x7586, &dcsAddressTable[10] },
  { 0x74D6, &dcsAddressTable[14] },
  { 0x754C, &dcsAddressTable[24] },
  { 0x74D8, &dcsAddressTable[19] },
};
...
static const SelectorEntry SelectorMap[] = {
    ...
    { "BLEED_AIR_PULL_POS0","BLEED_AIR_PULL",0,"selector",18,"POS0" },
    { "BLEED_AIR_PULL_POS1","BLEED_AIR_PULL",1,"selector",18,"POS1" },
    { "CABIN_PRESS_SW_RAM/DUMP","CABIN_PRESS_SW",0,"selector",6,"RAM/DUMP" },
    { "CABIN_PRESS_SW_DUMP","CABIN_PRESS_SW",1,"selector",6,"DUMP" },
    { "CABIN_PRESS_SW_NORM","CABIN_PRESS_SW",2,"selector",6,"NORM" },
    ...
    { "ECS_MODE_SW_OFF/RAM","ECS_MODE_SW",0,"selector",7,"OFF/RAM" },
    { "ECS_MODE_SW_MAN","ECS_MODE_SW",1,"selector",7,"MAN" },
    { "ECS_MODE_SW_AUTO","ECS_MODE_SW",2,"selector",7,"AUTO" },
    { "ENG_ANTIICE_SW_TEST","ENG_ANTIICE_SW",0,"selector",8,"TEST" },
    { "ENG_ANTIICE_SW_OFF","ENG_ANTIICE_SW",1,"selector",8,"OFF" },
    { "ENG_ANTIICE_SW_ON","ENG_ANTIICE_SW",2,"selector",8,"ON" },
    { "PITOT_HEAT_SW_AUTO","PITOT_HEAT_SW",0,"selector",9,"AUTO" },
    { "PITOT_HEAT_SW_ON","PITOT_HEAT_SW",1,"selector",9,"ON" },
    ...
    { "COCKKPIT_LIGHT_MODE_SW_DAY","COCKKPIT_LIGHT_MODE_SW",0,"selector",10,"DAY" },
    { "COCKKPIT_LIGHT_MODE_SW_NITE","COCKKPIT_LIGHT_MODE_SW",1,"selector",10,"NITE" },
    { "COCKKPIT_LIGHT_MODE_SW_NVG","COCKKPIT_LIGHT_MODE_SW",2,"selector",10,"NVG" },
    ...
    { "LIGHTS_TEST_SW_OFF","LIGHTS_TEST_SW",0,"selector",11,"OFF" },
    { "LIGHTS_TEST_SW_TEST","LIGHTS_TEST_SW",1,"selector",11,"TEST" },
    ...
    { "CANOPY_SW_CLOSE","CANOPY_SW",0,"selector",12,"CLOSE" },
    { "CANOPY_SW_HOLD","CANOPY_SW",1,"selector",12,"HOLD" },
    { "CANOPY_SW_OPEN","CANOPY_SW",2,"selector",12,"OPEN" },
    ...
    { "FLIR_SW_OFF","FLIR_SW",0,"selector",13,"OFF" },
    { "FLIR_SW_STBY","FLIR_SW",1,"selector",13,"STBY" },
    { "FLIR_SW_ON","FLIR_SW",2,"selector",13,"ON" },
    { "INS_SW_TEST","INS_SW",0,"selector",14,"TEST" },
    { "INS_SW_GB","INS_SW",1,"selector",14,"GB" },
    { "INS_SW_GYRO","INS_SW",2,"selector",14,"GYRO" },
    { "INS_SW_IFA","INS_SW",3,"selector",14,"IFA" },
    { "INS_SW_NAV","INS_SW",4,"selector",14,"NAV" },
    { "INS_SW_GND","INS_SW",5,"selector",14,"GND" },
    { "INS_SW_CV","INS_SW",6,"selector",14,"CV" },
    { "INS_SW_OFF","INS_SW",7,"selector",14,"OFF" },
    { "INS_SW_DEC","INS_SW",0,"fixed_step",0,"DEC" },
    { "INS_SW_INC","INS_SW",1,"fixed_step",0,"INC" },
    { "LST_NFLR_SW_OFF","LST_NFLR_SW",0,"selector",15,"OFF" },
    { "LST_NFLR_SW_ON","LST_NFLR_SW",1,"selector",15,"ON" },
    { "LTD_R_SW_SAFE","LTD_R_SW",0,"selector",16,"SAFE" },
    { "LTD_R_SW_ARM","LTD_R_SW",1,"selector",16,"ARM" },
    { "RADAR_SW_EMERG(PULL)","RADAR_SW",0,"selector",17,"EMERG(PULL)" },
    { "RADAR_SW_OPR","RADAR_SW",1,"selector",17,"OPR" },
    { "RADAR_SW_STBY","RADAR_SW",2,"selector",17,"STBY" },
    { "RADAR_SW_OFF","RADAR_SW",3,"selector",17,"OFF" },
...
static const SelectorHashEntry selectorHashTable[191] = {
  {"INS_SW", 7, &SelectorMap[77]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CABIN_TEMP", 1, &SelectorMap[26]},
  {"BLEED_AIR_PULL", 1, &SelectorMap[20]},
  {"LIGHTS_TEST_SW", 0, &SelectorMap[53]},
  {"FLIR_SW", 2, &SelectorMap[69]},
  {"LST_NFLR_SW", 0, &SelectorMap[80]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"BATTERY_SW", 2, &SelectorMap[8]},
  {"COCKKPIT_LIGHT_MODE_SW", 1, &SelectorMap[42]},
  {nullptr, 0, nullptr},
  {"INS_SW", 6, &SelectorMap[76]},
  {"DEFOG_HANDLE", 1, &SelectorMap[2]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  ...
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CANOPY_SW", 2, &SelectorMap[60]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"ENG_ANTIICE_SW", 0, &SelectorMap[30]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CONSOLES_DIMMER", 65535, &SelectorMap[44]},
  {nullptr, 0, nullptr},
  {"COCKKPIT_LIGHT_MODE_SW", 2, &SelectorMap[43]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"LIGHTS_TEST_SW", 1, &SelectorMap[54]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"SUIT_TEMP", 1, &SelectorMap[37]},
  {"COCKKPIT_LIGHT_MODE_SW", 0, &SelectorMap[41]},
  {"BLEED_AIR_KNOB", 2, &SelectorMap[15]},
  {nullptr, 0, nullptr},
  {"FLOOD_DIMMER", 0, &SelectorMap[48]},
  {"BATTERY_SW", 1, &SelectorMap[7]},
  {"CABIN_PRESS_SW", 1, &SelectorMap[22]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"RADAR_SW", 2, &SelectorMap[86]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"L_GEN_SW", 0, &SelectorMap[9]},
  {"CABIN_TEMP", 0, &SelectorMap[25]},
  {"BLEED_AIR_KNOB", 3, &SelectorMap[16]},
  {"LTD_R_SW", 0, &SelectorMap[82]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"R_GEN_SW", 0, &SelectorMap[11]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  ...
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"BLEED_AIR_KNOB", 1, &SelectorMap[14]},
  {"BLEED_AIR_KNOB", 1, &SelectorMap[18]},
  {"ECS_MODE_SW", 0, &SelectorMap[27]},
  {"SUIT_TEMP", 65535, &SelectorMap[35]},
  {"WARN_CAUTION_DIMMER", 0, &SelectorMap[56]},
  {"FCS_BIT_SW", 1, &SelectorMap[66]},
  {"RADAR_SW_PULL", 1, &SelectorMap[90]},
  {nullptr, 0, nullptr},
  {"CONSOLES_DIMMER", 1, &SelectorMap[46]},
  {nullptr, 0, nullptr},
  {"INS_SW", 0, &SelectorMap[70]},
  {"INS_SW", 0, &SelectorMap[78]},
  {"CONSOLES_DIMMER", 0, &SelectorMap[45]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"R_GEN_SW", 1, &SelectorMap[12]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CB_HOOOK", 1, &SelectorMap[63]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"DEFOG_HANDLE", 65535, &SelectorMap[0]},
  {"CB_FCS_CHAN4", 1, &SelectorMap[62]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"ECS_MODE_SW", 2, &SelectorMap[29]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"DEFOG_HANDLE", 0, &SelectorMap[1]},
  {"BLEED_AIR_PULL", 0, &SelectorMap[19]},
  {"CABIN_TEMP", 65535, &SelectorMap[24]},
  {nullptr, 0, nullptr},
  {"CABIN_PRESS_SW", 2, &SelectorMap[23]},
  {"FLOOD_DIMMER", 1, &SelectorMap[49]},
  {"ECS_MODE_SW", 1, &SelectorMap[28]},
  {"INS_SW", 1, &SelectorMap[71]},
  {"INS_SW", 1, &SelectorMap[79]},
  {nullptr, 0, nullptr},
  {"RADAR_SW", 3, &SelectorMap[87]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"WSHIELD_ANTI_ICE_SW", 0, &SelectorMap[3]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"L_GEN_SW", 1, &SelectorMap[10]},
  {nullptr, 0, nullptr},
  {"CABIN_PRESS_SW", 0, &SelectorMap[21]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"BLEED_AIR_KNOB", 0, &SelectorMap[13]},
  {"BLEED_AIR_KNOB", 0, &SelectorMap[17]},
  {"CB_FCS_CHAN3", 1, &SelectorMap[61]},
  {"CHART_DIMMER", 0, &SelectorMap[39]},
  {"INS_SW", 5, &SelectorMap[75]},
  {"RADAR_SW", 0, &SelectorMap[84]},
  {"RADAR_SW", 0, &SelectorMap[88]},
  {nullptr, 0, nullptr},
  {"WSHIELD_ANTI_ICE_SW", 1, &SelectorMap[4]},
  {"INST_PNL_DIMMER", 65535, &SelectorMap[50]},
  {"CHART_DIMMER", 1, &SelectorMap[40]},
  {"FCS_BIT_SW", 0, &SelectorMap[65]},
  {nullptr, 0, nullptr},
  {"ENG_ANTIICE_SW", 1, &SelectorMap[31]},
  {nullptr, 0, nullptr},
  {"FLIR_SW", 0, &SelectorMap[67]},
  {"WARN_CAUTION_DIMMER", 65535, &SelectorMap[55]},
  {"WARN_CAUTION_DIMMER", 1, &SelectorMap[57]},
  {"ENG_ANTIICE_SW", 2, &SelectorMap[32]},
  {nullptr, 0, nullptr},
  {"CANOPY_SW", 0, &SelectorMap[58]},
  {"SUIT_TEMP", 0, &SelectorMap[36]},
  {"CANOPY_SW", 1, &SelectorMap[59]},
  {"CHART_DIMMER", 65535, &SelectorMap[38]},
  {"PITOT_HEAT_SW", 0, &SelectorMap[33]},
  {nullptr, 0, nullptr},
  {"INST_PNL_DIMMER", 1, &SelectorMap[52]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"FLIR_SW", 1, &SelectorMap[68]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"INS_SW", 3, &SelectorMap[73]},
  {"RADAR_SW", 1, &SelectorMap[85]},
  {"RADAR_SW", 1, &SelectorMap[89]},
  {nullptr, 0, nullptr},
  {"INST_PNL_DIMMER", 0, &SelectorMap[51]},
  {"BATTERY_SW", 0, &SelectorMap[6]},
  {"PITOT_HEAT_SW", 1, &SelectorMap[34]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"LST_NFLR_SW", 1, &SelectorMap[81]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"INS_SW", 2, &SelectorMap[72]},
  {"WSHIELD_ANTI_ICE_SW", 2, &SelectorMap[5]},
...
inline const SelectorEntry* findSelectorByDcsAndValue(const char* dcsCommand, uint16_t value) {
  uint16_t startH = (labelHash(dcsCommand) ^ (value * 7919u)) % 191;
...
static CommandHistoryEntry commandHistory[] = {
    { "BATTERY_SW", 0, 0, true, 2, 0,   0, false, 0, {0}, {0}, 0 },
    { "BLEED_AIR_KNOB", 0, 0, true, 5, 0,   0, false, 0, {0}, {0}, 0 },
    { "BLEED_AIR_PULL", 0, 0, true, 18, 0,   0, false, 0, {0}, {0}, 0 },
    { "CABIN_PRESS_SW", 0, 0, true, 6, 0,   0, false, 0, {0}, {0}, 0 },
    { "CABIN_TEMP", 0, 0, false, 0, 0,   0, false, 0, {0}, {0}, 0 },
    { "CANOPY_SW", 0, 0, true, 12, 0,   0, false, 0, {0}, {0}, 0 },
    ...
    { "COCKKPIT_LIGHT_MODE_SW", 0, 0, true, 10, 0,   0, false, 0, {0}, {0}, 0 },
    { "CONSOLES_DIMMER", 0, 0, false, 0, 0,   0, false, 0, {0}, {0}, 0 },
    { "DEFOG_HANDLE", 0, 0, false, 0, 0,   0, false, 0, {0}, {0}, 0 },
    { "ECS_MODE_SW", 0, 0, true, 7, 0,   0, false, 0, {0}, {0}, 0 },
    { "ENG_ANTIICE_SW", 0, 0, true, 8, 0,   0, false, 0, {0}, {0}, 0 },
    { "FCS_BIT_SW", 0, 0, true, 19, 0,   0, false, 0, {0}, {0}, 0 },
    { "FLIR_SW", 0, 0, true, 13, 0,   0, false, 0, {0}, {0}, 0 },
    { "FLOOD_DIMMER", 0, 0, false, 0, 0,   0, false, 0, {0}, {0}, 0 },
    { "INST_PNL_DIMMER", 0, 0, false, 0, 0,   0, false, 0, {0}, {0}, 0 },
    { "INS_SW", 0, 0, true, 14, 0,   0, false, 0, {0}, {0}, 0 },
    { "LIGHTS_TEST_SW", 0, 0, true, 11, 0,   0, false, 0, {0}, {0}, 0 },
    { "LST_NFLR_SW", 0, 0, true, 15, 0,   0, false, 0, {0}, {0}, 0 },
    { "LTD_R_SW", 0, 0, true, 16, 0,   0, false, 0, {0}, {0}, 0 },
    { "L_GEN_SW", 0, 0, true, 3, 0,   0, false, 0, {0}, {0}, 0 },
    { "PITOT_HEAT_SW", 0, 0, true, 9, 0,   0, false, 0, {0}, {0}, 0 },
    { "RADAR_SW", 0, 0, true, 17, 0,   0, false, 0, {0}, {0}, 0 },
    { "RADAR_SW_PULL", 0, 0, false, 0, 0,   0, false, 0, {0}, {0}, 0 },
    { "R_GEN_SW", 0, 0, true, 4, 0,   0, false, 0, {0}, {0}, 0 },
    { "SUIT_TEMP", 0, 0, false, 0, 0,   0, false, 0, {0}, {0}, 0 },
    { "WARN_CAUTION_DIMMER", 0, 0, false, 0, 0,   0, false, 0, {0}, {0}, 0 },
    { "WSHIELD_ANTI_ICE_SW", 0, 0, true, 1, 0,   0, false, 0, {0}, {0}, 0 },
};
