...
// ================== RIGHT ENGINE RPM ==================
const SegmentMap IFEI_RPM_R_MAP[3][7] = {
...
// ================== FUEL FLOW LEFT ==================
const SegmentMap IFEI_FF_L_MAP[3][7] = {
...
const SegmentMap IFEI_FF_TEXTURE_LABEL = {16, 0, 0};

// ================== FUEL FLOW RIGHT ==================
const SegmentMap IFEI_FF_R_MAP[3][7] = {
...
// ================== TEMP/SP FIELDS ==================
const SegmentMap IFEI_SP_MAP[3][7] = {
...
const SegmentMap IFEI_TEMP_L_MAP[3][7] = {
    { {11,3,0}, {11,2,0}, {11,1,0}, {11,0,0}, {9,1,0}, {9,3,0}, {9,2,0} },
    { {15,3,0}, {15,2,0}, {15,1,0}, {15,0,0}, {13,1,0}, {13,3,0}, {13,2,0} },
    { {19,3,0}, {19,2,0}, {19,1,0}, {19,0,0}, {17,1,0}, {17,3,0}, {17,2,0} }
};
const SegmentMap IFEI_TEMP_TEXTURE_LABEL = {18, 0, 0};
const SegmentMap IFEI_CODES_MAP[3][7] = {
...
const SegmentMap IFEI_TEMP_R_MAP[3][7] = {
    { {23,3,0}, {23,2,0}, {23,1,0}, {23,0,0}, {21,1,0}, {21,3,0}, {21,2,0} },
    { {27,3,0}, {27,2,0}, {27,1,0}, {27,0,0}, {25,1,0}, {25,3,0}, {25,2,0} },
    { {31,3,0}, {31,2,0}, {31,1,0}, {31,0,0}, {29,1,0}, {29,3,0}, {29,2,0} }
};

// ================== NOZZLE/POINTER LABELS ==================
const SegmentMap IFEI_NOZ_TEXTURE_LABEL = {37, 3, 0};
const SegmentMap IFEI_LPOINTER_TEXTURE_LABEL = {43, 3, 0};
const SegmentMap IFEI_RPOINTER_TEXTURE_LABEL = {33, 3, 0};

// ================== NOZZLE/POINTER CUSTOM ==================
const SegmentMap IFEI_NOZZLE_L_MAP[1][11] = {
    { {14,0,0}, {12,0,0}, {10,0,0}, {42,0,0}, {42,1,0}, {42,2,0}, {42,3,0}, {43,0,0}, {43,1,0}, {43,2,0}, {43,3,0} }
};
const SegmentMap IFEI_NOZZLE_R_MAP[1][11] = {
    { {20,0,0}, {24,0,0}, {26,0,0}, {32,0,0}, {32,1,0}, {32,2,0}, {32,3,0}, {33,0,0}, {33,1,0}, {33,2,0}, {33,3,0} }
};

// ================== OIL PRESSURE ==================
const SegmentMap IFEI_OIL_PRESS_L_MAP[3][7] = {
...
const SegmentMap IFEI_OIL_PRESS_R_MAP[3][7] = {
...
const SegmentMap IFEI_OIL_TEXTURE_LABEL = {36, 3, 0};

// ================== FUEL UP/DOWN ==================
const SegmentMap IFEI_FUEL_UP_MAP[6][14] = {
...
const SegmentMap IFEI_FUEL_DOWN_MAP[6][14] = {
...
const SegmentMap IFEI_L_TEXTURE_LABEL = {21, 0, 1};
const SegmentMap IFEI_R_TEXTURE_LABEL = {20, 0, 1};

// ================== BINGO ==================
const SegmentMap IFEI_BINGO_MAP[5][7] = {
...
const SegmentMap IFEI_TIME_SET_MODE_MAP[6][14] = {
    { {41,0,1}, {40,3,1}, {40,2,1}, {40,1,1}, {42,1,1}, {42,3,1}, {42,2,1},
      {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1} },
    { {37,0,1}, {36,3,1}, {36,2,1}, {36,1,1}, {38,1,1}, {38,3,1}, {38,2,1},
      {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1}, {0xFF,0xFF,1} },
