...
static const SelectorEntry SelectorMap[] = {
    { "PLT_CMWS_ARM_ARM","PLT_CMWS_ARM",0,"selector",1,"ARM" },
    { "PLT_CMWS_ARM_SAFE","PLT_CMWS_ARM",1,"selector",1,"SAFE" },
    { "PLT_CMWS_BYPASS_BYPASS","PLT_CMWS_BYPASS",0,"selector",2,"BYPASS" },
    { "PLT_CMWS_BYPASS_AUTO","PLT_CMWS_BYPASS",1,"selector",2,"AUTO" },
    { "PLT_CMWS_JETT_POS0","PLT_CMWS_JETT",0,"selector",6,"POS0" },
    { "PLT_CMWS_JETT_POS1","PLT_CMWS_JETT",1,"selector",6,"POS1" },
    { "PLT_CMWS_JETT_CVR_OPEN","PLT_CMWS_JETT_CVR",0,"selector",3,"OPEN" },
    { "PLT_CMWS_JETT_CVR_CLOSE","PLT_CMWS_JETT_CVR",1,"selector",3,"CLOSE" },
    ...
    { "PLT_CMWS_MODE_CMWS","PLT_CMWS_MODE",0,"selector",4,"CMWS" },
    { "PLT_CMWS_MODE_NAV","PLT_CMWS_MODE",1,"selector",4,"NAV" },
