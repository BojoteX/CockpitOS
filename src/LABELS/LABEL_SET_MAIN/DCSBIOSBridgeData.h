...
static const AddressEntry dcsAddressTable[] = {
  { 0x740C, { &DcsOutputTable[0], &DcsOutputTable[1], &DcsOutputTable[51], &DcsOutputTable[52], &DcsOutputTable[53], &DcsOutputTable[54], &DcsOutputTable[55], &DcsOutputTable[56], &DcsOutputTable[57], &DcsOutputTable[69], &DcsOutputTable[70], &DcsOutputTable[71], &DcsOutputTable[72], &DcsOutputTable[73] }, 14 },
  { 0x7408, { &DcsOutputTable[2], &DcsOutputTable[4], &DcsOutputTable[6], &DcsOutputTable[32], &DcsOutputTable[33], &DcsOutputTable[36], &DcsOutputTable[37], &DcsOutputTable[38], &DcsOutputTable[40], &DcsOutputTable[41], &DcsOutputTable[42], &DcsOutputTable[43], &DcsOutputTable[44], &DcsOutputTable[45], &DcsOutputTable[58], &DcsOutputTable[59] }, 16 },
  { 0x758C, { &DcsOutputTable[3] }, 1 },
  { 0x7590, { &DcsOutputTable[5] }, 1 },
  { 0x758E, { &DcsOutputTable[7] }, 1 },
  { 0x74A4, { &DcsOutputTable[8], &DcsOutputTable[9], &DcsOutputTable[11], &DcsOutputTable[12], &DcsOutputTable[13], &DcsOutputTable[14], &DcsOutputTable[17], &DcsOutputTable[18] }, 8 },
  { 0x74A0, { &DcsOutputTable[10] }, 1 },
  { 0x74A8, { &DcsOutputTable[15], &DcsOutputTable[16], &DcsOutputTable[19] }, 3 },
  { 0x742C, { &DcsOutputTable[20] }, 1 },
  { 0x740E, { &DcsOutputTable[21] }, 1 },
  { 0x754A, { &DcsOutputTable[22] }, 1 },
  { 0x74C8, { &DcsOutputTable[23], &DcsOutputTable[27] }, 2 },
  { 0x7544, { &DcsOutputTable[24] }, 1 },
  { 0x7548, { &DcsOutputTable[25] }, 1 },
  { 0x7546, { &DcsOutputTable[26] }, 1 },
  { 0x754C, { &DcsOutputTable[28] }, 1 },
  { 0x740A, { &DcsOutputTable[29], &DcsOutputTable[30], &DcsOutputTable[31], &DcsOutputTable[34], &DcsOutputTable[35], &DcsOutputTable[39], &DcsOutputTable[60], &DcsOutputTable[61], &DcsOutputTable[62], &DcsOutputTable[63], &DcsOutputTable[64], &DcsOutputTable[65], &DcsOutputTable[66], &DcsOutputTable[67], &DcsOutputTable[68] }, 15 },
  { 0x7456, { &DcsOutputTable[46] }, 1 },
  { 0x742A, { &DcsOutputTable[47], &DcsOutputTable[48], &DcsOutputTable[49], &DcsOutputTable[50] }, 4 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[53] = {
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x74C8, &dcsAddressTable[11] },
  { 0x742A, &dcsAddressTable[18] },
  {0xFFFF, nullptr},
  { 0x742C, &dcsAddressTable[8] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x74A4, &dcsAddressTable[5] },
  { 0x7544, &dcsAddressTable[12] },
  {0xFFFF, nullptr},
  { 0x7408, &dcsAddressTable[1] },
  { 0x74A8, &dcsAddressTable[7] },
  { 0x7548, &dcsAddressTable[13] },
  { 0x7546, &dcsAddressTable[14] },
  { 0x740C, &dcsAddressTable[0] },
  { 0x754A, &dcsAddressTable[10] },
  { 0x740E, &dcsAddressTable[9] },
  { 0x754C, &dcsAddressTable[15] },
  { 0x740A, &dcsAddressTable[16] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
