...
static const SelectorEntry SelectorMap[] = {
    ...
    { "IR_COOL_SW_ORIDE","IR_COOL_SW",0,"selector",3,"ORIDE" },
    { "IR_COOL_SW_NORM","IR_COOL_SW",1,"selector",3,"NORM" },
    { "IR_COOL_SW_OFF","IR_COOL_SW",2,"selector",3,"OFF" },
    { "SPIN_RECOVERY_COVER","SPIN_RECOVERY_COVER",1,"momentary",0,"OPEN" },
    { "SPIN_RECOVERY_SW_RCVY","SPIN_RECOVERY_SW",0,"selector",4,"RCVY" },
    { "SPIN_RECOVERY_SW_NORM","SPIN_RECOVERY_SW",1,"selector",4,"NORM" },
    { "MASTER_ARM_SW_ARM","MASTER_ARM_SW",0,"selector",5,"ARM" },
    { "MASTER_ARM_SW_SAFE","MASTER_ARM_SW",1,"selector",5,"SAFE" },
