...
static const InputMapping InputMappings[] = {
    { "APU_FIRE_BTN"               , "TM1637" , PIN(40) ,  0 ,  -1 , "APU_FIRE_BTN"           ,     1 , "momentary"    ,  0 ,  0 },
    { "EMER_JETT_BTN"              , "PCA_0x5B" ,  0 ,  4 ,  -1 , "EMER_JETT_BTN"          ,     1 , "momentary"    ,  0 ,  0 },
    { "FIRE_EXT_BTN"               , "PCA_0x5B" ,  0 ,  2 ,  16 , "FIRE_EXT_BTN"           ,     1 , "momentary"    ,  0 ,  0 },
    ...
    { "LEFT_FIRE_BTN"              , "TM1637" , PIN(39) ,  0 ,  -1 , "LEFT_FIRE_BTN"          ,     1 , "momentary"    ,  0 ,  0 },
    { "LEFT_FIRE_BTN_COVER"        , "NONE" ,  0 ,  0 ,  -1 , "LEFT_FIRE_BTN_COVER"    ,     1 , "momentary"    ,  0 ,  0 },
    { "HMD_OFF_BRT"                , "GPIO" , PIN(18) ,  0 ,  -1 , "HMD_OFF_BRT"            , 65535 , "analog"       ,  0 ,  0 },
    { "HMD_OFF_BRT_DEC"            , "NONE" ,  0 ,  0 ,  -1 , "HMD_OFF_BRT"            ,     0 , "variable_step",  0 ,  0 },
    { "HMD_OFF_BRT_INC"            , "NONE" ,  0 ,  0 ,  -1 , "HMD_OFF_BRT"            ,     1 , "variable_step",  0 ,  0 },
    { "IR_COOL_SW_OFF"             , "PCA_0x26" ,  1 ,  1 ,  23 , "IR_COOL_SW"             ,     0 , "selector"     ,  6 ,  0 },
    { "IR_COOL_SW_NORM"            , "PCA_0x26" ,  1 , -1 ,  24 , "IR_COOL_SW"             ,     1 , "selector"     ,  6 ,  0 },
    { "IR_COOL_SW_ORIDE"           , "PCA_0x26" ,  1 ,  0 ,  25 , "IR_COOL_SW"             ,     2 , "selector"     ,  6 ,  0 },
    { "SPIN_RECOVERY_COVER"        , "PCA_0x26" ,  0 ,  0 ,  -1 , "SPIN_RECOVERY_COVER"    ,     1 , "momentary"    ,  0 ,  0 },
    { "SPIN_RECOVERY_SW_NORM"      , "PCA_0x26" ,  1 , -1 ,  22 , "SPIN_RECOVERY_SW"       ,     0 , "selector"     ,  7 ,  0 },
    { "SPIN_RECOVERY_SW_RCVY"      , "PCA_0x26" ,  1 ,  2 ,  21 , "SPIN_RECOVERY_SW"       ,     1 , "selector"     ,  7 ,  0 },
    { "MASTER_ARM_SW_SAFE"         , "PCA_0x5B" ,  0 ,  3 ,  18 , "MASTER_ARM_SW"          ,     0 , "selector"     ,  8 ,  0 },
    { "MASTER_ARM_SW_ARM"          , "PCA_0x5B" ,  0 , -1 ,  17 , "MASTER_ARM_SW"          ,     1 , "selector"     ,  8 ,  0 },
    { "MASTER_MODE_AA"             , "PCA_0x5B" ,  0 ,  1 ,  19 , "MASTER_MODE_AA"         ,     1 , "momentary"    ,  0 ,  0 },
    { "MASTER_MODE_AG"             , "PCA_0x5B" ,  0 ,  0 ,  20 , "MASTER_MODE_AG"         ,     1 , "momentary"    ,  0 ,  0 },
    { "MASTER_CAUTION_RESET_SW"    , "TM1637" , PIN(39) ,  9 ,  -1 , "MASTER_CAUTION_RESET_SW",     1 , "momentary"    ,  0 ,  0 },
    { "RIGHT_FIRE_BTN"             , "TM1637" , PIN(40) ,  9 ,  -1 , "RIGHT_FIRE_BTN"         ,     1 , "momentary"    ,  0 ,  0 },
    { "RIGHT_FIRE_BTN_COVER"       , "NONE" ,  0 ,  0 ,  -1 , "RIGHT_FIRE_BTN_COVER"   ,     1 , "momentary"    ,  0 ,  0 },
};
