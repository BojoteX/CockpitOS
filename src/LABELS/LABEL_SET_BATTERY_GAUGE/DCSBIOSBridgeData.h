...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x754A, { &DcsOutputTable[5] }, 1 },
  { 0x74C8, { &DcsOutputTable[6], &DcsOutputTable[10] }, 2 },
  { 0x7544, { &DcsOutputTable[7] }, 1 },
  { 0x7548, { &DcsOutputTable[8] }, 1 },
  { 0x7546, { &DcsOutputTable[9] }, 1 },
  { 0x754C, { &DcsOutputTable[11] }, 1 },
...
static const DcsAddressHashEntry dcsAddressHashTable[131] = {
  { 0x0418, &dcsAddressTable[33] },
  { 0x0419, &dcsAddressTable[34] },
  { 0x041A, &dcsAddressTable[35] },
  { 0x041B, &dcsAddressTable[36] },
  { 0x041C, &dcsAddressTable[37] },
  { 0x041D, &dcsAddressTable[38] },
  { 0x0000, &dcsAddressTable[40] },
  { 0x0001, &dcsAddressTable[41] },
  { 0x0002, &dcsAddressTable[42] },
  { 0x0003, &dcsAddressTable[43] },
  { 0x0004, &dcsAddressTable[44] },
  { 0x0005, &dcsAddressTable[45] },
  { 0x0006, &dcsAddressTable[46] },
  { 0x753C, &dcsAddressTable[2] },
  { 0x0007, &dcsAddressTable[47] },
  { 0x753E, &dcsAddressTable[1] },
  { 0x0008, &dcsAddressTable[48] },
  { 0x0009, &dcsAddressTable[49] },
  { 0x000A, &dcsAddressTable[50] },
  { 0x000B, &dcsAddressTable[51] },
  { 0x000C, &dcsAddressTable[52] },
  { 0x7544, &dcsAddressTable[5] },
  { 0x000D, &dcsAddressTable[53] },
  { 0x7546, &dcsAddressTable[7] },
  { 0x74C4, &dcsAddressTable[0] },
  { 0x7548, &dcsAddressTable[6] },
  { 0x000E, &dcsAddressTable[54] },
  { 0x754A, &dcsAddressTable[3] },
  { 0x74C8, &dcsAddressTable[4] },
  { 0x754C, &dcsAddressTable[8] },
  { 0x000F, &dcsAddressTable[55] },
  { 0x0010, &dcsAddressTable[56] },
  { 0x0011, &dcsAddressTable[57] },
  { 0x0012, &dcsAddressTable[58] },
  { 0xFFFE, &dcsAddressTable[39] },
  { 0x0013, &dcsAddressTable[59] },
  { 0x0014, &dcsAddressTable[60] },
  { 0x0015, &dcsAddressTable[61] },
  { 0x0016, &dcsAddressTable[62] },
  { 0x0017, &dcsAddressTable[63] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x0400, &dcsAddressTable[9] },
  { 0x0401, &dcsAddressTable[10] },
  { 0x0402, &dcsAddressTable[11] },
  { 0x0403, &dcsAddressTable[12] },
  { 0x0404, &dcsAddressTable[13] },
  { 0x0405, &dcsAddressTable[14] },
  { 0x0406, &dcsAddressTable[15] },
  { 0x0407, &dcsAddressTable[16] },
  { 0x0408, &dcsAddressTable[17] },
  { 0x0409, &dcsAddressTable[18] },
  { 0x040A, &dcsAddressTable[19] },
  { 0x040B, &dcsAddressTable[20] },
  { 0x040C, &dcsAddressTable[21] },
  { 0x040D, &dcsAddressTable[22] },
  { 0x040E, &dcsAddressTable[23] },
  { 0x040F, &dcsAddressTable[24] },
  { 0x0410, &dcsAddressTable[25] },
  { 0x0411, &dcsAddressTable[26] },
  { 0x0412, &dcsAddressTable[27] },
  { 0x0413, &dcsAddressTable[28] },
  { 0x0414, &dcsAddressTable[29] },
  { 0x0415, &dcsAddressTable[30] },
  { 0x0416, &dcsAddressTable[31] },
  { 0x0417, &dcsAddressTable[32] },
};
...
inline const AddressEntry* findDcsOutputEntries(uint16_t addr) {
  ...
  for (uint16_t i = 0; i < 131; ++i) {
    uint16_t idx = (startH + i >= 131) ? (startH + i - 131) : (startH + i);
