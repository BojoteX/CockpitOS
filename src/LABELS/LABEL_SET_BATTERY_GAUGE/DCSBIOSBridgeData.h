...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x7408, { &DcsOutputTable[5], &DcsOutputTable[6] }, 2 },
  { 0x0400, { &DcsOutputTable[7] }, 1 },
  { 0x0401, { &DcsOutputTable[8] }, 1 },
  { 0x0402, { &DcsOutputTable[9] }, 1 },
  { 0x0403, { &DcsOutputTable[10] }, 1 },
  { 0x0404, { &DcsOutputTable[11] }, 1 },
  { 0x0405, { &DcsOutputTable[12] }, 1 },
  { 0x0406, { &DcsOutputTable[13] }, 1 },
  { 0x0407, { &DcsOutputTable[14] }, 1 },
  { 0x0408, { &DcsOutputTable[15] }, 1 },
  { 0x0409, { &DcsOutputTable[16] }, 1 },
  { 0x040A, { &DcsOutputTable[17] }, 1 },
  { 0x040B, { &DcsOutputTable[18] }, 1 },
  { 0x040C, { &DcsOutputTable[19] }, 1 },
  { 0x040D, { &DcsOutputTable[20] }, 1 },
  { 0x040E, { &DcsOutputTable[21] }, 1 },
  { 0x040F, { &DcsOutputTable[22] }, 1 },
  { 0x0410, { &DcsOutputTable[23] }, 1 },
  { 0x0411, { &DcsOutputTable[24] }, 1 },
  { 0x0412, { &DcsOutputTable[25] }, 1 },
  { 0x0413, { &DcsOutputTable[26] }, 1 },
  { 0x0414, { &DcsOutputTable[27] }, 1 },
  { 0x0415, { &DcsOutputTable[28] }, 1 },
  { 0x0416, { &DcsOutputTable[29] }, 1 },
  { 0x0417, { &DcsOutputTable[30] }, 1 },
  { 0x0418, { &DcsOutputTable[31] }, 1 },
  { 0x0419, { &DcsOutputTable[32] }, 1 },
  { 0x041A, { &DcsOutputTable[33] }, 1 },
  { 0x041B, { &DcsOutputTable[34] }, 1 },
  { 0x041C, { &DcsOutputTable[35] }, 1 },
  { 0x041D, { &DcsOutputTable[36] }, 1 },
  { 0xFFFE, { &DcsOutputTable[37], &DcsOutputTable[38] }, 2 },
  { 0x0000, { &DcsOutputTable[39] }, 1 },
  { 0x0001, { &DcsOutputTable[40] }, 1 },
  { 0x0002, { &DcsOutputTable[41] }, 1 },
  { 0x0003, { &DcsOutputTable[42] }, 1 },
  { 0x0004, { &DcsOutputTable[43] }, 1 },
  { 0x0005, { &DcsOutputTable[44] }, 1 },
  { 0x0006, { &DcsOutputTable[45] }, 1 },
  { 0x0007, { &DcsOutputTable[46] }, 1 },
  { 0x0008, { &DcsOutputTable[47] }, 1 },
  { 0x0009, { &DcsOutputTable[48] }, 1 },
  { 0x000A, { &DcsOutputTable[49] }, 1 },
  { 0x000B, { &DcsOutputTable[50] }, 1 },
  { 0x000C, { &DcsOutputTable[51] }, 1 },
  { 0x000D, { &DcsOutputTable[52] }, 1 },
  { 0x000E, { &DcsOutputTable[53] }, 1 },
  { 0x000F, { &DcsOutputTable[54] }, 1 },
  { 0x0010, { &DcsOutputTable[55] }, 1 },
  { 0x0011, { &DcsOutputTable[56] }, 1 },
  { 0x0012, { &DcsOutputTable[57] }, 1 },
  { 0x0013, { &DcsOutputTable[58] }, 1 },
  { 0x0014, { &DcsOutputTable[59] }, 1 },
  { 0x0015, { &DcsOutputTable[60] }, 1 },
  { 0x0016, { &DcsOutputTable[61] }, 1 },
  { 0x0017, { &DcsOutputTable[62] }, 1 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[127] = {
  { 0x0000, &dcsAddressTable[35] },
  { 0x0001, &dcsAddressTable[36] },
  { 0xFFFE, &dcsAddressTable[34] },
  { 0x0002, &dcsAddressTable[37] },
  { 0x0003, &dcsAddressTable[38] },
  { 0x0004, &dcsAddressTable[39] },
  { 0x0005, &dcsAddressTable[40] },
  { 0x0006, &dcsAddressTable[41] },
  { 0x0400, &dcsAddressTable[4] },
  { 0x0401, &dcsAddressTable[5] },
  { 0x0402, &dcsAddressTable[6] },
  { 0x0403, &dcsAddressTable[7] },
  { 0x0404, &dcsAddressTable[8] },
  { 0x0405, &dcsAddressTable[9] },
  { 0x0406, &dcsAddressTable[10] },
  { 0x0407, &dcsAddressTable[11] },
  { 0x0408, &dcsAddressTable[12] },
  { 0x0409, &dcsAddressTable[13] },
  { 0x040A, &dcsAddressTable[14] },
  { 0x040B, &dcsAddressTable[15] },
  { 0x040C, &dcsAddressTable[16] },
  { 0x040D, &dcsAddressTable[17] },
  { 0x040E, &dcsAddressTable[18] },
  { 0x040F, &dcsAddressTable[19] },
  { 0x0410, &dcsAddressTable[20] },
  { 0x0411, &dcsAddressTable[21] },
  { 0x0412, &dcsAddressTable[22] },
  { 0x0413, &dcsAddressTable[23] },
  { 0x0414, &dcsAddressTable[24] },
  { 0x0415, &dcsAddressTable[25] },
  { 0x0416, &dcsAddressTable[26] },
  { 0x0417, &dcsAddressTable[27] },
  { 0x0418, &dcsAddressTable[28] },
  { 0x0419, &dcsAddressTable[29] },
  { 0x041A, &dcsAddressTable[30] },
  { 0x041B, &dcsAddressTable[31] },
  { 0x041C, &dcsAddressTable[32] },
  { 0x041D, &dcsAddressTable[33] },
  { 0x0007, &dcsAddressTable[42] },
  { 0x0008, &dcsAddressTable[43] },
  { 0x753C, &dcsAddressTable[2] },
  { 0x0009, &dcsAddressTable[44] },
  { 0x753E, &dcsAddressTable[1] },
  { 0x000A, &dcsAddressTable[45] },
  { 0x000B, &dcsAddressTable[46] },
  { 0x000C, &dcsAddressTable[47] },
  { 0x000D, &dcsAddressTable[48] },
  { 0x74C4, &dcsAddressTable[0] },
  { 0x000E, &dcsAddressTable[49] },
  { 0x000F, &dcsAddressTable[50] },
  { 0x0010, &dcsAddressTable[51] },
  { 0x0011, &dcsAddressTable[52] },
  { 0x0012, &dcsAddressTable[53] },
  { 0x0013, &dcsAddressTable[54] },
  { 0x0014, &dcsAddressTable[55] },
  { 0x0015, &dcsAddressTable[56] },
  { 0x0016, &dcsAddressTable[57] },
  { 0x0017, &dcsAddressTable[58] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
