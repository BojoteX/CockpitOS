...
static const InputMapping InputMappings[] = {
    ...
    { "APU_CONTROL_SW_ON"          , "GPIO" ,  1 ,  0 ,  -1 , "APU_CONTROL_SW"        ,     1 , "selector"     ,  1 , 0 },
    { "ENGINE_CRANK_SW_RIGHT"      , "GPIO" , 39 ,  0 ,  -1 , "ENGINE_CRANK_SW"       ,     0 , "selector"     ,  2 , 0 },
    { "ENGINE_CRANK_SW_OFF"        , "GPIO" , -1 ,  0 ,  -1 , "ENGINE_CRANK_SW"       ,     1 , "selector"     ,  2 , 0 },
    { "ENGINE_CRANK_SW_LEFT"       , "GPIO" , 40 ,  0 ,  -1 , "ENGINE_CRANK_SW"       ,     2 , "selector"     ,  2 , 0 },
    ...
    { "COCKKPIT_LIGHT_MODE_SW_DAY" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     0 , "selector"     ,  3 , 0 },
    { "COCKKPIT_LIGHT_MODE_SW_NITE", "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     1 , "selector"     ,  3 , 0 },
    { "COCKKPIT_LIGHT_MODE_SW_NVG" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     2 , "selector"     ,  3 , 0 },
    ...
    { "LIGHTS_TEST_SW_OFF"         , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"        ,     0 , "selector"     ,  4 , 0 },
    { "LIGHTS_TEST_SW_TEST"        , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"        ,     1 , "selector"     ,  4 , 0 },
...
static const InputHashEntry inputHashTable[53] = {
  {nullptr, nullptr},
  {"WARN_CAUTION_DIMMER_DEC", &InputMappings[23]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"WARN_CAUTION_DIMMER_INC", &InputMappings[24]},
  {"CHART_DIMMER_INC", &InputMappings[7]},
  {"INST_PNL_DIMMER", &InputMappings[17]},
  {"CONSOLES_DIMMER_DEC", &InputMappings[12]},
  {"LIGHTS_TEST_SW_TEST", &InputMappings[21]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"CONSOLES_DIMMER_INC", &InputMappings[13]},
  {nullptr, nullptr},
  {"APU_CONTROL_SW_OFF", &InputMappings[0]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"COCKKPIT_LIGHT_MODE_SW_NVG", &InputMappings[10]},
  {"CHART_DIMMER", &InputMappings[5]},
  {"APU_CONTROL_SW_ON", &InputMappings[1]},
  {"CHART_DIMMER_DEC", &InputMappings[6]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"FLOOD_DIMMER", &InputMappings[14]},
  {nullptr, nullptr},
  {"FLOOD_DIMMER_DEC", &InputMappings[15]},
  {nullptr, nullptr},
  {"CONSOLES_DIMMER", &InputMappings[11]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"COCKKPIT_LIGHT_MODE_SW_DAY", &InputMappings[8]},
  {"COCKKPIT_LIGHT_MODE_SW_NITE", &InputMappings[9]},
  {"WARN_CAUTION_DIMMER", &InputMappings[22]},
  {"FLOOD_DIMMER_INC", &InputMappings[16]},
  {nullptr, nullptr},
  {"INST_PNL_DIMMER_DEC", &InputMappings[18]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {"INST_PNL_DIMMER_INC", &InputMappings[19]},
  {"LIGHTS_TEST_SW_OFF", &InputMappings[20]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
