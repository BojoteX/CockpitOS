...
static const InputMapping InputMappings[] = {
    { "FIRE_TEST_SW_POS0"            , "PCA_0x26" ,  0 ,  5 ,  -1 , "FIRE_TEST_SW"           ,     0 , "selector"     ,  1 ,  0 },
    { "FIRE_TEST_SW_POS1"            , "PCA_0x26" ,  0 , -1 ,  -1 , "FIRE_TEST_SW"           ,     1 , "selector"     ,  1 ,  0 },
    { "FIRE_TEST_SW_POS2"            , "PCA_0x26" ,  0 ,  6 ,  -1 , "FIRE_TEST_SW"           ,     2 , "selector"     ,  1 ,  0 },
    { "GEN_TIE_COVER"                , "NONE" ,  0 ,  0 ,  -1 , "GEN_TIE_COVER"          ,     1 , "momentary"    ,  0 ,  0 },
    { "GEN_TIE_SW_RESET"             , "PCA_0x26" ,  1 ,  3 ,  -1 , "GEN_TIE_SW"             ,     1 , "selector"     ,  2 ,  0 },
    { "GEN_TIE_SW_NORM"              , "PCA_0x26" ,  1 , -1 ,  -1 , "GEN_TIE_SW"             ,     0 , "selector"     ,  2 ,  0 },
    ...
    { "COCKKPIT_LIGHT_MODE_SW_DAY"   , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW" ,     2 , "selector"     , 11 ,  0 },
    { "COCKKPIT_LIGHT_MODE_SW_NITE"  , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW" ,     1 , "selector"     , 11 ,  0 },
    { "COCKKPIT_LIGHT_MODE_SW_NVG"   , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW" ,     0 , "selector"     , 11 ,  0 },
    ...
    { "LIGHTS_TEST_SW_OFF"           , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"         ,     1 , "selector"     , 12 ,  0 },
    { "LIGHTS_TEST_SW_TEST"          , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"         ,     0 , "selector"     , 12 ,  0 },
    ...
    { "HYD_ISOLATE_OVERRIDE_SW_ORIDE", "PCA_0x26" ,  1 , -1 ,  -1 , "HYD_ISOLATE_OVERRIDE_SW",     1 , "selector"     ,  3 ,  0 },
    { "HYD_ISOLATE_OVERRIDE_SW_NORM" , "PCA_0x26" ,  1 ,  2 ,  -1 , "HYD_ISOLATE_OVERRIDE_SW",     0 , "selector"     ,  3 ,  0 },
    { "MC_SW_2_OFF"                  , "PCA_0x26" ,  1 ,  0 ,  -1 , "MC_SW"                  ,     2 , "selector"     ,  4 ,  0 },
    { "MC_SW_NORM"                   , "PCA_0x26" ,  1 , -1 ,  -1 , "MC_SW"                  ,     1 , "selector"     ,  4 ,  0 },
    { "MC_SW_1_OFF"                  , "PCA_0x26" ,  1 ,  1 ,  -1 , "MC_SW"                  ,     0 , "selector"     ,  4 ,  0 },
    { "ANTI_SKID_SW_PRESS"           , "NONE" ,  0 ,  0 ,  -1 , "ANTI_SKID_SW"           ,     0 , "selector"     ,  5 ,  0 },
    { "ANTI_SKID_SW_RELEASE"         , "NONE" ,  0 ,  0 ,  -1 , "ANTI_SKID_SW"           ,     1 , "selector"     ,  5 ,  0 },
    { "FLAP_SW_FULL"                 , "NONE" ,  0 ,  0 ,  -1 , "FLAP_SW"                ,     2 , "selector"     ,  6 ,  0 },
    { "FLAP_SW_HALF"                 , "NONE" ,  0 ,  0 ,  -1 , "FLAP_SW"                ,     1 , "selector"     ,  6 ,  0 },
    { "FLAP_SW_AUTO"                 , "NONE" ,  0 ,  0 ,  -1 , "FLAP_SW"                ,     0 , "selector"     ,  6 ,  0 },
    { "HOOK_BYPASS_SW_CARRIER"       , "NONE" ,  0 ,  0 ,  -1 , "HOOK_BYPASS_SW"         ,     1 , "selector"     ,  7 ,  0 },
    { "HOOK_BYPASS_SW_FIELD"         , "NONE" ,  0 ,  0 ,  -1 , "HOOK_BYPASS_SW"         ,     0 , "selector"     ,  7 ,  0 },
    { "LAUNCH_BAR_SW_PRESS"          , "NONE" ,  0 ,  0 ,  -1 , "LAUNCH_BAR_SW"          ,     0 , "selector"     ,  8 ,  0 },
    { "LAUNCH_BAR_SW_RELEASE"        , "NONE" ,  0 ,  0 ,  -1 , "LAUNCH_BAR_SW"          ,     1 , "selector"     ,  8 ,  0 },
    { "LDG_TAXI_SW_TAXI_LIGHT_SWITCH", "NONE" ,  0 ,  0 ,  -1 , "LDG_TAXI_SW"            ,     1 , "selector"     ,  9 ,  0 },
    { "LDG_TAXI_SW_LDG"              , "NONE" ,  0 ,  0 ,  -1 , "LDG_TAXI_SW"            ,     0 , "selector"     ,  9 ,  0 },
    { "SEL_JETT_BTN"                 , "NONE" ,  0 ,  0 ,  -1 , "SEL_JETT_BTN"           ,     1 , "momentary"    ,  0 ,  0 },
    { "SEL_JETT_KNOB_STORES"         , "NONE" ,  0 ,  0 ,  -1 , "SEL_JETT_KNOB"          ,     0 , "selector"     , 10 ,  0 },
    { "SEL_JETT_KNOB_RACK/LCHR"      , "NONE" ,  0 ,  0 ,  -1 , "SEL_JETT_KNOB"          ,     1 , "selector"     , 10 ,  0 },
    { "SEL_JETT_KNOB_R_FUS_MSL"      , "NONE" ,  0 ,  0 ,  -1 , "SEL_JETT_KNOB"          ,     2 , "selector"     , 10 ,  0 },
    { "SEL_JETT_KNOB_SAFE"           , "NONE" ,  0 ,  0 ,  -1 , "SEL_JETT_KNOB"          ,     3 , "selector"     , 10 ,  0 },
    { "SEL_JETT_KNOB_L_FUS_MSL"      , "NONE" ,  0 ,  0 ,  -1 , "SEL_JETT_KNOB"          ,     4 , "selector"     , 10 ,  0 },
    { "SEL_JETT_KNOB_DEC"            , "NONE" ,  0 ,  0 ,  -1 , "SEL_JETT_KNOB"          ,     0 , "fixed_step"   ,  0 ,  0 },
    { "SEL_JETT_KNOB_INC"            , "NONE" ,  0 ,  0 ,  -1 , "SEL_JETT_KNOB"          ,     1 , "fixed_step"   ,  0 ,  0 },
};
...
static const InputHashEntry inputHashTable[101] = {
  ...
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"SEL_JETT_KNOB_R_FUS_MSL", &InputMappings[45]},
  ...
  {nullptr, nullptr},
  {"SEL_JETT_KNOB_RACK/LCHR", &InputMappings[44]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {"SEL_JETT_KNOB_STORES", &InputMappings[43]},
  {"WARN_CAUTION_DIMMER_DEC", &InputMappings[24]},
  {"MC_SW_2_OFF", &InputMappings[28]},
  {"SEL_JETT_KNOB_SAFE", &InputMappings[46]},
  ...
  {"SEL_JETT_KNOB_L_FUS_MSL", &InputMappings[47]},
