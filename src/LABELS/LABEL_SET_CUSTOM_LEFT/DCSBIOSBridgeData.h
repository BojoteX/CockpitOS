...
static const SelectorEntry SelectorMap[] = {
    ...
    { "GEN_TIE_SW_RESET","GEN_TIE_SW",0,"selector",1,"RESET" },
    { "GEN_TIE_SW_NORM","GEN_TIE_SW",1,"selector",1,"NORM" },
    ...
    { "HYD_ISOLATE_OVERRIDE_SW_ORIDE","HYD_ISOLATE_OVERRIDE_SW",0,"selector",4,"ORIDE" },
    { "HYD_ISOLATE_OVERRIDE_SW_NORM","HYD_ISOLATE_OVERRIDE_SW",1,"selector",4,"NORM" },
    { "MC_SW_2_OFF","MC_SW",0,"selector",5,"2_OFF" },
    { "MC_SW_NORM","MC_SW",1,"selector",5,"NORM" },
    { "MC_SW_1_OFF","MC_SW",2,"selector",5,"1_OFF" },
    { "ANTI_SKID_SW_PRESS","ANTI_SKID_SW",0,"selector",11,"PRESS" },
    { "ANTI_SKID_SW_RELEASE","ANTI_SKID_SW",1,"selector",11,"RELEASE" },
    { "FLAP_SW_FULL","FLAP_SW",0,"selector",6,"FULL" },
    { "FLAP_SW_HALF","FLAP_SW",1,"selector",6,"HALF" },
    { "FLAP_SW_AUTO","FLAP_SW",2,"selector",6,"AUTO" },
    { "HOOK_BYPASS_SW_CARRIER","HOOK_BYPASS_SW",0,"selector",7,"CARRIER" },
    { "HOOK_BYPASS_SW_FIELD","HOOK_BYPASS_SW",1,"selector",7,"FIELD" },
    { "LAUNCH_BAR_SW_PRESS","LAUNCH_BAR_SW",0,"selector",12,"PRESS" },
    { "LAUNCH_BAR_SW_RELEASE","LAUNCH_BAR_SW",1,"selector",12,"RELEASE" },
    { "LDG_TAXI_SW_TAXI_LIGHT_SWITCH","LDG_TAXI_SW",0,"selector",8,"TAXI_LIGHT_SWITCH" },
    { "LDG_TAXI_SW_LDG","LDG_TAXI_SW",1,"selector",8,"LDG" },
    { "SEL_JETT_BTN","SEL_JETT_BTN",1,"momentary",0,"PRESS" },
    { "SEL_JETT_KNOB_STORES","SEL_JETT_KNOB",0,"selector",9,"STORES" },
    { "SEL_JETT_KNOB_RACK/LCHR","SEL_JETT_KNOB",1,"selector",9,"RACK/LCHR" },
    { "SEL_JETT_KNOB_R_FUS_MSL","SEL_JETT_KNOB",2,"selector",9,"R_FUS_MSL" },
    { "SEL_JETT_KNOB_SAFE","SEL_JETT_KNOB",3,"selector",9,"SAFE" },
    { "SEL_JETT_KNOB_L_FUS_MSL","SEL_JETT_KNOB",4,"selector",9,"L_FUS_MSL" },
    { "SEL_JETT_KNOB_DEC","SEL_JETT_KNOB",0,"fixed_step",0,"DEC" },
    { "SEL_JETT_KNOB_INC","SEL_JETT_KNOB",1,"fixed_step",0,"INC" },
};
...
static const SelectorHashEntry selectorHashTable[101] = {
  {"FIRE_TEST_SW", 0, &SelectorMap[0]},
  {"HYD_ISOLATE_OVERRIDE_SW", 1, &SelectorMap[27]},
  {"ANTI_SKID_SW", 1, &SelectorMap[32]},
  {"GEN_TIE_SW", 1, &SelectorMap[5]},
  {"LAUNCH_BAR_SW", 1, &SelectorMap[39]},
  {"SEL_JETT_BTN", 1, &SelectorMap[42]},
  {"HOOK_BYPASS_SW", 0, &SelectorMap[36]},
  {"SEL_JETT_KNOB", 4, &SelectorMap[47]},
  {"LDG_TAXI_SW", 0, &SelectorMap[40]},
  {"SEL_JETT_KNOB", 1, &SelectorMap[44]},
  {"SEL_JETT_KNOB", 1, &SelectorMap[49]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"COCKKPIT_LIGHT_MODE_SW", 0, &SelectorMap[9]},
  {"INST_PNL_DIMMER", 1, &SelectorMap[20]},
  {"COCKKPIT_LIGHT_MODE_SW", 2, &SelectorMap[11]},
  {"WARN_CAUTION_DIMMER", 1, &SelectorMap[25]},
  {nullptr, 0, nullptr},
  {"GEN_TIE_COVER", 1, &SelectorMap[3]},
  {"COCKKPIT_LIGHT_MODE_SW", 1, &SelectorMap[10]},
  {"GEN_TIE_SW", 0, &SelectorMap[4]},
  {"FLOOD_DIMMER", 65535, &SelectorMap[15]},
  {nullptr, 0, nullptr},
  {"LAUNCH_BAR_SW", 0, &SelectorMap[38]},
  {nullptr, 0, nullptr},
  {"CHART_DIMMER", 0, &SelectorMap[7]},
  {"FLOOD_DIMMER", 0, &SelectorMap[16]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"LIGHTS_TEST_SW", 1, &SelectorMap[22]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"FLAP_SW", 2, &SelectorMap[35]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"FIRE_TEST_SW", 2, &SelectorMap[2]},
  {"CONSOLES_DIMMER", 0, &SelectorMap[13]},
  {"FLAP_SW", 1, &SelectorMap[34]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"INST_PNL_DIMMER", 0, &SelectorMap[19]},
  {"FIRE_TEST_SW", 1, &SelectorMap[1]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"FLOOD_DIMMER", 1, &SelectorMap[17]},
  {"MC_SW", 2, &SelectorMap[30]},
  {"WARN_CAUTION_DIMMER", 65535, &SelectorMap[23]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"INST_PNL_DIMMER", 65535, &SelectorMap[18]},
  {"LIGHTS_TEST_SW", 0, &SelectorMap[21]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"ANTI_SKID_SW", 0, &SelectorMap[31]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"MC_SW", 1, &SelectorMap[29]},
  {"FLAP_SW", 0, &SelectorMap[33]},
  {"SEL_JETT_KNOB", 2, &SelectorMap[45]},
  {"SEL_JETT_KNOB", 3, &SelectorMap[46]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  ...
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"HYD_ISOLATE_OVERRIDE_SW", 0, &SelectorMap[26]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"CHART_DIMMER", 65535, &SelectorMap[6]},
  {"CONSOLES_DIMMER", 1, &SelectorMap[14]},
  {"CHART_DIMMER", 1, &SelectorMap[8]},
  {"CONSOLES_DIMMER", 65535, &SelectorMap[12]},
  {"HOOK_BYPASS_SW", 1, &SelectorMap[37]},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {nullptr, 0, nullptr},
  {"SEL_JETT_KNOB", 0, &SelectorMap[43]},
  {"SEL_JETT_KNOB", 0, &SelectorMap[48]},
  {nullptr, 0, nullptr},
  {"LDG_TAXI_SW", 1, &SelectorMap[41]},
  {"MC_SW", 0, &SelectorMap[28]},
  {nullptr, 0, nullptr},
  {"WARN_CAUTION_DIMMER", 0, &SelectorMap[24]},
  {nullptr, 0, nullptr},
};
...
inline const SelectorEntry* findSelectorByDcsAndValue(const char* dcsCommand, uint16_t value) {
  uint16_t startH = (labelHash(dcsCommand) ^ (value * 7919u)) % 101;
...
static CommandHistoryEntry commandHistory[] = {
    { "ANTI_SKID_SW", 0, 0, true, 11, 0,   0, false, 0, {0}, {0}, 0 },
    ...
    { "FIRE_TEST_SW", 0, 0, true, 10, 0,   0, false, 0, {0}, {0}, 0 },
    ...
    { "LAUNCH_BAR_SW", 0, 0, true, 12, 0,   0, false, 0, {0}, {0}, 0 },
    ...
    { "SEL_JETT_KNOB", 0, 0, true, 9, 0,   0, false, 0, {0}, {0}, 0 },
