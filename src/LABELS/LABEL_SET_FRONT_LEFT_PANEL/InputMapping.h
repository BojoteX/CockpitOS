...
static const InputMapping InputMappings[] = {
    ...
    { "FIRE_TEST_SW_POS0"          , "GPIO" , PIN(33) ,  0 ,  -1 , "FIRE_TEST_SW"          ,     0 , "selector"     ,  3 },
    { "FIRE_TEST_SW_POS1"          , "GPIO" , -1 ,  0 ,  -1 , "FIRE_TEST_SW"          ,     1 , "selector"     ,  3 },
    { "FIRE_TEST_SW_POS2"          , "GPIO" , PIN(21) ,  0 ,  -1 , "FIRE_TEST_SW"          ,     2 , "selector"     ,  3 },
    { "GEN_TIE_COVER"              , "PCA_0x00" ,  0 ,  0 ,  -1 , "GEN_TIE_COVER"         ,     1 , "momentary"    ,  0 },
    { "GEN_TIE_SW_NORM"            , "GPIO" , -1 ,  0 ,  -1 , "GEN_TIE_SW"            ,     0 , "selector"     ,  4 },
    { "GEN_TIE_SW_RESET"           , "GPIO" , PIN(6) ,  0 ,  -1 , "GEN_TIE_SW"            ,     1 , "selector"     ,  4 },
...
static const InputHashEntry inputHashTable[107] = {
  {"WARN_CAUTION_DIMMER", &InputMappings[49]},
  {"WARN_CAUTION_DIMMER_INC", &InputMappings[51]},
  {nullptr, nullptr},
  {"GND_PWR_2_SW_A_ON", &InputMappings[23]},
  {"CONSOLES_DIMMER_DEC", &InputMappings[39]},
  {nullptr, nullptr},
  {"CHART_DIMMER_DEC", &InputMappings[33]},
  {"COCKKPIT_LIGHT_MODE_SW_NVG", &InputMappings[35]},
  {"GND_PWR_1_SW_A_ON", &InputMappings[20]},
  {"CONSOLES_DIMMER", &InputMappings[38]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"GEN_TIE_SW_RESET", &InputMappings[16]},
  {"INST_PNL_DIMMER_INC", &InputMappings[46]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"COCKKPIT_LIGHT_MODE_SW_NITE", &InputMappings[36]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"WARN_CAUTION_DIMMER_DEC", &InputMappings[50]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {"FIRE_TEST_SW_POS0", &InputMappings[11]},
  {"FIRE_TEST_SW_POS1", &InputMappings[12]},
  {"FORMATION_DIMMER_INC", &InputMappings[2]},
  {"FIRE_TEST_SW_POS2", &InputMappings[13]},
  {"INST_PNL_DIMMER", &InputMappings[44]},
  {"INST_PNL_DIMMER_DEC", &InputMappings[45]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"FLOOD_DIMMER_INC", &InputMappings[43]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"LIGHTS_TEST_SW_TEST", &InputMappings[47]},
  {nullptr, nullptr},
  {"FLOOD_DIMMER", &InputMappings[41]},
  {"CONSOLES_DIMMER_INC", &InputMappings[40]},
  {nullptr, nullptr},
  {"GND_PWR_4_SW_AUTO", &InputMappings[30]},
  {"GEN_TIE_SW_NORM", &InputMappings[15]},
  {"CHART_DIMMER_INC", &InputMappings[34]},
  {"LIGHTS_TEST_SW_OFF", &InputMappings[48]},
  {nullptr, nullptr},
  {"GND_PWR_3_SW_AUTO", &InputMappings[27]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"GND_PWR_4_SW_B_ON", &InputMappings[31]},
  {"POSITION_DIMMER", &InputMappings[5]},
  {"POSITION_DIMMER_DEC", &InputMappings[6]},
  {"GND_PWR_2_SW_AUTO", &InputMappings[24]},
  {"GEN_TIE_COVER", &InputMappings[14]},
  {"FORMATION_DIMMER_DEC", &InputMappings[1]},
  {"GND_PWR_1_SW_AUTO", &InputMappings[21]},
  {"GND_PWR_3_SW_B_ON", &InputMappings[28]},
  {"CHART_DIMMER", &InputMappings[32]},
  {nullptr, nullptr},
  {"GND_PWR_2_SW_B_ON", &InputMappings[25]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"EXT_PWR_SW_RESET", &InputMappings[17]},
  {"EXT_PWR_SW_NORM", &InputMappings[18]},
  {"GND_PWR_1_SW_B_ON", &InputMappings[22]},
  {"GND_PWR_4_SW_A_ON", &InputMappings[29]},
  {"EXT_PWR_SW_OFF", &InputMappings[19]},
  {"COCKKPIT_LIGHT_MODE_SW_DAY", &InputMappings[37]},
  {"GND_PWR_3_SW_A_ON", &InputMappings[26]},
  {"FLOOD_DIMMER_DEC", &InputMappings[42]},
};
...
inline const InputMapping* findInputByLabel(const char* label) {
  uint16_t startH = inputHash(label) % 107;
