...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x74B0, { &DcsOutputTable[3], &DcsOutputTable[10], &DcsOutputTable[11] }, 3 },
  { 0x74AC, { &DcsOutputTable[4], &DcsOutputTable[7], &DcsOutputTable[8], &DcsOutputTable[9] }, 4 },
  { 0x74C2, { &DcsOutputTable[5], &DcsOutputTable[6] }, 2 },
  { 0x754A, { &DcsOutputTable[12] }, 1 },
  { 0x74C8, { &DcsOutputTable[13], &DcsOutputTable[17] }, 2 },
  { 0x7544, { &DcsOutputTable[14] }, 1 },
  { 0x7548, { &DcsOutputTable[15] }, 1 },
  { 0x7546, { &DcsOutputTable[16] }, 1 },
  { 0x754C, { &DcsOutputTable[18] }, 1 },
};
...
static const SelectorEntry SelectorMap[] = {
    ...
    { "INT_WNG_TANK_SW_INHIBIT","INT_WNG_TANK_SW",0,"selector",1,"INHIBIT" },
    { "INT_WNG_TANK_SW_NORM","INT_WNG_TANK_SW",1,"selector",1,"NORM" },
    ...
    { "STROBE_SW_POS0","STROBE_SW",0,"selector",10,"POS0" },
    { "STROBE_SW_POS1","STROBE_SW",1,"selector",10,"POS1" },
    { "STROBE_SW_POS2","STROBE_SW",2,"selector",10,"POS2" },
    { "FIRE_TEST_SW_POS0","FIRE_TEST_SW",0,"selector",11,"POS0" },
    { "FIRE_TEST_SW_POS1","FIRE_TEST_SW",1,"selector",11,"POS1" },
    { "FIRE_TEST_SW_POS2","FIRE_TEST_SW",2,"selector",11,"POS2" },
    { "GEN_TIE_COVER","GEN_TIE_COVER",1,"momentary",0,"OPEN" },
    { "GEN_TIE_SW_NORM","GEN_TIE_SW",0,"selector",2,"NORM" },
    { "GEN_TIE_SW_RESET","GEN_TIE_SW",1,"selector",2,"RESET" },
    { "EXT_PWR_SW_RESET","EXT_PWR_SW",0,"selector",3,"RESET" },
    { "EXT_PWR_SW_NORM","EXT_PWR_SW",1,"selector",3,"NORM" },
    { "EXT_PWR_SW_OFF","EXT_PWR_SW",2,"selector",3,"OFF" },
    { "GND_PWR_1_SW_A_ON","GND_PWR_1_SW",0,"selector",4,"A_ON" },
    { "GND_PWR_1_SW_AUTO","GND_PWR_1_SW",1,"selector",4,"AUTO" },
    { "GND_PWR_1_SW_B_ON","GND_PWR_1_SW",2,"selector",4,"B_ON" },
    { "GND_PWR_2_SW_A_ON","GND_PWR_2_SW",0,"selector",5,"A_ON" },
    { "GND_PWR_2_SW_AUTO","GND_PWR_2_SW",1,"selector",5,"AUTO" },
    { "GND_PWR_2_SW_B_ON","GND_PWR_2_SW",2,"selector",5,"B_ON" },
    { "GND_PWR_3_SW_A_ON","GND_PWR_3_SW",0,"selector",6,"A_ON" },
    { "GND_PWR_3_SW_AUTO","GND_PWR_3_SW",1,"selector",6,"AUTO" },
    { "GND_PWR_3_SW_B_ON","GND_PWR_3_SW",2,"selector",6,"B_ON" },
    { "GND_PWR_4_SW_A_ON","GND_PWR_4_SW",0,"selector",7,"A_ON" },
    { "GND_PWR_4_SW_AUTO","GND_PWR_4_SW",1,"selector",7,"AUTO" },
    { "GND_PWR_4_SW_B_ON","GND_PWR_4_SW",2,"selector",7,"B_ON" },
    ...
    { "COCKKPIT_LIGHT_MODE_SW_NVG","COCKKPIT_LIGHT_MODE_SW",0,"selector",8,"NVG" },
    { "COCKKPIT_LIGHT_MODE_SW_NITE","COCKKPIT_LIGHT_MODE_SW",1,"selector",8,"NITE" },
    { "COCKKPIT_LIGHT_MODE_SW_DAY","COCKKPIT_LIGHT_MODE_SW",2,"selector",8,"DAY" },
    ...
    { "LIGHTS_TEST_SW_TEST","LIGHTS_TEST_SW",0,"selector",9,"TEST" },
    { "LIGHTS_TEST_SW_OFF","LIGHTS_TEST_SW",1,"selector",9,"OFF" },
...
static CommandHistoryEntry commandHistory[] = {
    ...
    { "EXT_PWR_SW", 0, 0, true, 3, 0,   0, false, {0}, {0}, 0 },
    { "FIRE_TEST_SW", 0, 0, true, 11, 0,   0, false, {0}, {0}, 0 },
    ...
    { "GEN_TIE_SW", 0, 0, true, 2, 0,   0, false, {0}, {0}, 0 },
    { "GND_PWR_1_SW", 0, 0, true, 4, 0,   0, false, {0}, {0}, 0 },
    { "GND_PWR_2_SW", 0, 0, true, 5, 0,   0, false, {0}, {0}, 0 },
    { "GND_PWR_3_SW", 0, 0, true, 6, 0,   0, false, {0}, {0}, 0 },
    { "GND_PWR_4_SW", 0, 0, true, 7, 0,   0, false, {0}, {0}, 0 },
    ...
    { "STROBE_SW", 0, 0, true, 10, 0,   0, false, {0}, {0}, 0 },
