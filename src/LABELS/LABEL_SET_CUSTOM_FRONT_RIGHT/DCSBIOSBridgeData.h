...
static const AddressEntry dcsAddressTable[] = {
  { 0x74A0, { &DcsOutputTable[0], &DcsOutputTable[1], &DcsOutputTable[4], &DcsOutputTable[14], &DcsOutputTable[26], &DcsOutputTable[30], &DcsOutputTable[31] }, 7 },
  ...
  { 0x749C, { &DcsOutputTable[24], &DcsOutputTable[29] }, 2 },
  { 0x751A, { &DcsOutputTable[25] }, 1 },
  { 0x7518, { &DcsOutputTable[27] }, 1 },
  { 0x751C, { &DcsOutputTable[28] }, 1 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[53] = {
  ...
  { 0x7518, &dcsAddressTable[13] },
  {0xFFFF, nullptr},
  { 0x751A, &dcsAddressTable[12] },
  {0xFFFF, nullptr},
  { 0x751C, &dcsAddressTable[14] },
  {0xFFFF, nullptr},
