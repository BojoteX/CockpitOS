...
static const InputMapping InputMappings[] = {
    { "APU_CONTROL_SW_OFF"   , "GPIO" , -1 ,  0 ,  -1 , "APU_CONTROL_SW" ,     0 , "selector",  1 },
    { "APU_CONTROL_SW_ON"    , "GPIO" ,  1 ,  0 ,  -1 , "APU_CONTROL_SW" ,     1 , "selector",  1 },
    { "ENGINE_CRANK_SW_RIGHT", "NONE" ,  0 ,  0 ,  -1 , "ENGINE_CRANK_SW",     0 , "selector",  2 },
    { "ENGINE_CRANK_SW_OFF"  , "NONE" ,  0 ,  0 ,  -1 , "ENGINE_CRANK_SW",     1 , "selector",  2 },
    { "ENGINE_CRANK_SW_LEFT" , "NONE" ,  0 ,  0 ,  -1 , "ENGINE_CRANK_SW",     2 , "selector",  2 },
};
