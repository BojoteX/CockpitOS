...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x74D6, { &DcsOutputTable[4], &DcsOutputTable[5], &DcsOutputTable[7], &DcsOutputTable[10], &DcsOutputTable[11], &DcsOutputTable[14], &DcsOutputTable[15], &DcsOutputTable[73] }, 8 },
  { 0x7574, { &DcsOutputTable[6] }, 1 },
  { 0x756E, { &DcsOutputTable[8] }, 1 },
  { 0x7572, { &DcsOutputTable[9] }, 1 },
  { 0x7570, { &DcsOutputTable[12] }, 1 },
  { 0x74D8, { &DcsOutputTable[13], &DcsOutputTable[59] }, 2 },
  { 0x7468, { &DcsOutputTable[16] }, 1 },
  { 0x7469, { &DcsOutputTable[17] }, 1 },
  { 0x746A, { &DcsOutputTable[18] }, 1 },
  { 0x746B, { &DcsOutputTable[19] }, 1 },
  { 0x746C, { &DcsOutputTable[20] }, 1 },
  { 0x74C6, { &DcsOutputTable[21] }, 1 },
  { 0x746E, { &DcsOutputTable[22] }, 1 },
  { 0x746F, { &DcsOutputTable[23] }, 1 },
  { 0x7470, { &DcsOutputTable[24] }, 1 },
  { 0x7471, { &DcsOutputTable[25] }, 1 },
  { 0x7472, { &DcsOutputTable[26] }, 1 },
  { 0x7473, { &DcsOutputTable[27] }, 1 },
  { 0x74AE, { &DcsOutputTable[28] }, 1 },
  { 0x74AF, { &DcsOutputTable[29] }, 1 },
  { 0x74B0, { &DcsOutputTable[30] }, 1 },
  { 0x747A, { &DcsOutputTable[31] }, 1 },
  { 0x747C, { &DcsOutputTable[32] }, 1 },
  { 0x747E, { &DcsOutputTable[33] }, 1 },
  { 0x7480, { &DcsOutputTable[34] }, 1 },
  { 0x7466, { &DcsOutputTable[35], &DcsOutputTable[36], &DcsOutputTable[62], &DcsOutputTable[71], &DcsOutputTable[113], &DcsOutputTable[114] }, 6 },
  { 0x7482, { &DcsOutputTable[37] }, 1 },
  { 0x7483, { &DcsOutputTable[38] }, 1 },
  { 0x7484, { &DcsOutputTable[39] }, 1 },
  { 0x7486, { &DcsOutputTable[40] }, 1 },
  { 0x7487, { &DcsOutputTable[41] }, 1 },
  { 0x7488, { &DcsOutputTable[42] }, 1 },
  { 0x74C0, { &DcsOutputTable[43] }, 1 },
  { 0x748A, { &DcsOutputTable[44] }, 1 },
  { 0x748B, { &DcsOutputTable[45] }, 1 },
  { 0x748C, { &DcsOutputTable[46] }, 1 },
  { 0x748D, { &DcsOutputTable[47] }, 1 },
  { 0x748E, { &DcsOutputTable[48] }, 1 },
  { 0x748F, { &DcsOutputTable[49] }, 1 },
  { 0x7490, { &DcsOutputTable[50] }, 1 },
  { 0x7491, { &DcsOutputTable[51] }, 1 },
  { 0x7492, { &DcsOutputTable[52] }, 1 },
  { 0x7493, { &DcsOutputTable[53] }, 1 },
  { 0x7494, { &DcsOutputTable[54] }, 1 },
  { 0x7495, { &DcsOutputTable[55] }, 1 },
  { 0x74CC, { &DcsOutputTable[56] }, 1 },
  { 0x74D4, { &DcsOutputTable[57], &DcsOutputTable[125], &DcsOutputTable[126] }, 3 },
  { 0x74D0, { &DcsOutputTable[58] }, 1 },
  { 0x74C8, { &DcsOutputTable[60], &DcsOutputTable[117], &DcsOutputTable[121] }, 3 },
  { 0x7582, { &DcsOutputTable[61] }, 1 },
  { 0x74C2, { &DcsOutputTable[63] }, 1 },
  { 0x7496, { &DcsOutputTable[64] }, 1 },
  { 0x7497, { &DcsOutputTable[65] }, 1 },
  { 0x7498, { &DcsOutputTable[66] }, 1 },
  { 0x749A, { &DcsOutputTable[67] }, 1 },
  { 0x749B, { &DcsOutputTable[68] }, 1 },
  { 0x749C, { &DcsOutputTable[69] }, 1 },
  { 0x74C4, { &DcsOutputTable[70] }, 1 },
  { 0x74CE, { &DcsOutputTable[72] }, 1 },
  { 0x74D2, { &DcsOutputTable[74] }, 1 },
  { 0x749E, { &DcsOutputTable[75] }, 1 },
  { 0x749F, { &DcsOutputTable[76] }, 1 },
  { 0x74A0, { &DcsOutputTable[77] }, 1 },
  { 0x74A2, { &DcsOutputTable[78] }, 1 },
  { 0x74A3, { &DcsOutputTable[79] }, 1 },
  { 0x74A4, { &DcsOutputTable[80] }, 1 },
  { 0x74BC, { &DcsOutputTable[81] }, 1 },
  { 0x74DA, { &DcsOutputTable[82] }, 1 },
  { 0x74CA, { &DcsOutputTable[83] }, 1 },
  { 0x7584, { &DcsOutputTable[84] }, 1 },
  { 0x74B2, { &DcsOutputTable[85] }, 1 },
  { 0x74B3, { &DcsOutputTable[86] }, 1 },
  { 0x74B4, { &DcsOutputTable[87] }, 1 },
  { 0x757C, { &DcsOutputTable[88] }, 1 },
  { 0x757D, { &DcsOutputTable[89] }, 1 },
  { 0x757E, { &DcsOutputTable[90] }, 1 },
  { 0x757F, { &DcsOutputTable[91] }, 1 },
  { 0x7580, { &DcsOutputTable[92] }, 1 },
  { 0x7581, { &DcsOutputTable[93] }, 1 },
  { 0x74A6, { &DcsOutputTable[94] }, 1 },
  { 0x74A7, { &DcsOutputTable[95] }, 1 },
  { 0x74A8, { &DcsOutputTable[96] }, 1 },
  { 0x74AA, { &DcsOutputTable[97] }, 1 },
  { 0x74AB, { &DcsOutputTable[98] }, 1 },
  { 0x74AC, { &DcsOutputTable[99] }, 1 },
  { 0x74BE, { &DcsOutputTable[100] }, 1 },
  { 0x7474, { &DcsOutputTable[101] }, 1 },
  { 0x7475, { &DcsOutputTable[102] }, 1 },
  { 0x7476, { &DcsOutputTable[103] }, 1 },
  { 0x7477, { &DcsOutputTable[104] }, 1 },
  { 0x7478, { &DcsOutputTable[105] }, 1 },
  { 0x7479, { &DcsOutputTable[106] }, 1 },
  { 0x74B6, { &DcsOutputTable[107] }, 1 },
  { 0x74B7, { &DcsOutputTable[108] }, 1 },
  { 0x74B8, { &DcsOutputTable[109] }, 1 },
  { 0x74B9, { &DcsOutputTable[110] }, 1 },
  { 0x74BA, { &DcsOutputTable[111] }, 1 },
  { 0x74BB, { &DcsOutputTable[112] }, 1 },
  { 0x74DC, { &DcsOutputTable[115] }, 1 },
  { 0x754A, { &DcsOutputTable[116] }, 1 },
  { 0x7544, { &DcsOutputTable[118] }, 1 },
  { 0x7548, { &DcsOutputTable[119] }, 1 },
  { 0x7546, { &DcsOutputTable[120] }, 1 },
  { 0x754C, { &DcsOutputTable[122] }, 1 },
  { 0x755E, { &DcsOutputTable[123] }, 1 },
  { 0x7558, { &DcsOutputTable[124] }, 1 },
  { 0x755A, { &DcsOutputTable[127] }, 1 },
  { 0x7566, { &DcsOutputTable[128] }, 1 },
  { 0x7564, { &DcsOutputTable[129] }, 1 },
  { 0x7560, { &DcsOutputTable[130] }, 1 },
  { 0x755C, { &DcsOutputTable[131] }, 1 },
  { 0x7562, { &DcsOutputTable[132] }, 1 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[233] = {
  { 0x7480, &dcsAddressTable[28] },
  { 0x7566, &dcsAddressTable[111] },
  { 0x7482, &dcsAddressTable[30] },
  { 0x7483, &dcsAddressTable[31] },
  { 0x7484, &dcsAddressTable[32] },
  { 0x756E, &dcsAddressTable[6] },
  { 0x7486, &dcsAddressTable[33] },
  { 0x7570, &dcsAddressTable[8] },
  { 0x7487, &dcsAddressTable[34] },
  { 0x7572, &dcsAddressTable[7] },
  { 0x7488, &dcsAddressTable[35] },
  { 0x7574, &dcsAddressTable[5] },
  { 0x748A, &dcsAddressTable[37] },
  { 0x7576, &dcsAddressTable[0] },
  { 0x748B, &dcsAddressTable[38] },
  { 0x7578, &dcsAddressTable[3] },
  { 0x748C, &dcsAddressTable[39] },
  { 0x757A, &dcsAddressTable[2] },
  { 0x748D, &dcsAddressTable[40] },
  { 0x748E, &dcsAddressTable[41] },
  { 0x748F, &dcsAddressTable[42] },
  { 0x7490, &dcsAddressTable[43] },
  { 0x7491, &dcsAddressTable[44] },
  { 0x7492, &dcsAddressTable[45] },
  { 0x7493, &dcsAddressTable[46] },
  { 0x7494, &dcsAddressTable[47] },
  { 0x7495, &dcsAddressTable[48] },
  { 0x7582, &dcsAddressTable[53] },
  { 0x7496, &dcsAddressTable[55] },
  { 0x7586, &dcsAddressTable[1] },
  { 0x7497, &dcsAddressTable[56] },
  { 0x7498, &dcsAddressTable[57] },
  { 0x749A, &dcsAddressTable[58] },
  { 0x749B, &dcsAddressTable[59] },
  { 0x749C, &dcsAddressTable[60] },
  { 0x749E, &dcsAddressTable[64] },
  { 0x749F, &dcsAddressTable[65] },
  { 0x74A0, &dcsAddressTable[66] },
  { 0x74A2, &dcsAddressTable[67] },
  { 0x74A3, &dcsAddressTable[68] },
  { 0x74A4, &dcsAddressTable[69] },
  { 0x7584, &dcsAddressTable[73] },
  { 0x757C, &dcsAddressTable[77] },
  { 0x757D, &dcsAddressTable[78] },
  { 0x757E, &dcsAddressTable[79] },
  { 0x757F, &dcsAddressTable[80] },
  { 0x74AE, &dcsAddressTable[22] },
  { 0x74AF, &dcsAddressTable[23] },
  { 0x74B0, &dcsAddressTable[24] },
  { 0x7580, &dcsAddressTable[81] },
  { 0x74B2, &dcsAddressTable[74] },
  { 0x74B3, &dcsAddressTable[75] },
  { 0x74B4, &dcsAddressTable[76] },
  { 0x7581, &dcsAddressTable[82] },
  { 0x74A6, &dcsAddressTable[83] },
  { 0x74A7, &dcsAddressTable[84] },
  { 0x74A8, &dcsAddressTable[85] },
  { 0x74AA, &dcsAddressTable[86] },
  { 0x74AB, &dcsAddressTable[87] },
  { 0x74AC, &dcsAddressTable[88] },
  { 0x74BC, &dcsAddressTable[70] },
  { 0x74B6, &dcsAddressTable[96] },
  { 0x74BE, &dcsAddressTable[89] },
  { 0x74B7, &dcsAddressTable[97] },
  { 0x74C0, &dcsAddressTable[36] },
  { 0x74B8, &dcsAddressTable[98] },
  { 0x74C2, &dcsAddressTable[54] },
  { 0x74B9, &dcsAddressTable[99] },
  { 0x74C4, &dcsAddressTable[61] },
  { 0x74BA, &dcsAddressTable[100] },
  { 0x74C6, &dcsAddressTable[15] },
  { 0x74BB, &dcsAddressTable[101] },
  { 0x74C8, &dcsAddressTable[52] },
  { 0x7564, &dcsAddressTable[112] },
  { 0x74CA, &dcsAddressTable[72] },
  { 0x7560, &dcsAddressTable[113] },
  { 0x74CC, &dcsAddressTable[49] },
  { 0x755C, &dcsAddressTable[114] },
  { 0x74CE, &dcsAddressTable[62] },
  { 0x7562, &dcsAddressTable[115] },
  { 0x74D0, &dcsAddressTable[51] },
  {0xFFFF, nullptr},
  { 0x74D2, &dcsAddressTable[63] },
  {0xFFFF, nullptr},
  { 0x74D4, &dcsAddressTable[50] },
  {0xFFFF, nullptr},
  { 0x74D6, &dcsAddressTable[4] },
  {0xFFFF, nullptr},
  { 0x74D8, &dcsAddressTable[9] },
  {0xFFFF, nullptr},
  { 0x74DA, &dcsAddressTable[71] },
  {0xFFFF, nullptr},
  { 0x74DC, &dcsAddressTable[102] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x7544, &dcsAddressTable[104] },
  {0xFFFF, nullptr},
  { 0x7546, &dcsAddressTable[106] },
  {0xFFFF, nullptr},
  { 0x7548, &dcsAddressTable[105] },
  {0xFFFF, nullptr},
  { 0x754A, &dcsAddressTable[103] },
  {0xFFFF, nullptr},
  { 0x754C, &dcsAddressTable[107] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x7466, &dcsAddressTable[29] },
  {0xFFFF, nullptr},
  { 0x7468, &dcsAddressTable[10] },
  { 0x7469, &dcsAddressTable[11] },
  { 0x746A, &dcsAddressTable[12] },
  { 0x746B, &dcsAddressTable[13] },
  { 0x746C, &dcsAddressTable[14] },
  {0xFFFF, nullptr},
  { 0x746E, &dcsAddressTable[16] },
  { 0x746F, &dcsAddressTable[17] },
  { 0x7470, &dcsAddressTable[18] },
  { 0x7471, &dcsAddressTable[19] },
  { 0x7472, &dcsAddressTable[20] },
  { 0x7473, &dcsAddressTable[21] },
  { 0x7474, &dcsAddressTable[90] },
  { 0x7475, &dcsAddressTable[91] },
  { 0x7476, &dcsAddressTable[92] },
  { 0x7477, &dcsAddressTable[93] },
  { 0x7478, &dcsAddressTable[94] },
  { 0x7479, &dcsAddressTable[95] },
  { 0x747A, &dcsAddressTable[25] },
  { 0x755E, &dcsAddressTable[108] },
  { 0x747C, &dcsAddressTable[26] },
  { 0x7558, &dcsAddressTable[109] },
  { 0x747E, &dcsAddressTable[27] },
  { 0x755A, &dcsAddressTable[110] },
};
...
inline const AddressEntry* findDcsOutputEntries(uint16_t addr) {
  ...
  for (uint16_t i = 0; i < 233; ++i) {
    uint16_t idx = (startH + i >= 233) ? (startH + i - 233) : (startH + i);
