...
static const AddressEntry dcsAddressTable[] = {
  { 0x7468, { &DcsOutputTable[0] }, 1 },
  { 0x7469, { &DcsOutputTable[1] }, 1 },
  { 0x746A, { &DcsOutputTable[2] }, 1 },
  { 0x746B, { &DcsOutputTable[3] }, 1 },
  { 0x746C, { &DcsOutputTable[4] }, 1 },
  { 0x74C6, { &DcsOutputTable[5] }, 1 },
  { 0x746E, { &DcsOutputTable[6] }, 1 },
  { 0x746F, { &DcsOutputTable[7] }, 1 },
  { 0x7470, { &DcsOutputTable[8] }, 1 },
  { 0x7471, { &DcsOutputTable[9] }, 1 },
  { 0x7472, { &DcsOutputTable[10] }, 1 },
  { 0x7473, { &DcsOutputTable[11] }, 1 },
  { 0x74AE, { &DcsOutputTable[12] }, 1 },
  { 0x74AF, { &DcsOutputTable[13] }, 1 },
  { 0x74B0, { &DcsOutputTable[14] }, 1 },
  { 0x747A, { &DcsOutputTable[15] }, 1 },
  { 0x747C, { &DcsOutputTable[16] }, 1 },
  { 0x747E, { &DcsOutputTable[17] }, 1 },
  { 0x7480, { &DcsOutputTable[18] }, 1 },
  { 0x7466, { &DcsOutputTable[19], &DcsOutputTable[20], &DcsOutputTable[46], &DcsOutputTable[55], &DcsOutputTable[97], &DcsOutputTable[98] }, 6 },
  { 0x7482, { &DcsOutputTable[21] }, 1 },
  { 0x7483, { &DcsOutputTable[22] }, 1 },
  { 0x7484, { &DcsOutputTable[23] }, 1 },
  { 0x7486, { &DcsOutputTable[24] }, 1 },
  { 0x7487, { &DcsOutputTable[25] }, 1 },
  { 0x7488, { &DcsOutputTable[26] }, 1 },
  { 0x74C0, { &DcsOutputTable[27] }, 1 },
  { 0x748A, { &DcsOutputTable[28] }, 1 },
  { 0x748B, { &DcsOutputTable[29] }, 1 },
  { 0x748C, { &DcsOutputTable[30] }, 1 },
  { 0x748D, { &DcsOutputTable[31] }, 1 },
  { 0x748E, { &DcsOutputTable[32] }, 1 },
  { 0x748F, { &DcsOutputTable[33] }, 1 },
  { 0x7490, { &DcsOutputTable[34] }, 1 },
  { 0x7491, { &DcsOutputTable[35] }, 1 },
  { 0x7492, { &DcsOutputTable[36] }, 1 },
  { 0x7493, { &DcsOutputTable[37] }, 1 },
  { 0x7494, { &DcsOutputTable[38] }, 1 },
  { 0x7495, { &DcsOutputTable[39] }, 1 },
  { 0x74CC, { &DcsOutputTable[40] }, 1 },
  { 0x74D4, { &DcsOutputTable[41] }, 1 },
  { 0x74D0, { &DcsOutputTable[42] }, 1 },
  { 0x74D8, { &DcsOutputTable[43] }, 1 },
  { 0x74C8, { &DcsOutputTable[44] }, 1 },
  { 0x7582, { &DcsOutputTable[45] }, 1 },
  { 0x74C2, { &DcsOutputTable[47] }, 1 },
  { 0x7496, { &DcsOutputTable[48] }, 1 },
  { 0x7497, { &DcsOutputTable[49] }, 1 },
  { 0x7498, { &DcsOutputTable[50] }, 1 },
  { 0x749A, { &DcsOutputTable[51] }, 1 },
  { 0x749B, { &DcsOutputTable[52] }, 1 },
  { 0x749C, { &DcsOutputTable[53] }, 1 },
  { 0x74C4, { &DcsOutputTable[54] }, 1 },
  { 0x74CE, { &DcsOutputTable[56] }, 1 },
  { 0x74D6, { &DcsOutputTable[57] }, 1 },
  { 0x74D2, { &DcsOutputTable[58] }, 1 },
  { 0x749E, { &DcsOutputTable[59] }, 1 },
  { 0x749F, { &DcsOutputTable[60] }, 1 },
  { 0x74A0, { &DcsOutputTable[61] }, 1 },
  { 0x74A2, { &DcsOutputTable[62] }, 1 },
  { 0x74A3, { &DcsOutputTable[63] }, 1 },
  { 0x74A4, { &DcsOutputTable[64] }, 1 },
  { 0x74BC, { &DcsOutputTable[65] }, 1 },
  { 0x74DA, { &DcsOutputTable[66] }, 1 },
  { 0x74CA, { &DcsOutputTable[67] }, 1 },
  { 0x7584, { &DcsOutputTable[68] }, 1 },
  { 0x74B2, { &DcsOutputTable[69] }, 1 },
  { 0x74B3, { &DcsOutputTable[70] }, 1 },
  { 0x74B4, { &DcsOutputTable[71] }, 1 },
  { 0x757C, { &DcsOutputTable[72] }, 1 },
  { 0x757D, { &DcsOutputTable[73] }, 1 },
  { 0x757E, { &DcsOutputTable[74] }, 1 },
  { 0x757F, { &DcsOutputTable[75] }, 1 },
  { 0x7580, { &DcsOutputTable[76] }, 1 },
  { 0x7581, { &DcsOutputTable[77] }, 1 },
  { 0x74A6, { &DcsOutputTable[78] }, 1 },
  { 0x74A7, { &DcsOutputTable[79] }, 1 },
  { 0x74A8, { &DcsOutputTable[80] }, 1 },
  { 0x74AA, { &DcsOutputTable[81] }, 1 },
  { 0x74AB, { &DcsOutputTable[82] }, 1 },
  { 0x74AC, { &DcsOutputTable[83] }, 1 },
  { 0x74BE, { &DcsOutputTable[84] }, 1 },
  { 0x7474, { &DcsOutputTable[85] }, 1 },
  { 0x7475, { &DcsOutputTable[86] }, 1 },
  { 0x7476, { &DcsOutputTable[87] }, 1 },
  { 0x7477, { &DcsOutputTable[88] }, 1 },
  { 0x7478, { &DcsOutputTable[89] }, 1 },
  { 0x7479, { &DcsOutputTable[90] }, 1 },
  { 0x74B6, { &DcsOutputTable[91] }, 1 },
  { 0x74B7, { &DcsOutputTable[92] }, 1 },
  { 0x74B8, { &DcsOutputTable[93] }, 1 },
  { 0x74B9, { &DcsOutputTable[94] }, 1 },
  { 0x74BA, { &DcsOutputTable[95] }, 1 },
  { 0x74BB, { &DcsOutputTable[96] }, 1 },
  { 0x74DC, { &DcsOutputTable[99] }, 1 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[191] = {
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x7466, &dcsAddressTable[19] },
  {0xFFFF, nullptr},
  { 0x7468, &dcsAddressTable[0] },
  { 0x7469, &dcsAddressTable[1] },
  { 0x746A, &dcsAddressTable[2] },
  { 0x746B, &dcsAddressTable[3] },
  { 0x746C, &dcsAddressTable[4] },
  {0xFFFF, nullptr},
  { 0x746E, &dcsAddressTable[6] },
  { 0x746F, &dcsAddressTable[7] },
  { 0x7470, &dcsAddressTable[8] },
  { 0x7471, &dcsAddressTable[9] },
  { 0x7472, &dcsAddressTable[10] },
  { 0x7473, &dcsAddressTable[11] },
  { 0x7474, &dcsAddressTable[82] },
  { 0x7475, &dcsAddressTable[83] },
  { 0x7476, &dcsAddressTable[84] },
  { 0x7477, &dcsAddressTable[85] },
  { 0x7478, &dcsAddressTable[86] },
  { 0x7479, &dcsAddressTable[87] },
  { 0x747A, &dcsAddressTable[15] },
  {0xFFFF, nullptr},
  { 0x747C, &dcsAddressTable[16] },
  {0xFFFF, nullptr},
  { 0x747E, &dcsAddressTable[17] },
  {0xFFFF, nullptr},
  { 0x7480, &dcsAddressTable[18] },
  {0xFFFF, nullptr},
  { 0x7482, &dcsAddressTable[20] },
  { 0x7483, &dcsAddressTable[21] },
  { 0x7484, &dcsAddressTable[22] },
  {0xFFFF, nullptr},
  { 0x7486, &dcsAddressTable[23] },
  { 0x7487, &dcsAddressTable[24] },
  { 0x7488, &dcsAddressTable[25] },
  {0xFFFF, nullptr},
  { 0x748A, &dcsAddressTable[27] },
  { 0x748B, &dcsAddressTable[28] },
  { 0x748C, &dcsAddressTable[29] },
  { 0x748D, &dcsAddressTable[30] },
  { 0x748E, &dcsAddressTable[31] },
  { 0x748F, &dcsAddressTable[32] },
  { 0x7490, &dcsAddressTable[33] },
  { 0x7491, &dcsAddressTable[34] },
  { 0x7492, &dcsAddressTable[35] },
  { 0x7493, &dcsAddressTable[36] },
  { 0x7494, &dcsAddressTable[37] },
  { 0x7495, &dcsAddressTable[38] },
  { 0x7496, &dcsAddressTable[46] },
  { 0x7497, &dcsAddressTable[47] },
  { 0x7498, &dcsAddressTable[48] },
  {0xFFFF, nullptr},
  { 0x749A, &dcsAddressTable[49] },
  { 0x749B, &dcsAddressTable[50] },
  { 0x749C, &dcsAddressTable[51] },
  {0xFFFF, nullptr},
  { 0x749E, &dcsAddressTable[56] },
  { 0x749F, &dcsAddressTable[57] },
  { 0x74A0, &dcsAddressTable[58] },
  {0xFFFF, nullptr},
  { 0x74A2, &dcsAddressTable[59] },
  { 0x74A3, &dcsAddressTable[60] },
  { 0x74A4, &dcsAddressTable[61] },
  {0xFFFF, nullptr},
  { 0x74A6, &dcsAddressTable[75] },
  { 0x74A7, &dcsAddressTable[76] },
  { 0x74A8, &dcsAddressTable[77] },
  {0xFFFF, nullptr},
  { 0x74AA, &dcsAddressTable[78] },
  { 0x74AB, &dcsAddressTable[79] },
  { 0x74AC, &dcsAddressTable[80] },
  {0xFFFF, nullptr},
  { 0x74AE, &dcsAddressTable[12] },
  { 0x74AF, &dcsAddressTable[13] },
  { 0x74B0, &dcsAddressTable[14] },
  {0xFFFF, nullptr},
  { 0x74B2, &dcsAddressTable[66] },
  { 0x74B3, &dcsAddressTable[67] },
  { 0x74B4, &dcsAddressTable[68] },
  {0xFFFF, nullptr},
  { 0x74B6, &dcsAddressTable[88] },
  { 0x74B7, &dcsAddressTable[89] },
  { 0x74B8, &dcsAddressTable[90] },
  { 0x74B9, &dcsAddressTable[91] },
  { 0x74BA, &dcsAddressTable[92] },
  { 0x74BB, &dcsAddressTable[93] },
  { 0x74BC, &dcsAddressTable[62] },
  { 0x757C, &dcsAddressTable[69] },
  { 0x757D, &dcsAddressTable[70] },
  { 0x757E, &dcsAddressTable[71] },
  { 0x74C0, &dcsAddressTable[26] },
  { 0x757F, &dcsAddressTable[72] },
  { 0x74C2, &dcsAddressTable[45] },
  { 0x7582, &dcsAddressTable[44] },
  { 0x74C4, &dcsAddressTable[52] },
  { 0x7584, &dcsAddressTable[65] },
  { 0x74C6, &dcsAddressTable[5] },
  { 0x7580, &dcsAddressTable[73] },
  { 0x74C8, &dcsAddressTable[43] },
  { 0x7581, &dcsAddressTable[74] },
  { 0x74CA, &dcsAddressTable[64] },
  { 0x74BE, &dcsAddressTable[81] },
  { 0x74CC, &dcsAddressTable[39] },
  {0xFFFF, nullptr},
  { 0x74CE, &dcsAddressTable[53] },
  {0xFFFF, nullptr},
  { 0x74D0, &dcsAddressTable[41] },
  {0xFFFF, nullptr},
  { 0x74D2, &dcsAddressTable[55] },
  {0xFFFF, nullptr},
  { 0x74D4, &dcsAddressTable[40] },
  {0xFFFF, nullptr},
  { 0x74D6, &dcsAddressTable[54] },
  {0xFFFF, nullptr},
  { 0x74D8, &dcsAddressTable[42] },
  {0xFFFF, nullptr},
  { 0x74DA, &dcsAddressTable[63] },
  {0xFFFF, nullptr},
  { 0x74DC, &dcsAddressTable[94] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
