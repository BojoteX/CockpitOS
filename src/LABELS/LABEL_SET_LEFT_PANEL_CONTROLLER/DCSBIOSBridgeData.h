...
static const SelectorEntry SelectorMap[] = {
    { "COMM1_ANT_SELECT_SW_UPPER","COMM1_ANT_SELECT_SW",0,"selector",1,"UPPER" },
    { "COMM1_ANT_SELECT_SW_AUTO","COMM1_ANT_SELECT_SW",1,"selector",1,"AUTO" },
    { "COMM1_ANT_SELECT_SW_LOWER","COMM1_ANT_SELECT_SW",2,"selector",1,"LOWER" },
    { "IFF_ANT_SELECT_SW_UPPER","IFF_ANT_SELECT_SW",0,"selector",2,"UPPER" },
    { "IFF_ANT_SELECT_SW_BOTH","IFF_ANT_SELECT_SW",1,"selector",2,"BOTH" },
    { "IFF_ANT_SELECT_SW_LOWER","IFF_ANT_SELECT_SW",2,"selector",2,"LOWER" },
    { "APU_CONTROL_SW_ON","APU_CONTROL_SW",0,"selector",3,"ON" },
    { "APU_CONTROL_SW_OFF","APU_CONTROL_SW",1,"selector",3,"OFF" },
    { "ENGINE_CRANK_SW_LEFT","ENGINE_CRANK_SW",0,"selector",4,"LEFT" },
    { "ENGINE_CRANK_SW_OFF","ENGINE_CRANK_SW",1,"selector",4,"OFF" },
    { "ENGINE_CRANK_SW_RIGHT","ENGINE_CRANK_SW",2,"selector",4,"RIGHT" },
    { "COM_AUX","COM_AUX",65535,"analog",0,"LEVEL" },
    { "COM_AUX_DEC","COM_AUX",0,"variable_step",0,"DEC" },
    { "COM_AUX_INC","COM_AUX",1,"variable_step",0,"INC" },
    { "COM_COMM_G_XMT_SW_COMM_1","COM_COMM_G_XMT_SW",0,"selector",5,"COMM_1" },
    { "COM_COMM_G_XMT_SW_OFF","COM_COMM_G_XMT_SW",1,"selector",5,"OFF" },
    { "COM_COMM_G_XMT_SW_COMM_2","COM_COMM_G_XMT_SW",2,"selector",5,"COMM_2" },
    { "COM_COMM_RELAY_SW_CIPHER","COM_COMM_RELAY_SW",0,"selector",6,"CIPHER" },
    { "COM_COMM_RELAY_SW_OFF","COM_COMM_RELAY_SW",1,"selector",6,"OFF" },
    { "COM_COMM_RELAY_SW_PLAIN","COM_COMM_RELAY_SW",2,"selector",6,"PLAIN" },
    { "COM_CRYPTO_SW_HOLD","COM_CRYPTO_SW",0,"selector",7,"HOLD" },
    { "COM_CRYPTO_SW_NORM","COM_CRYPTO_SW",1,"selector",7,"NORM" },
    { "COM_CRYPTO_SW_ZERO","COM_CRYPTO_SW",2,"selector",7,"ZERO" },
    { "COM_ICS","COM_ICS",65535,"analog",0,"LEVEL" },
    { "COM_ICS_DEC","COM_ICS",0,"variable_step",0,"DEC" },
    { "COM_ICS_INC","COM_ICS",1,"variable_step",0,"INC" },
    { "COM_IFF_MASTER_SW_EMER","COM_IFF_MASTER_SW",0,"selector",8,"EMER" },
    { "COM_IFF_MASTER_SW_NORM","COM_IFF_MASTER_SW",1,"selector",8,"NORM" },
    ...
    { "COM_ILS_UFC_MAN_SW_UFC","COM_ILS_UFC_MAN_SW",0,"selector",9,"UFC" },
    { "COM_ILS_UFC_MAN_SW_MAN","COM_ILS_UFC_MAN_SW",1,"selector",9,"MAN" },
    ...
    { "EXT_CNT_TANK_SW_STOP","EXT_CNT_TANK_SW",0,"selector",10,"STOP" },
    { "EXT_CNT_TANK_SW_NORM","EXT_CNT_TANK_SW",1,"selector",10,"NORM" },
    { "EXT_CNT_TANK_SW_ORIDE","EXT_CNT_TANK_SW",2,"selector",10,"ORIDE" },
    { "EXT_WNG_TANK_SW_STOP","EXT_WNG_TANK_SW",0,"selector",11,"STOP" },
    { "EXT_WNG_TANK_SW_NORM","EXT_WNG_TANK_SW",1,"selector",11,"NORM" },
    { "EXT_WNG_TANK_SW_ORIDE","EXT_WNG_TANK_SW",2,"selector",11,"ORIDE" },
    { "FUEL_DUMP_SW_ON","FUEL_DUMP_SW",0,"selector",12,"ON" },
    { "FUEL_DUMP_SW_OFF","FUEL_DUMP_SW",1,"selector",12,"OFF" },
    { "PROBE_SW_EXTEND","PROBE_SW",0,"selector",13,"EXTEND" },
    { "PROBE_SW_RETRACT","PROBE_SW",1,"selector",13,"RETRACT" },
    { "PROBE_SW_EMERG_EXTD","PROBE_SW",2,"selector",13,"EMERG_EXTD" },
    ...
    { "COCKKPIT_LIGHT_MODE_SW_NVG","COCKKPIT_LIGHT_MODE_SW",0,"selector",14,"NVG" },
    { "COCKKPIT_LIGHT_MODE_SW_NITE","COCKKPIT_LIGHT_MODE_SW",1,"selector",14,"NITE" },
    { "COCKKPIT_LIGHT_MODE_SW_DAY","COCKKPIT_LIGHT_MODE_SW",2,"selector",14,"DAY" },
    ...
    { "LIGHTS_TEST_SW_TEST","LIGHTS_TEST_SW",0,"selector",15,"TEST" },
    { "LIGHTS_TEST_SW_OFF","LIGHTS_TEST_SW",1,"selector",15,"OFF" },
    ...
    { "OBOGS_SW_ON","OBOGS_SW",0,"selector",16,"ON" },
    { "OBOGS_SW_OFF","OBOGS_SW",1,"selector",16,"OFF" },
    ...
    { "NUC_WPN_SW_ENABLE","NUC_WPN_SW",0,"selector",17,"ENABLE" },
    { "NUC_WPN_SW_DISABLE_(NO_FUNCTION)","NUC_WPN_SW",1,"selector",17,"DISABLE_(NO_FUNCTION)" },
