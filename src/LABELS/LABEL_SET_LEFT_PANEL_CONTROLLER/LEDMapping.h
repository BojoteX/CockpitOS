...
static const LEDMapping panelLEDs[] = {
  { "COMM1_ANT_SELECT_SW"   , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "IFF_ANT_SELECT_SW"     , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "APU_CONTROL_SW"        , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  ...
  { "COM_COMM_G_XMT_SW"     , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "COM_COMM_RELAY_SW"     , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "COM_CRYPTO_SW"         , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "COM_ICS"               , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "COM_IFF_MASTER_SW"     , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "COM_IFF_MODE4_SW"      , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "COM_ILS_CHANNEL_SW"    , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "COM_ILS_UFC_MAN_SW"    , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  ...
  { "FCS_RESET_BTN"         , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "GAIN_SWITCH"           , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "GAIN_SWITCH_COVER"     , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "RUD_TRIM"              , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "TO_TRIM_BTN"           , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "EXT_CNT_TANK_SW"       , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "EXT_WNG_TANK_SW"       , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "FUEL_DUMP_SW"          , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "PROBE_SW"              , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  ...
  { "OBOGS_SW"              , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "OXY_FLOW"              , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }, // No Info,
  { "LEFT_VIDEO_BIT"        , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "NUC_WPN_SW"            , DEVICE_NONE    , {.gpioInfo = {0}}, false, false },
  { "RIGHT_VIDEO_BIT"       , DEVICE_NONE    , {.gpioInfo = {0}}, false, false }
};
