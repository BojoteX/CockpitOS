...
static const SelectorEntry SelectorMap[] = {
    ...
    { "COCKKPIT_LIGHT_MODE_SW_NVG","COCKKPIT_LIGHT_MODE_SW",0,"selector",1,"NVG" },
    { "COCKKPIT_LIGHT_MODE_SW_NITE","COCKKPIT_LIGHT_MODE_SW",1,"selector",1,"NITE" },
    { "COCKKPIT_LIGHT_MODE_SW_DAY","COCKKPIT_LIGHT_MODE_SW",2,"selector",1,"DAY" },
    ...
    { "LIGHTS_TEST_SW_TEST","LIGHTS_TEST_SW",0,"selector",2,"TEST" },
    { "LIGHTS_TEST_SW_OFF","LIGHTS_TEST_SW",1,"selector",2,"OFF" },
    ...
    { "KY58_FILL_SELECT_Z_1-5","KY58_FILL_SELECT",0,"selector",3,"Z_1-5" },
    { "KY58_FILL_SELECT_1","KY58_FILL_SELECT",1,"selector",3,"1" },
    { "KY58_FILL_SELECT_2","KY58_FILL_SELECT",2,"selector",3,"2" },
    { "KY58_FILL_SELECT_3","KY58_FILL_SELECT",3,"selector",3,"3" },
    { "KY58_FILL_SELECT_4","KY58_FILL_SELECT",4,"selector",3,"4" },
    { "KY58_FILL_SELECT_5","KY58_FILL_SELECT",5,"selector",3,"5" },
    { "KY58_FILL_SELECT_6","KY58_FILL_SELECT",6,"selector",3,"6" },
    { "KY58_FILL_SELECT_Z_ALL","KY58_FILL_SELECT",7,"selector",3,"Z_ALL" },
    { "KY58_FILL_SEL_PULL_POS0","KY58_FILL_SEL_PULL",0,"selector",6,"POS0" },
    { "KY58_FILL_SEL_PULL_POS1","KY58_FILL_SEL_PULL",1,"selector",6,"POS1" },
    { "KY58_MODE_SELECT_P","KY58_MODE_SELECT",0,"selector",4,"P" },
    { "KY58_MODE_SELECT_C","KY58_MODE_SELECT",1,"selector",4,"C" },
    { "KY58_MODE_SELECT_LD","KY58_MODE_SELECT",2,"selector",4,"LD" },
    { "KY58_MODE_SELECT_RV","KY58_MODE_SELECT",3,"selector",4,"RV" },
    { "KY58_POWER_SELECT_OFF","KY58_POWER_SELECT",0,"selector",5,"OFF" },
    { "KY58_POWER_SELECT_ON","KY58_POWER_SELECT",1,"selector",5,"ON" },
    { "KY58_POWER_SELECT_TD","KY58_POWER_SELECT",2,"selector",5,"TD" },
