...
static const InputMapping InputMappings[] = {
    ...
    { "COCKKPIT_LIGHT_MODE_SW_DAY" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     0 , "selector"     ,  5 ,  0 },
    { "COCKKPIT_LIGHT_MODE_SW_NITE", "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     1 , "selector"     ,  5 ,  0 },
    { "COCKKPIT_LIGHT_MODE_SW_NVG" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     2 , "selector"     ,  5 ,  0 },
    ...
    { "LIGHTS_TEST_SW_OFF"         , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"        ,     0 , "selector"     ,  6 ,  0 },
    { "LIGHTS_TEST_SW_TEST"        , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"        ,     1 , "selector"     ,  6 ,  0 },
    ...
    { "KY58_FILL_SELECT_Z_ALL"     , "HC165" ,  0 ,  6 ,   8 , "KY58_FILL_SELECT"      ,     7 , "selector"     ,  1 ,  0 },
    { "KY58_FILL_SELECT_6"         , "HC165" ,  0 ,  5 ,   7 , "KY58_FILL_SELECT"      ,     6 , "selector"     ,  1 ,  0 },
    { "KY58_FILL_SELECT_5"         , "HC165" ,  0 ,  4 ,   6 , "KY58_FILL_SELECT"      ,     5 , "selector"     ,  1 ,  0 },
    { "KY58_FILL_SELECT_4"         , "HC165" ,  0 ,  3 ,   5 , "KY58_FILL_SELECT"      ,     4 , "selector"     ,  1 ,  0 },
    { "KY58_FILL_SELECT_3"         , "HC165" ,  0 ,  2 ,   4 , "KY58_FILL_SELECT"      ,     3 , "selector"     ,  1 ,  0 },
    { "KY58_FILL_SELECT_2"         , "HC165" ,  0 ,  1 ,   3 , "KY58_FILL_SELECT"      ,     2 , "selector"     ,  1 ,  0 },
    { "KY58_FILL_SELECT_1"         , "HC165" ,  0 ,  0 ,   2 , "KY58_FILL_SELECT"      ,     1 , "selector"     ,  1 ,  0 },
    { "KY58_FILL_SELECT_Z_1-5"     , "HC165" ,  0 ,  7 ,   1 , "KY58_FILL_SELECT"      ,     0 , "selector"     ,  1 ,  0 },
    { "KY58_FILL_SELECT_DEC"       , "NONE" ,  0 ,  0 ,  -1 , "KY58_FILL_SELECT"      ,     0 , "fixed_step"   ,  0 ,  0 },
    { "KY58_FILL_SELECT_INC"       , "NONE" ,  0 ,  0 ,  -1 , "KY58_FILL_SELECT"      ,     1 , "fixed_step"   ,  0 ,  0 },
    { "KY58_FILL_SEL_PULL_POS0"    , "NONE" ,  0 ,  0 ,  -1 , "KY58_FILL_SEL_PULL"    ,     0 , "selector"     ,  2 ,  0 },
    { "KY58_FILL_SEL_PULL_POS1"    , "NONE" ,  0 ,  0 ,  -1 , "KY58_FILL_SEL_PULL"    ,     1 , "selector"     ,  2 ,  0 },
    { "KY58_MODE_SELECT_RV"        , "HC165" ,  0 , 11 ,  12 , "KY58_MODE_SELECT"      ,     3 , "selector"     ,  3 ,  0 },
    { "KY58_MODE_SELECT_LD"        , "HC165" ,  0 , 10 ,  11 , "KY58_MODE_SELECT"      ,     2 , "selector"     ,  3 ,  0 },
    { "KY58_MODE_SELECT_C"         , "HC165" ,  0 ,  9 ,  10 , "KY58_MODE_SELECT"      ,     1 , "selector"     ,  3 ,  0 },
    { "KY58_MODE_SELECT_P"         , "HC165" ,  0 ,  8 ,   9 , "KY58_MODE_SELECT"      ,     0 , "selector"     ,  3 ,  0 },
    { "KY58_MODE_SELECT_DEC"       , "NONE" ,  0 ,  0 ,  -1 , "KY58_MODE_SELECT"      ,     0 , "fixed_step"   ,  0 ,  0 },
    { "KY58_MODE_SELECT_INC"       , "NONE" ,  0 ,  0 ,  -1 , "KY58_MODE_SELECT"      ,     1 , "fixed_step"   ,  0 ,  0 },
    { "KY58_POWER_SELECT_TD"       , "HC165" ,  0 , 14 ,  15 , "KY58_POWER_SELECT"     ,     2 , "selector"     ,  4 ,  0 },
    { "KY58_POWER_SELECT_ON"       , "HC165" ,  0 , 13 ,  14 , "KY58_POWER_SELECT"     ,     1 , "selector"     ,  4 ,  0 },
    { "KY58_POWER_SELECT_OFF"      , "HC165" ,  0 , 12 ,  13 , "KY58_POWER_SELECT"     ,     0 , "selector"     ,  4 ,  0 },
    { "KY58_VOLUME"                , "GPIO" , PIN(11) ,  0 ,  -1 , "KY58_VOLUME"           , 65535 , "analog"       ,  0 ,  0 },
    { "KY58_VOLUME_DEC"            , "NONE" ,  0 ,  0 ,  -1 , "KY58_VOLUME"           ,     0 , "variable_step",  0 ,  0 },
    { "KY58_VOLUME_INC"            , "NONE" ,  0 ,  0 ,  -1 , "KY58_VOLUME"           ,     1 , "variable_step",  0 ,  0 },
};
...
static const InputHashEntry inputHashTable[89] = {
  {nullptr, nullptr},
  {"KY58_POWER_SELECT_ON", &InputMappings[39]},
  {"KY58_FILL_SELECT_1", &InputMappings[26]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"KY58_FILL_SELECT_Z_ALL", &InputMappings[20]},
  {"KY58_FILL_SELECT_2", &InputMappings[25]},
  {"KY58_MODE_SELECT_LD", &InputMappings[33]},
  {"KY58_FILL_SEL_PULL_POS0", &InputMappings[30]},
  {"KY58_VOLUME_INC", &InputMappings[43]},
  {nullptr, nullptr},
  {"CONSOLES_DIMMER_INC", &InputMappings[8]},
  {"KY58_FILL_SELECT_3", &InputMappings[24]},
  {"KY58_FILL_SELECT_DEC", &InputMappings[28]},
  {nullptr, nullptr},
  {"KY58_FILL_SELECT_Z_1-5", &InputMappings[27]},
  {"KY58_FILL_SELECT_4", &InputMappings[23]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"KY58_VOLUME", &InputMappings[41]},
  ...
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"KY58_MODE_SELECT_C", &InputMappings[34]},
  ...
  {"KY58_MODE_SELECT_RV", &InputMappings[32]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"LIGHTS_TEST_SW_TEST", &InputMappings[16]},
  {"LIGHTS_TEST_SW_OFF", &InputMappings[15]},
  {"CHART_DIMMER_INC", &InputMappings[2]},
  {"KY58_FILL_SEL_PULL_POS1", &InputMappings[31]},
  {"KY58_MODE_SELECT_INC", &InputMappings[37]},
  {"KY58_FILL_SELECT_5", &InputMappings[22]},
  {"WARN_CAUTION_DIMMER", &InputMappings[17]},
  {"KY58_VOLUME_DEC", &InputMappings[42]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"COCKKPIT_LIGHT_MODE_SW_NVG", &InputMappings[5]},
  {"INST_PNL_DIMMER_DEC", &InputMappings[13]},
  {"KY58_FILL_SELECT_6", &InputMappings[21]},
  {nullptr, nullptr},
  {"CHART_DIMMER_DEC", &InputMappings[1]},
  {nullptr, nullptr},
  {"KY58_MODE_SELECT_DEC", &InputMappings[36]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {"KY58_MODE_SELECT_P", &InputMappings[35]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"KY58_POWER_SELECT_TD", &InputMappings[38]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"KY58_POWER_SELECT_OFF", &InputMappings[40]},
  {nullptr, nullptr},
  {"INST_PNL_DIMMER_INC", &InputMappings[14]},
  {"KY58_FILL_SELECT_INC", &InputMappings[29]},
