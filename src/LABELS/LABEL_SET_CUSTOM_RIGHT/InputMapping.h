...
static const InputMapping InputMappings[] = {
    { "HOOK_LEVER_POS0"            , "PCA_0x26" ,  0 , -1 ,  -1 , "HOOK_LEVER"            ,     1 , "selector"     ,  4 ,  0 },
    { "HOOK_LEVER_POS1"            , "PCA_0x26" ,  0 ,  7 ,  -1 , "HOOK_LEVER"            ,     0 , "selector"     ,  4 ,  0 },
    { "AV_COOL_SW_EMERG"           , "PCA_0x26" ,  0 ,  4 ,  -1 , "AV_COOL_SW"            ,     1 , "selector"     ,  1 ,  0 },
    { "AV_COOL_SW_NORM"            , "PCA_0x26" ,  0 , -1 ,  -1 , "AV_COOL_SW"            ,     0 , "selector"     ,  1 ,  0 },
    ...
    { "COCKKPIT_LIGHT_MODE_SW_DAY" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     2 , "selector"     ,  2 ,  0 },
    { "COCKKPIT_LIGHT_MODE_SW_NITE", "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     1 , "selector"     ,  2 ,  0 },
    { "COCKKPIT_LIGHT_MODE_SW_NVG" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW",     0 , "selector"     ,  2 ,  0 },
    ...
    { "LIGHTS_TEST_SW_OFF"         , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"        ,     1 , "selector"     ,  3 ,  0 },
    { "LIGHTS_TEST_SW_TEST"        , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"        ,     0 , "selector"     ,  3 ,  0 },
    ...
    { "RADALT_HEIGHT_POS0"         , "GPIO" , PIN(38) ,  0 ,  -1 , "RADALT_HEIGHT"         ,     0 , "variable_step",  0 ,  0 },
    { "RADALT_HEIGHT_POS1"         , "GPIO" , PIN(1) ,  0 ,  -1 , "RADALT_HEIGHT"         ,     1 , "variable_step",  0 ,  0 },
    { "RADALT_TEST_SW"             , "GPIO" , PIN(16) ,  0 ,  -1 , "RADALT_TEST_SW"        ,     1 , "momentary"    ,  0 ,  0 },
    { "WING_FOLD_PULL_POS0"        , "NONE" ,  0 ,  1 ,   1 , "WING_FOLD_PULL"        ,     0 , "selector"     ,  5 ,  0 },
    { "WING_FOLD_PULL_POS1"        , "NONE" ,  0 , -1 ,   2 , "WING_FOLD_PULL"        ,     1 , "selector"     ,  5 ,  0 },
    { "WING_FOLD_ROTATE_UNFOLD"    , "NONE" ,  0 ,  2 ,   3 , "WING_FOLD_ROTATE"      ,     0 , "selector"     ,  6 ,  0 },
    { "WING_FOLD_ROTATE_HOLD"      , "NONE" ,  0 , -1 ,   4 , "WING_FOLD_ROTATE"      ,     1 , "selector"     ,  6 ,  0 },
    { "WING_FOLD_ROTATE_FOLD"      , "NONE" ,  0 ,  3 ,   5 , "WING_FOLD_ROTATE"      ,     2 , "selector"     ,  6 ,  0 },
};
