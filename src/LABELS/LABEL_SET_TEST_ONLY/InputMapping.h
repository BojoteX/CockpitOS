...
static const InputMapping InputMappings[] = {
    ...
    { "IR_COOL_SW_NORM"      , "NONE" ,  0 ,  0 ,  -1 , "IR_COOL_SW"         ,     1 , "selector"     ,  3 },
    { "IR_COOL_SW_OFF"       , "NONE" ,  0 ,  0 ,  -1 , "IR_COOL_SW"         ,     2 , "selector"     ,  3 },
    { "SPIN_RECOVERY_COVER"  , "NONE" ,  0 ,  0 ,  -1 , "SPIN_RECOVERY_COVER",     1 , "momentary"    ,  0 },
    { "SPIN_RECOVERY_SW_RCVY", "NONE" ,  0 ,  0 ,  -1 , "SPIN_RECOVERY_SW"   ,     0 , "selector"     ,  2 },
