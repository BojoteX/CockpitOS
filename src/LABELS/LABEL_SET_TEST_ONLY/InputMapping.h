...
static const InputMapping InputMappings[] = {
    ...
    { "COCKKPIT_LIGHT_MODE_SW_DAY" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW" ,     0 , "selector"     ,  2 },
    { "COCKKPIT_LIGHT_MODE_SW_NITE", "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW" ,     1 , "selector"     ,  2 },
    { "COCKKPIT_LIGHT_MODE_SW_NVG" , "NONE" ,  0 ,  0 ,  -1 , "COCKKPIT_LIGHT_MODE_SW" ,     2 , "selector"     ,  2 },
    ...
    { "LIGHTS_TEST_SW_OFF"         , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"         ,     0 , "selector"     ,  3 },
    { "LIGHTS_TEST_SW_TEST"        , "NONE" ,  0 ,  0 ,  -1 , "LIGHTS_TEST_SW"         ,     1 , "selector"     ,  3 },
    ...
    { "WING_FOLD_PULL_POS0"        , "NONE" ,  0 ,  0 ,  -1 , "WING_FOLD_PULL"         ,     0 , "selector"     ,  4 },
    { "WING_FOLD_PULL_POS1"        , "NONE" ,  0 ,  0 ,  -1 , "WING_FOLD_PULL"         ,     1 , "selector"     ,  4 },
    { "WING_FOLD_ROTATE_UNFOLD"    , "NONE" ,  0 ,  0 ,  -1 , "WING_FOLD_ROTATE"       ,     0 , "selector"     ,  5 },
    { "WING_FOLD_ROTATE_HOLD"      , "NONE" ,  0 ,  0 ,  -1 , "WING_FOLD_ROTATE"       ,     1 , "selector"     ,  5 },
    { "WING_FOLD_ROTATE_FOLD"      , "NONE" ,  0 ,  0 ,  -1 , "WING_FOLD_ROTATE"       ,     2 , "selector"     ,  5 },
};
...
static const InputHashEntry inputHashTable[59] = {
  ...
  {"MASTER_CAUTION_RESET_SW", &InputMappings[22]},
  ...
  {"WING_FOLD_PULL_POS0", &InputMappings[23]},
  {"INST_PNL_DIMMER_INC", &InputMappings[16]},
  {"WING_FOLD_PULL_POS1", &InputMappings[24]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {nullptr, nullptr},
  {nullptr, nullptr},
  {"WING_FOLD_ROTATE_UNFOLD", &InputMappings[25]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {"WING_FOLD_ROTATE_FOLD", &InputMappings[27]},
  {nullptr, nullptr},
  {nullptr, nullptr},
  {nullptr, nullptr},
  ...
  {"WING_FOLD_ROTATE_HOLD", &InputMappings[26]},
