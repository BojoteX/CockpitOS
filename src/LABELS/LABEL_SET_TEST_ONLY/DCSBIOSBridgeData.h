...
static const AddressEntry dcsAddressTable[] = {
  { 0x74A0, { &DcsOutputTable[0], &DcsOutputTable[1], &DcsOutputTable[30], &DcsOutputTable[31] }, 4 },
  { 0x7488, { &DcsOutputTable[2], &DcsOutputTable[6] }, 2 },
  { 0x7484, { &DcsOutputTable[3], &DcsOutputTable[4] }, 2 },
  { 0x74D4, { &DcsOutputTable[5] }, 1 },
  { 0x754A, { &DcsOutputTable[7] }, 1 },
  { 0x74C8, { &DcsOutputTable[8], &DcsOutputTable[12] }, 2 },
  { 0x7544, { &DcsOutputTable[9] }, 1 },
  { 0x7548, { &DcsOutputTable[10] }, 1 },
  { 0x7546, { &DcsOutputTable[11] }, 1 },
  { 0x754C, { &DcsOutputTable[13] }, 1 },
  { 0x74C2, { &DcsOutputTable[14] }, 1 },
  { 0x74C4, { &DcsOutputTable[15], &DcsOutputTable[16], &DcsOutputTable[17] }, 3 },
  { 0x7408, { &DcsOutputTable[18], &DcsOutputTable[19] }, 2 },
  { 0x742C, { &DcsOutputTable[20] }, 1 },
  { 0x742E, { &DcsOutputTable[21], &DcsOutputTable[22], &DcsOutputTable[23], &DcsOutputTable[24], &DcsOutputTable[26], &DcsOutputTable[28] }, 6 },
  { 0x7430, { &DcsOutputTable[25], &DcsOutputTable[27], &DcsOutputTable[29] }, 3 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[53] = {
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x742C, &dcsAddressTable[13] },
  {0xFFFF, nullptr},
  { 0x742E, &dcsAddressTable[14] },
  {0xFFFF, nullptr},
  { 0x7430, &dcsAddressTable[15] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
...
static const SelectorEntry SelectorMap[] = {
    { "HOOK_LEVER_POS0","HOOK_LEVER",0,"selector",7,"POS0" },
    { "HOOK_LEVER_POS1","HOOK_LEVER",1,"selector",7,"POS1" },
    ...
    { "WING_FOLD_PULL_POS0","WING_FOLD_PULL",0,"selector",8,"POS0" },
    { "WING_FOLD_PULL_POS1","WING_FOLD_PULL",1,"selector",8,"POS1" },
    { "WING_FOLD_ROTATE_UNFOLD","WING_FOLD_ROTATE",0,"selector",6,"UNFOLD" },
    { "WING_FOLD_ROTATE_HOLD","WING_FOLD_ROTATE",1,"selector",6,"HOLD" },
    { "WING_FOLD_ROTATE_FOLD","WING_FOLD_ROTATE",2,"selector",6,"FOLD" },
};
...
static CommandHistoryEntry commandHistory[] = {
    ...
    { "HOOK_LEVER", 0, 0, true, 7, 0,   0, false, {0}, {0}, 0 },
    ...
    { "WING_FOLD_PULL", 0, 0, true, 8, 0,   0, false, {0}, {0}, 0 },
    { "WING_FOLD_ROTATE", 0, 0, true, 6, 0,   0, false, {0}, {0}, 0 },
};
