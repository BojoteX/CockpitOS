...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x7538, { &DcsOutputTable[1] }, 1 },
  { 0x74BC, { &DcsOutputTable[2], &DcsOutputTable[3], &DcsOutputTable[6], &DcsOutputTable[7] }, 4 },
  { 0x74BE, { &DcsOutputTable[4], &DcsOutputTable[8], &DcsOutputTable[9] }, 3 },
  { 0x752C, { &DcsOutputTable[5] }, 1 },
  { 0x7532, { &DcsOutputTable[10] }, 1 },
  { 0x7534, { &DcsOutputTable[11] }, 1 },
  { 0x752E, { &DcsOutputTable[12] }, 1 },
  { 0x7536, { &DcsOutputTable[13] }, 1 },
  { 0x752A, { &DcsOutputTable[14] }, 1 },
  { 0x7530, { &DcsOutputTable[15] }, 1 },
  { 0x740C, { &DcsOutputTable[16], &DcsOutputTable[17], &DcsOutputTable[18], &DcsOutputTable[19], &DcsOutputTable[20], &DcsOutputTable[21], &DcsOutputTable[22] }, 7 },
  { 0x7408, { &DcsOutputTable[23], &DcsOutputTable[24] }, 2 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[53] = {
  { 0x752E, &dcsAddressTable[7] },
  {0xFFFF, nullptr},
  { 0x7530, &dcsAddressTable[10] },
  {0xFFFF, nullptr},
  { 0x7532, &dcsAddressTable[5] },
  {0xFFFF, nullptr},
  { 0x7534, &dcsAddressTable[6] },
  {0xFFFF, nullptr},
  { 0x7536, &dcsAddressTable[8] },
  {0xFFFF, nullptr},
  { 0x7538, &dcsAddressTable[1] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x74BC, &dcsAddressTable[2] },
  {0xFFFF, nullptr},
  { 0x74BE, &dcsAddressTable[3] },
  {0xFFFF, nullptr},
  { 0x752A, &dcsAddressTable[9] },
  {0xFFFF, nullptr},
  { 0x752C, &dcsAddressTable[4] },
  {0xFFFF, nullptr},
};
...
static const SelectorEntry SelectorMap[] = {
    ...
    { "COM_IFF_MODE4_SW_POS0","COM_IFF_MODE4_SW",0,"selector",7,"POS0" },
    { "COM_IFF_MODE4_SW_POS1","COM_IFF_MODE4_SW",1,"selector",7,"POS1" },
    { "COM_IFF_MODE4_SW_POS2","COM_IFF_MODE4_SW",2,"selector",7,"POS2" },
    { "COM_ILS_CHANNEL_SW_POS0","COM_ILS_CHANNEL_SW",0,"selector",8,"POS0" },
    { "COM_ILS_CHANNEL_SW_POS1","COM_ILS_CHANNEL_SW",1,"selector",8,"POS1" },
    { "COM_ILS_CHANNEL_SW_POS2","COM_ILS_CHANNEL_SW",2,"selector",8,"POS2" },
    { "COM_ILS_CHANNEL_SW_POS3","COM_ILS_CHANNEL_SW",3,"selector",8,"POS3" },
    { "COM_ILS_CHANNEL_SW_POS4","COM_ILS_CHANNEL_SW",4,"selector",8,"POS4" },
    { "COM_ILS_CHANNEL_SW_POS5","COM_ILS_CHANNEL_SW",5,"selector",8,"POS5" },
    { "COM_ILS_CHANNEL_SW_POS6","COM_ILS_CHANNEL_SW",6,"selector",8,"POS6" },
    { "COM_ILS_CHANNEL_SW_POS7","COM_ILS_CHANNEL_SW",7,"selector",8,"POS7" },
    { "COM_ILS_CHANNEL_SW_POS8","COM_ILS_CHANNEL_SW",8,"selector",8,"POS8" },
    { "COM_ILS_CHANNEL_SW_POS9","COM_ILS_CHANNEL_SW",9,"selector",8,"POS9" },
    { "COM_ILS_CHANNEL_SW_POS10","COM_ILS_CHANNEL_SW",10,"selector",8,"POS10" },
    { "COM_ILS_CHANNEL_SW_POS11","COM_ILS_CHANNEL_SW",11,"selector",8,"POS11" },
    { "COM_ILS_CHANNEL_SW_POS12","COM_ILS_CHANNEL_SW",12,"selector",8,"POS12" },
    { "COM_ILS_CHANNEL_SW_POS13","COM_ILS_CHANNEL_SW",13,"selector",8,"POS13" },
    { "COM_ILS_CHANNEL_SW_POS14","COM_ILS_CHANNEL_SW",14,"selector",8,"POS14" },
    { "COM_ILS_CHANNEL_SW_POS15","COM_ILS_CHANNEL_SW",15,"selector",8,"POS15" },
    { "COM_ILS_CHANNEL_SW_POS16","COM_ILS_CHANNEL_SW",16,"selector",8,"POS16" },
    { "COM_ILS_CHANNEL_SW_POS17","COM_ILS_CHANNEL_SW",17,"selector",8,"POS17" },
    { "COM_ILS_CHANNEL_SW_POS18","COM_ILS_CHANNEL_SW",18,"selector",8,"POS18" },
    { "COM_ILS_CHANNEL_SW_POS19","COM_ILS_CHANNEL_SW",19,"selector",8,"POS19" },
    ...
    { "MASTER_ARM_SW_SAFE","MASTER_ARM_SW",0,"selector",6,"SAFE" },
    { "MASTER_ARM_SW_ARM","MASTER_ARM_SW",1,"selector",6,"ARM" },
...
static CommandHistoryEntry commandHistory[] = {
    ...
    { "COM_IFF_MODE4_SW", 0, 0, true, 7, 0,   0, false, {0}, {0}, 0 },
    { "COM_ILS_CHANNEL_SW", 0, 0, true, 8, 0,   0, false, {0}, {0}, 0 },
    ...
    { "MASTER_ARM_SW", 0, 0, true, 6, 0,   0, false, {0}, {0}, 0 },
