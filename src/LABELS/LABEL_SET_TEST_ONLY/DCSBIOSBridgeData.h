...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x74BC, { &DcsOutputTable[1], &DcsOutputTable[2], &DcsOutputTable[5], &DcsOutputTable[6], &DcsOutputTable[24] }, 5 },
  ...
  { 0x74C6, { &DcsOutputTable[15], &DcsOutputTable[17], &DcsOutputTable[19], &DcsOutputTable[20] }, 4 },
  { 0x74C4, { &DcsOutputTable[16] }, 1 },
  { 0x7540, { &DcsOutputTable[18] }, 1 },
  { 0x74C8, { &DcsOutputTable[21] }, 1 },
  { 0x7542, { &DcsOutputTable[22] }, 1 },
  { 0x74B4, { &DcsOutputTable[23], &DcsOutputTable[25], &DcsOutputTable[27] }, 3 },
  { 0x7528, { &DcsOutputTable[26] }, 1 },
  { 0x7456, { &DcsOutputTable[28] }, 1 },
  { 0x742A, { &DcsOutputTable[29], &DcsOutputTable[30], &DcsOutputTable[31], &DcsOutputTable[32] }, 4 },
  { 0x749C, { &DcsOutputTable[33], &DcsOutputTable[38] }, 2 },
  { 0x751A, { &DcsOutputTable[34] }, 1 },
  { 0x74A0, { &DcsOutputTable[35] }, 1 },
  { 0x7518, { &DcsOutputTable[36] }, 1 },
  { 0x751C, { &DcsOutputTable[37] }, 1 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[53] = {
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x749C, &dcsAddressTable[19] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x74A0, &dcsAddressTable[21] },
  { 0x7540, &dcsAddressTable[12] },
  {0xFFFF, nullptr},
  { 0x7542, &dcsAddressTable[14] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x7518, &dcsAddressTable[22] },
  {0xFFFF, nullptr},
  { 0x751A, &dcsAddressTable[20] },
  {0xFFFF, nullptr},
  { 0x751C, &dcsAddressTable[23] },
  {0xFFFF, nullptr},
  { 0x74B4, &dcsAddressTable[15] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
...
static const SelectorEntry SelectorMap[] = {
    ...
    { "COM_IFF_MODE4_SW_POS0","COM_IFF_MODE4_SW",0,"selector",11,"POS0" },
    { "COM_IFF_MODE4_SW_POS1","COM_IFF_MODE4_SW",1,"selector",11,"POS1" },
    { "COM_IFF_MODE4_SW_POS2","COM_IFF_MODE4_SW",2,"selector",11,"POS2" },
    { "COM_ILS_CHANNEL_SW_POS0","COM_ILS_CHANNEL_SW",0,"selector",12,"POS0" },
    { "COM_ILS_CHANNEL_SW_POS1","COM_ILS_CHANNEL_SW",1,"selector",12,"POS1" },
    { "COM_ILS_CHANNEL_SW_POS2","COM_ILS_CHANNEL_SW",2,"selector",12,"POS2" },
    { "COM_ILS_CHANNEL_SW_POS3","COM_ILS_CHANNEL_SW",3,"selector",12,"POS3" },
    { "COM_ILS_CHANNEL_SW_POS4","COM_ILS_CHANNEL_SW",4,"selector",12,"POS4" },
    { "COM_ILS_CHANNEL_SW_POS5","COM_ILS_CHANNEL_SW",5,"selector",12,"POS5" },
    { "COM_ILS_CHANNEL_SW_POS6","COM_ILS_CHANNEL_SW",6,"selector",12,"POS6" },
    { "COM_ILS_CHANNEL_SW_POS7","COM_ILS_CHANNEL_SW",7,"selector",12,"POS7" },
    { "COM_ILS_CHANNEL_SW_POS8","COM_ILS_CHANNEL_SW",8,"selector",12,"POS8" },
    { "COM_ILS_CHANNEL_SW_POS9","COM_ILS_CHANNEL_SW",9,"selector",12,"POS9" },
    { "COM_ILS_CHANNEL_SW_POS10","COM_ILS_CHANNEL_SW",10,"selector",12,"POS10" },
    { "COM_ILS_CHANNEL_SW_POS11","COM_ILS_CHANNEL_SW",11,"selector",12,"POS11" },
    { "COM_ILS_CHANNEL_SW_POS12","COM_ILS_CHANNEL_SW",12,"selector",12,"POS12" },
    { "COM_ILS_CHANNEL_SW_POS13","COM_ILS_CHANNEL_SW",13,"selector",12,"POS13" },
    { "COM_ILS_CHANNEL_SW_POS14","COM_ILS_CHANNEL_SW",14,"selector",12,"POS14" },
    { "COM_ILS_CHANNEL_SW_POS15","COM_ILS_CHANNEL_SW",15,"selector",12,"POS15" },
    { "COM_ILS_CHANNEL_SW_POS16","COM_ILS_CHANNEL_SW",16,"selector",12,"POS16" },
    { "COM_ILS_CHANNEL_SW_POS17","COM_ILS_CHANNEL_SW",17,"selector",12,"POS17" },
    { "COM_ILS_CHANNEL_SW_POS18","COM_ILS_CHANNEL_SW",18,"selector",12,"POS18" },
    { "COM_ILS_CHANNEL_SW_POS19","COM_ILS_CHANNEL_SW",19,"selector",12,"POS19" },
    ...
    { "BLEED_AIR_KNOB_R_OFF","BLEED_AIR_KNOB",3,"selector",6,"R_OFF" },
    { "BLEED_AIR_KNOB_NORM","BLEED_AIR_KNOB",2,"selector",6,"NORM" },
    { "BLEED_AIR_KNOB_L_OFF","BLEED_AIR_KNOB",1,"selector",6,"L_OFF" },
    { "BLEED_AIR_KNOB_OFF","BLEED_AIR_KNOB",0,"selector",6,"OFF" },
    { "BLEED_AIR_PULL_POS0","BLEED_AIR_PULL",0,"selector",13,"POS0" },
    { "BLEED_AIR_PULL_POS1","BLEED_AIR_PULL",1,"selector",13,"POS1" },
    { "CABIN_PRESS_SW_POS0","CABIN_PRESS_SW",0,"selector",14,"POS0" },
    { "CABIN_PRESS_SW_POS1","CABIN_PRESS_SW",1,"selector",14,"POS1" },
    { "CABIN_PRESS_SW_POS2","CABIN_PRESS_SW",2,"selector",14,"POS2" },
    ...
    { "ECS_MODE_SW_POS0","ECS_MODE_SW",0,"selector",15,"POS0" },
    { "ECS_MODE_SW_POS1","ECS_MODE_SW",1,"selector",15,"POS1" },
    { "ECS_MODE_SW_POS2","ECS_MODE_SW",2,"selector",15,"POS2" },
    { "ENG_ANTIICE_SW_ON","ENG_ANTIICE_SW",2,"selector",7,"ON" },
    { "ENG_ANTIICE_SW_OFF","ENG_ANTIICE_SW",1,"selector",7,"OFF" },
    { "ENG_ANTIICE_SW_TEST","ENG_ANTIICE_SW",0,"selector",7,"TEST" },
    { "PITOT_HEAT_SW_ON","PITOT_HEAT_SW",1,"action",8,"ON" },
    { "PITOT_HEAT_SW_AUTO","PITOT_HEAT_SW",0,"action",8,"AUTO" },
    ...
    { "GAIN_SWITCH_POS0","GAIN_SWITCH",0,"selector",16,"POS0" },
    { "GAIN_SWITCH_POS1","GAIN_SWITCH",1,"selector",16,"POS1" },
...
static CommandHistoryEntry commandHistory[] = {
    { "BLEED_AIR_KNOB", 0, 0, true, 6, 0,   0, false, {0}, {0}, 0 },
    { "BLEED_AIR_PULL", 0, 0, true, 13, 0,   0, false, {0}, {0}, 0 },
    { "CABIN_PRESS_SW", 0, 0, true, 14, 0,   0, false, {0}, {0}, 0 },
    ...
    { "COM_IFF_MODE4_SW", 0, 0, true, 11, 0,   0, false, {0}, {0}, 0 },
    { "COM_ILS_CHANNEL_SW", 0, 0, true, 12, 0,   0, false, {0}, {0}, 0 },
    ...
    { "ECS_MODE_SW", 0, 0, true, 15, 0,   0, false, {0}, {0}, 0 },
    { "ENG_ANTIICE_SW", 0, 0, true, 7, 0,   0, false, {0}, {0}, 0 },
    { "FCS_RESET_BTN", 0, 0, false, 0, 0,   0, false, {0}, {0}, 0 },
    { "GAIN_SWITCH", 0, 0, true, 16, 0,   0, false, {0}, {0}, 0 },
    ...
    { "PITOT_HEAT_SW", 0, 0, true, 8, 0,   0, false, {0}, {0}, 0 },
