...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x749C, { &DcsOutputTable[28], &DcsOutputTable[33] }, 2 },
  { 0x751A, { &DcsOutputTable[29] }, 1 },
  { 0x74A0, { &DcsOutputTable[30] }, 1 },
  { 0x7518, { &DcsOutputTable[31] }, 1 },
  { 0x751C, { &DcsOutputTable[32] }, 1 },
};
...
static const DcsAddressHashEntry dcsAddressHashTable[53] = {
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x749C, &dcsAddressTable[17] },
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x74A0, &dcsAddressTable[19] },
  ...
  {0xFFFF, nullptr},
  {0xFFFF, nullptr},
  { 0x7518, &dcsAddressTable[20] },
  {0xFFFF, nullptr},
  { 0x751A, &dcsAddressTable[18] },
  {0xFFFF, nullptr},
  { 0x751C, &dcsAddressTable[21] },
  {0xFFFF, nullptr},
...
static const SelectorEntry SelectorMap[] = {
    ...
    { "COM_IFF_MODE4_SW_POS0","COM_IFF_MODE4_SW",0,"selector",9,"POS0" },
    { "COM_IFF_MODE4_SW_POS1","COM_IFF_MODE4_SW",1,"selector",9,"POS1" },
    { "COM_IFF_MODE4_SW_POS2","COM_IFF_MODE4_SW",2,"selector",9,"POS2" },
    { "COM_ILS_CHANNEL_SW_POS0","COM_ILS_CHANNEL_SW",0,"selector",10,"POS0" },
    { "COM_ILS_CHANNEL_SW_POS1","COM_ILS_CHANNEL_SW",1,"selector",10,"POS1" },
    { "COM_ILS_CHANNEL_SW_POS2","COM_ILS_CHANNEL_SW",2,"selector",10,"POS2" },
    { "COM_ILS_CHANNEL_SW_POS3","COM_ILS_CHANNEL_SW",3,"selector",10,"POS3" },
    { "COM_ILS_CHANNEL_SW_POS4","COM_ILS_CHANNEL_SW",4,"selector",10,"POS4" },
    { "COM_ILS_CHANNEL_SW_POS5","COM_ILS_CHANNEL_SW",5,"selector",10,"POS5" },
    { "COM_ILS_CHANNEL_SW_POS6","COM_ILS_CHANNEL_SW",6,"selector",10,"POS6" },
    { "COM_ILS_CHANNEL_SW_POS7","COM_ILS_CHANNEL_SW",7,"selector",10,"POS7" },
    { "COM_ILS_CHANNEL_SW_POS8","COM_ILS_CHANNEL_SW",8,"selector",10,"POS8" },
    { "COM_ILS_CHANNEL_SW_POS9","COM_ILS_CHANNEL_SW",9,"selector",10,"POS9" },
    { "COM_ILS_CHANNEL_SW_POS10","COM_ILS_CHANNEL_SW",10,"selector",10,"POS10" },
    { "COM_ILS_CHANNEL_SW_POS11","COM_ILS_CHANNEL_SW",11,"selector",10,"POS11" },
    { "COM_ILS_CHANNEL_SW_POS12","COM_ILS_CHANNEL_SW",12,"selector",10,"POS12" },
    { "COM_ILS_CHANNEL_SW_POS13","COM_ILS_CHANNEL_SW",13,"selector",10,"POS13" },
    { "COM_ILS_CHANNEL_SW_POS14","COM_ILS_CHANNEL_SW",14,"selector",10,"POS14" },
    { "COM_ILS_CHANNEL_SW_POS15","COM_ILS_CHANNEL_SW",15,"selector",10,"POS15" },
    { "COM_ILS_CHANNEL_SW_POS16","COM_ILS_CHANNEL_SW",16,"selector",10,"POS16" },
    { "COM_ILS_CHANNEL_SW_POS17","COM_ILS_CHANNEL_SW",17,"selector",10,"POS17" },
    { "COM_ILS_CHANNEL_SW_POS18","COM_ILS_CHANNEL_SW",18,"selector",10,"POS18" },
    { "COM_ILS_CHANNEL_SW_POS19","COM_ILS_CHANNEL_SW",19,"selector",10,"POS19" },
    ...
    { "BLEED_AIR_PULL_POS0","BLEED_AIR_PULL",0,"selector",11,"POS0" },
    { "BLEED_AIR_PULL_POS1","BLEED_AIR_PULL",1,"selector",11,"POS1" },
    { "CABIN_PRESS_SW_POS0","CABIN_PRESS_SW",0,"selector",12,"POS0" },
    { "CABIN_PRESS_SW_POS1","CABIN_PRESS_SW",1,"selector",12,"POS1" },
    { "CABIN_PRESS_SW_POS2","CABIN_PRESS_SW",2,"selector",12,"POS2" },
    ...
    { "ECS_MODE_SW_POS0","ECS_MODE_SW",0,"selector",13,"POS0" },
    { "ECS_MODE_SW_POS1","ECS_MODE_SW",1,"selector",13,"POS1" },
    { "ECS_MODE_SW_POS2","ECS_MODE_SW",2,"selector",13,"POS2" },
    ...
    { "GAIN_SWITCH_POS0","GAIN_SWITCH",0,"selector",14,"POS0" },
    { "GAIN_SWITCH_POS1","GAIN_SWITCH",1,"selector",14,"POS1" },
...
static CommandHistoryEntry commandHistory[] = {
    ...
    { "BLEED_AIR_PULL", 0, 0, true, 11, 0,   0, false, {0}, {0}, 0 },
    { "CABIN_PRESS_SW", 0, 0, true, 12, 0,   0, false, {0}, {0}, 0 },
    ...
    { "COM_IFF_MODE4_SW", 0, 0, true, 9, 0,   0, false, {0}, {0}, 0 },
    { "COM_ILS_CHANNEL_SW", 0, 0, true, 10, 0,   0, false, {0}, {0}, 0 },
