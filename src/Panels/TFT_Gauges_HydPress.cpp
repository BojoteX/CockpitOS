...
// --- Pins ---
#if defined(ARDUINO_LOLIN_S3_MINI)
#define HYD_PRESSURE_CS_PIN     4
#define HYD_PRESSURE_DC_PIN    12
#define HYD_PRESSURE_MOSI_PIN   8
#define HYD_PRESSURE_SCLK_PIN  11
#define HYD_PRESSURE_RST_PIN   -1
#define HYD_PRESSURE_MISO_PIN  -1
#else
#define HYD_PRESSURE_CS_PIN     5
#define HYD_PRESSURE_DC_PIN     7
#define HYD_PRESSURE_MOSI_PIN  10
#define HYD_PRESSURE_SCLK_PIN  11
#define HYD_PRESSURE_RST_PIN   -1
#define HYD_PRESSURE_MISO_PIN  -1
#endif
...
#undef HYD_PRESSURE_CS_PIN
#undef HYD_PRESSURE_DC_PIN
#undef HYD_PRESSURE_MOSI_PIN
#undef HYD_PRESSURE_SCLK_PIN
#undef HYD_PRESSURE_RST_PIN
#undef HYD_PRESSURE_MISO_PIN
#if defined(ARDUINO_LOLIN_S3_MINI)
#define HYD_PRESSURE_CS_PIN     4
#define HYD_PRESSURE_DC_PIN    12
#define HYD_PRESSURE_MOSI_PIN   8
