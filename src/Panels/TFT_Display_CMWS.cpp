...
// =============================================================================
//
// IMPORTANT: CALLBACK EXECUTION CONTEXT
// These callbacks are invoked by DCS-BIOS from the main loop / task context,
// NOT from a hardware ISR. This means:
//   - portENTER_CRITICAL (not _ISR variant) is correct
//   - strlen/strcmp/debugPrintf are safe to use
//   - No ISR-specific timing constraints apply
//
// The term "burst updates" refers to multiple callbacks firing in quick 
// succession during a single loop() iteration when DCS-BIOS processes
// incoming serial data — not interrupt-driven callbacks.
//
// =============================================================================
