...
# --- CONFIG ---
PNG_FILE = "radarAltMinHeightPointerNVG.png"
HEADER_FILE = "radarAltMinHeightPointerNVG.h"
ARRAY_NAME = "radarAltMinHeightPointerNVG"
EXPECTED_WIDTH = 23
EXPECTED_HEIGHT = 180
PIXELS_PER_LINE = 15
...
def write_header_file(pixels, output_path):
    with open(output_path, 'w') as f:
        f.write(f"// 'Radar Alt Min Height Pointer', {EXPECTED_WIDTH}x{EXPECTED_HEIGHT}\n")
