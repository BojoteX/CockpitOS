...
# --- CONFIG ---
PNG_FILE = "radarAltNeedleNVG.png"
HEADER_FILE = "radarAltNeedleNVG.h"
ARRAY_NAME = "radarAltNeedleNVG"
EXPECTED_WIDTH = 76
EXPECTED_HEIGHT = 173
PIXELS_PER_LINE = 15
...
def write_header_file(pixels, output_path):
    with open(output_path, 'w') as f:
        f.write(f"// 'Radar Alt Needle NVG', {EXPECTED_WIDTH}x{EXPECTED_HEIGHT} Pivot point 38x134\n")
