...
# --- CONFIG ---
PNG_FILE = "cabinPressNeedleNVG.png"
HEADER_FILE = "cabinPressNeedleNVG.h"
ARRAY_NAME = "cabinPressNeedleNVG"
EXPECTED_WIDTH = 23
EXPECTED_HEIGHT = 238
PIXELS_PER_LINE = 15
...
def write_header_file(pixels, output_path):
    with open(output_path, 'w') as f:
        f.write(f"// 'Needle NVG', {EXPECTED_WIDTH}x{EXPECTED_HEIGHT} Pivot point 12x165\n")
