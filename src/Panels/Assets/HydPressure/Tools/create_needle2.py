...
# --- CONFIG ---
PNG_FILE = "hydPressNeedle2.png"
HEADER_FILE = "hydPressNeedle2.h"
ARRAY_NAME = "hydPressNeedle2"
EXPECTED_WIDTH = 33
EXPECTED_HEIGHT = 120
PIXELS_PER_LINE = 15
...
def write_header_file(pixels, output_path):
    with open(output_path, 'w') as f:
        f.write(f"// 'Needle 2', {EXPECTED_WIDTH}x{EXPECTED_HEIGHT} Pivot point 17x103\n")
