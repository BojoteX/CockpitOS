...
# --- CONFIG ---
PNG_FILE = "hydPressNeedle2NVG.png"
HEADER_FILE = "hydPressNeedle2NVG.h"
ARRAY_NAME = "hydPressNeedle2NVG"
EXPECTED_WIDTH = 33
EXPECTED_HEIGHT = 120
PIXELS_PER_LINE = 15
...
def write_header_file(pixels, output_path):
    with open(output_path, 'w') as f:
        f.write(f"// 'Needle NVG', {EXPECTED_WIDTH}x{EXPECTED_HEIGHT} Pivot point 17x103\n")
