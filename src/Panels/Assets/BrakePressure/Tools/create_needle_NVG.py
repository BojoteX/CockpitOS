...
# --- CONFIG ---
PNG_FILE = "brakePressNeedleNVG.png"
HEADER_FILE = "brakePressNeedleNVG.h"
ARRAY_NAME = "brakePressNeedleNVG"
EXPECTED_WIDTH = 15
EXPECTED_HEIGHT = 150
PIXELS_PER_LINE = 15
...
def write_header_file(pixels, output_path):
    with open(output_path, 'w') as f:
        f.write(f"// 'Needle NVG', {EXPECTED_WIDTH}x{EXPECTED_HEIGHT} Pivot point 7x150\n")
