...
# --- CONFIG ---
PNG_FILE = "brakePressNeedle.png"
HEADER_FILE = "brakePressNeedle.h"
ARRAY_NAME = "brakePressNeedle"
EXPECTED_WIDTH = 15
EXPECTED_HEIGHT = 150
PIXELS_PER_LINE = 15
...
def write_header_file(pixels, output_path):
    with open(output_path, 'w') as f:
        f.write(f"// 'Needle', {EXPECTED_WIDTH}x{EXPECTED_HEIGHT} Pivot point 7x150\n")
