...
static const AddressEntry dcsAddressTable[] = {
  ...
  { 0x740C, { &DcsOutputTable[15], &DcsOutputTable[16], &DcsOutputTable[17], &DcsOutputTable[18], &DcsOutputTable[19], &DcsOutputTable[20], &DcsOutputTable[21] }, 7 },
  { 0x7408, { &DcsOutputTable[22], &DcsOutputTable[23] }, 2 },
};
