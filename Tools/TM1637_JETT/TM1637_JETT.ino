...
const TM1637LEDEntry tm1637LEDs[] = {
  {"RA_APU_FIRE",  &JETSEL_Device, 5, 0},
  {"RA_ENG_FIRE",  &JETSEL_Device, 0, 2},
  {"RA_RCDR_ON",   &JETSEL_Device, 0, 1},
  {"RA_AI",        &JETSEL_Device, 4, 1},
  {"RA_CW",        &JETSEL_Device, 5, 1},
  {"RA_DISP",      &JETSEL_Device, 0, 0},
  {"RA_SAM",       &JETSEL_Device, 3, 0},
  {"RA_AAA",       &JETSEL_Device, 4, 0},
  {"RA_DASH_L1",   &JETSEL_Device, 1, 1},
  {"RA_DASH_L2",   &JETSEL_Device, 2, 1},
  {"RA_DASH_L3",   &JETSEL_Device, 3, 1},
  {"RA_DASH_R1",   &JETSEL_Device, 1, 0},
  {"RA_DASH_R2",   &JETSEL_Device, 2, 0},
};
